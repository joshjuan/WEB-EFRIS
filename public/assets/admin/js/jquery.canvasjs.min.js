...
(function () {
  ...
  function Ra(q, v, s) {
    "millisecond" === s
      ? q.setMilliseconds(q.getMilliseconds() + 1 * v)
      : "second" === s
      ? q.setSeconds(q.getSeconds() + 1 * v)
      : "minute" === s
      ? q.setMinutes(q.getMinutes() + 1 * v)
      : "hour" === s
      ? q.setHours(q.getHours() + 1 * v)
      : "day" === s
      ? q.setDate(q.getDate() + 1 * v)
      : "week" === s
      ? q.setDate(q.getDate() + 7 * v)
      : "month" === s
      ? q.setMonth(q.getMonth() + 1 * v)
      : "year" === s && q.setFullYear(q.getFullYear() + 1 * v);
    return q;
  }
  function ga(q, v) {
    var s = !1;
    0 > q && ((s = !0), (q *= -1));
    q = "" + q;
    for (v = v ? v : 1; q.length < v; ) q = "0" + q;
    return s ? "-" + q : q;
  }
  function Da(q) {
    if (!q) return q;
    q = q.replace(/^\s\s*/, "");
    for (var v = /\s/, s = q.length; v.test(q.charAt(--s)); );
    return q.slice(0, s + 1);
  }
  function Aa(q) {
    q.roundRect = function (q, s, x, w, y, z, R, B) {
      R && (this.fillStyle = R);
      B && (this.strokeStyle = B);
      "undefined" === typeof y && (y = 5);
      this.lineWidth = z;
      this.beginPath();
      this.moveTo(q + y, s);
      this.lineTo(q + x - y, s);
      this.quadraticCurveTo(q + x, s, q + x, s + y);
      this.lineTo(q + x, s + w - y);
      this.quadraticCurveTo(q + x, s + w, q + x - y, s + w);
      this.lineTo(q + y, s + w);
      this.quadraticCurveTo(q, s + w, q, s + w - y);
      this.lineTo(q, s + y);
      this.quadraticCurveTo(q, s, q + y, s);
      this.closePath();
      R && this.fill();
      B && 0 < z && this.stroke();
    };
  ...
  function P(q) {
    var v = ((q & 16711680) >> 16).toString(16),
      s = ((q & 65280) >> 8).toString(16);
  ...
  function Za(q, v) {
    ...
    for (0 > x && (x += s); x < s; x++)
      if (x in this && this[x] === q) return x;
    return -1;
  }
  function w(q) {
  ...
  function Ea(q) {
    q.indexOf || (q.indexOf = Za);
    return q;
  }
  function $a(q) {
    if (na.fSDec)
      q[na.fSDec("`eeDwdouMhrudods")](
        na.fSDec("e`u`@ohl`uhnoHuds`uhnoDoe"),
        function () {
          na._fTWm && na._fTWm(q);
        }
      );
  ...
  function F(q, v) {
    ...
    if (
      ...
      for (var x = 0; x < s.length; x++) s[x] *= v;
    else s = [];
    return s;
  }
  function U(q, v, s, x) {
    return q.addEventListener
      ? (q.addEventListener(v, s, x || !1), s)
      : q.attachEvent
      ? ((x = function (v) {
          v = v || window.event;
          v.preventDefault =
  ...
  function Ua(q, v, s) {
    q *= aa;
    v *= aa;
    q = s.getImageData(q, v, 2, 2).data;
    v = !0;
    for (s = 0; 4 > s; s++)
      if ((q[s] !== q[s + 4]) | (q[s] !== q[s + 8]) | (q[s] !== q[s + 12])) {
        v = !1;
        break;
      }
    return v ? (q[0] << 16) | (q[1] << 8) | q[2] : 0;
  }
  function ia(q, v, s) {
    return q in v ? v[q] : s[q];
  }
  function Fa(q, v, s) {
    if (x && Va) {
      var w = q.getContext("2d");
      Ja =
        w.webkitBackingStorePixelRatio ||
        w.mozBackingStorePixelRatio ||
        w.msBackingStorePixelRatio ||
        w.oBackingStorePixelRatio ||
        w.backingStorePixelRatio ||
        1;
      aa = Oa / Ja;
      q.width = v * aa;
      q.height = s * aa;
  ...
  function Wa(q) {
    if (!ab) {
      ...
      "undefined" === typeof qa.Chart.creditHref
        ? ((q.creditHref = "https://canvasjs.com/"),
          (q.creditText = "CanvasJS.com"))
        : ((v = q.updateOption("creditText")),
          (s = q.updateOption("creditHref")));
      if (q.creditHref && q.creditText) {
        q._creditLink ||
          ((q._creditLink = document.createElement("a")),
          q._creditLink.setAttribute("class", "canvasjs-chart-credit"),
          q._creditLink.setAttribute(
            "style",
          ...
          q._creditLink.setAttribute("tabIndex", -1),
          q._creditLink.setAttribute("target", "_blank"));
        if (0 === q.renderCount || v || s)
          q._creditLink.setAttribute("href", q.creditHref),
            (q._creditLink.innerHTML = q.creditText);
        q._creditLink && q.creditHref && q.creditText
          ? (q._creditLink.parentElement ||
              q._canvasJSContainer.appendChild(q._creditLink),
            (q._creditLink.style.top = q.height - 14 + "px"))
          : q._creditLink.parentElement &&
            q._canvasJSContainer.removeChild(q._creditLink);
      }
    }
  }
  function ra(q, v) {
  ...
  function ma(q, v, s) {
    for (var x in s) v.style[x] = s[x];
  }
  function sa(q, v, s) {
    v.getAttribute("state") ||
      ((v.style.backgroundColor = q.toolbar.backgroundColor),
    ...
    v.getAttribute("state") !== s &&
      (v.setAttribute("state", s),
      ...
      v.setAttribute("title", q._cultureInfo[s + "Text"]),
      (v.innerHTML =
        "<img style='height:95%;' src='" +
        bb[s].image +
        "' alt='" +
        q._cultureInfo[s + "Text"] +
        "' />"));
  }
  function Ka() {
    for (var q = null, v = 0; v < arguments.length; v++)
      (q = arguments[v]), q.style && (q.style.display = "inline");
  }
  function ta() {
    for (var q = null, v = 0; v < arguments.length; v++)
      (q = arguments[v]) && q.style && (q.style.display = "none");
  }
  function T(q, v, s, x, y) {
    this._defaultsKey = q;
    ...
    q = {};
    this.theme && w(v) && w(x)
      ? (q = w(va[this.theme]) ? va.light1 : va[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[v] &&
        (null === x
          ? (q = this.parent.themeOptions[v])
          : 0 < this.parent.themeOptions[v].length &&
            ((x = Math.min(this.parent.themeOptions[v].length - 1, x)),
            (q = this.parent.themeOptions[v][x])));
    this.themeOptions = q;
    this.options = s ? s : { _isPlaceholder: !0 };
    this.setOptions(this.options, q);
  }
  function Ba(q, v, s, x, w) {
  ...
  function ja(q, v) {
    ja.base.constructor.call(this, "TextBlock", null, v, null, null);
    this.ctx = q;
    this._isDirty = !0;
  ...
  function Pa(q, v) {
    Pa.base.constructor.call(this, "Toolbar", "toolbar", v, null, q);
    this.chart = q;
  ...
  function Ga(q, v) {
    Ga.base.constructor.call(this, "Title", "title", v, null, q);
    this.chart = q;
    this.canvas = q.canvas;
    this.ctx = this.chart.ctx;
    this.optionsName = "title";
    if (w(this.options.margin) && q.options.subtitles)
      for (var s = q.options.subtitles, x = 0; x < s.length; x++)
        if (
          ((w(s[x].horizontalAlign) && "center" === this.horizontalAlign) ||
            s[x].horizontalAlign === this.horizontalAlign) &&
          ((w(s[x].verticalAlign) && "top" === this.verticalAlign) ||
            s[x].verticalAlign === this.verticalAlign) &&
          !s[x].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  function La(q, v, s) {
    La.base.constructor.call(this, "Subtitle", "subtitles", v, s, q);
    this.chart = q;
    this.canvas = q.canvas;
    this.ctx = this.chart.ctx;
  ...
  function Ha(q) {
    var v;
    q && Ia[q] && (v = Ia[q]);
    Ha.base.constructor.call(this, "CultureInfo", null, v, null, null);
  }
  var na = {},
    ...
    qa = {
      ...
      Crosshair: {
        ...
        labelWrap: !0,
        labelMaxWidth: null,
        labelBackgroundColor: x ? "grey" : null,
    ...
    Ia = { en: {} },
    y = x ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
    ua = x ? "Impact, Charcoal, sans-serif" : "Arial",
    xa = {
      colorSet1:
  ...
  var da = 20,
    ...
    ya = (function () {
      ...
      return function (R, B, O) {
        ...
        "UTC:" === B.slice(0, 4) && ((B = B.slice(4)), (U = !0));
        O = U ? "getUTC" : "get";
        var T = R[O + "Date"](),
          W = R[O + "Day"](),
          V = R[O + "Month"](),
          ...
          a = R[O + "Seconds"](),
          f = R[O + "Milliseconds"](),
          b = U ? 0 : R.getTimezoneOffset();
        return (O = B.replace(q, function (c) {
          switch (c) {
            case "D":
              return T;
            case "DD":
            ...
            case "YY":
              return ga(String(X).slice(-2), 2);
            case "YYY":
              return ga(String(X).slice(-3), 3);
            case "YYYY":
              return ga(X, 4);
            case "h":
              return L % 12 || 12;
            ...
            case "ff":
              return ga(String(f).slice(0, 2), 2);
            case "fff":
              return ga(String(f).slice(0, 3), 3);
            case "t":
              return 12 > L ? "a" : "p";
            case "tt":
              return 12 > L ? "am" : "pm";
            ...
            case "K":
              return U
                ? "UTC"
                : (String(R).match(y) || [""]).pop().replace(z, "");
            case "z":
              return (0 < b ? "-" : "+") + Math.floor(Math.abs(b) / 60);
            case "zz":
              return (0 < b ? "-" : "+") + ga(Math.floor(Math.abs(b) / 60), 2);
            case "zzz":
              return (
                (0 < b ? "-" : "+") +
                ga(Math.floor(Math.abs(b) / 60), 2) +
                ga(Math.abs(b) % 60, 2)
              );
            default:
    ...
    X = function (q, v, s) {
        ...
        if (((v = R[W]), "." === v && 0 > B)) B = W;
          ...
          if ("%" === v) z *= 100;
            ...
            ("E" !== v[0] && "e" !== v[0]) ||
              ...
              (U = !0);
          0 > B
            ? (O.push(v), "#" === v || "0" === v ? J++ : "," === v && Q++)
            : (F.push(v), ("#" !== v && "0" !== v) || P++);
        }
      U &&
        ((v = Math.floor(q)),
        (R = -Math.floor(Math.log(q) / Math.LN10 + 1)),
        (V = 0 === q ? 0 : 0 === v ? -(J + R) : String(v).length - J),
        (z /= Math.pow(10, V)));
      0 > B && (B = W);
      z = (q * z).toFixed(P);
      v = z.split(".");
      ...
      q = (v[1] + "").split("");
      z && "0" === z[0] && z.shift();
      for (U = R = W = P = B = 0; 0 < O.length; )
        if (((v = O.pop()), "#" === v || "0" === v))
          if ((B++, B === J)) {
            var T = z,
              z = [];
            if ("0" === v)
              for (v = J - P - (T ? T.length : 0); 0 < v; ) T.unshift("0"), v--;
            for (; 0 < T.length; )
              (s = T.pop() + s),
                U++,
                0 === U % R && W === Q && 0 < T.length && (s = y + s);
          } else
            0 < z.length
              ? ((s = z.pop() + s), P++, U++)
              : "0" === v && ((s = "0" + s), P++, U++),
              0 === U % R && W === Q && 0 < z.length && (s = y + s);
        else
          ("E" !== v[0] && "e" !== v[0]) ||
          "0" !== v[v.length - 1] ||
          !/[eE][+-]*[0]+/.test(v)
            ? "," === v
              ? (W++, (R = U), (U = 0), 0 < z.length && (s = y + s))
              : (s =
                  1 < v.length &&
                  (('"' === v[0] && '"' === v[v.length - 1]) ||
                    ("'" === v[0] && "'" === v[v.length - 1]))
                    ? v.slice(1, v.length - 1) + s
                    : v + s)
            : ((v =
                0 > V
                  ? v.replace("+", "").replace("-", "")
                  : v.replace("-", "")),
              (s += v.replace(/[0]+/, function (q) {
                return ga(V, q.length);
              })));
      y = "";
      for (O = !1; 0 < F.length; )
        (v = F.shift()),
          "#" === v || "0" === v
            ? 0 < q.length && 0 !== Number(q.join(""))
              ? ((y += q.shift()), (O = !0))
              : "0" === v && ((y += "0"), (O = !0))
            : 1 < v.length &&
              (('"' === v[0] && '"' === v[v.length - 1]) ||
                ("'" === v[0] && "'" === v[v.length - 1]))
            ? (y += v.slice(1, v.length - 1))
            : ("E" !== v[0] && "e" !== v[0]) ||
              "0" !== v[v.length - 1] ||
              !/[eE][+-]*[0]+/.test(v)
            ? (y += v)
    ...
    Ma = function (q) {
      var v = 0,
        s = 0;
      q = q || window.event;
      q.offsetX || 0 === q.offsetX
        ? ((v = q.offsetX), (s = q.offsetY))
        : q.layerX || 0 == q.layerX
        ? ((v = q.layerX), (s = q.layerY))
        : ((v = q.pageX - q.target.offsetLeft),
          (s = q.pageY - q.target.offsetTop));
      return { x: v, y: s };
    },
    Va = !0,
    ...
    ab =
      ...
      (-1 !== window.location.href.indexOf("canvasjs.com") ||
        -1 !== window.location.href.indexOf("fenopix.com") ||
        -1 !== window.location.href.indexOf("fiddle")),
    bb = {
      reset: {
        image:
  ...
  T.prototype.setOptions = function (q, v) {
    if (qa[this._defaultsKey]) {
      ...
      for (x in s)
        "publicProperties" !== x &&
          s.hasOwnProperty(x) &&
          (this[x] = q && x in q ? q[x] : v && x in v ? v[x] : s[x]);
    }
  };
  T.prototype.get = function (q) {
    var v = qa[this._defaultsKey];
    if ("options" === q)
      return this.options && this.options._isPlaceholder ? null : this.options;
    if (
      v.hasOwnProperty(q) ||
      (v.publicProperties && v.publicProperties.hasOwnProperty(q))
    )
      return this[q];
    window.console &&
      window.console.log(
        'Property "' + q + "\" doesn't exist. Please check for typo."
      );
  };
  T.prototype.set = function (q, v, s) {
    s = "undefined" === typeof s ? !0 : s;
    var x = qa[this._defaultsKey];
    if ("options" === q) this.createUserOptions(v);
    else if (
      x.hasOwnProperty(q) ||
      (x.publicProperties &&
        x.publicProperties.hasOwnProperty(q) &&
        "readWrite" === x.publicProperties[q])
    )
      ...
      window.console &&
        (x.publicProperties &&
        x.publicProperties.hasOwnProperty(q) &&
        "readOnly" === x.publicProperties[q]
          ? window.console.log('Property "' + q + '" is read-only.')
          : window.console.log(
              'Property "' + q + "\" doesn't exist. Please check for typo."
            ));
      return;
  ...
  T.prototype.addTo = function (q, v, x, w) {
    w = "undefined" === typeof w ? !0 : w;
    var y = qa[this._defaultsKey];
    y.hasOwnProperty(q) ||
    (y.publicProperties &&
      y.publicProperties.hasOwnProperty(q) &&
      "readWrite" === y.publicProperties[q])
      ? (this.options._isPlaceholder && this.createUserOptions(),
        "undefined" === typeof this.options[q] && (this.options[q] = []),
        (q = this.options[q]),
        (x = "undefined" === typeof x || null === x ? q.length : x),
        q.splice(x, 0, v),
        w && (this.chart || this).render())
      : window.console &&
        (y.publicProperties &&
        y.publicProperties.hasOwnProperty(q) &&
        "readOnly" === y.publicProperties[q]
          ? window.console.log('Property "' + q + '" is read-only.')
          : window.console.log(
              'Property "' + q + "\" doesn't exist. Please check for typo."
            ));
  };
  T.prototype.createUserOptions = function (q) {
    if ("undefined" !== typeof q || this.options._isPlaceholder)
      if (
        ...
        var v = this.parent.options[this.optionsName],
          x = v.length;
        this.options._isPlaceholder || (Ea(v), (x = v.indexOf(this.options)));
        this.options = "undefined" === typeof q ? {} : q;
        v[x] = this.options;
      } else
        (this.options = "undefined" === typeof q ? {} : q),
          (q = this.parent.options),
          this.optionsName
            ? (v = this.optionsName)
            : (v = this._defaultsKey) && 0 !== v.length
            ? ((x = v.charAt(0).toLowerCase()),
              1 < v.length && (x = x.concat(v.slice(1))),
              (v = x))
            : (v = void 0),
          (q[v] = this.options);
  };
  T.prototype.remove = function (q) {
  ...
  T.prototype.updateOption = function (q) {
    var x = qa[this._defaultsKey],
      s = {},
      y = this[q],
      ...
      F = this._index;
    this.theme && w(z) && w(F)
      ? (s = w(va[this.theme]) ? va.light1 : va[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[z] &&
        (null === F
          ? (s = this.parent.themeOptions[z])
          : 0 < this.parent.themeOptions[z].length &&
            ((s = Math.min(this.parent.themeOptions[z].length - 1, F)),
            (s = this.parent.themeOptions[z][s])));
    this.themeOptions = s;
    q in x &&
      (y = q in this.options ? this.options[q] : s && q in s ? s[q] : x[q]);
    if (y === this[q]) return !1;
    this[q] = y;
    return !0;
  };
  T.prototype.trackChanges = function (q) {
    if (!this.sessionVariables) throw "Session Variable Store not set";
    this.sessionVariables[q] = this.options[q];
  };
  T.prototype.isBeingTracked = function (q) {
    this.options._oldOptions || (this.options._oldOptions = {});
    return this.options._oldOptions[q] ? !0 : !1;
  };
  T.prototype.hasOptionChanged = function (q) {
    if (!this.sessionVariables) throw "Session Variable Store not set";
    return this.sessionVariables[q] !== this.options[q];
  };
  T.prototype.addEventListener = function (q, x, s) {
    q &&
      x &&
      ((this._eventListeners[q] = this._eventListeners[q] || []),
      this._eventListeners[q].push({ context: s || this, eventHandler: x }));
  };
  T.prototype.removeEventListener = function (q, x) {
    if (q && x && this._eventListeners[q])
      for (var s = this._eventListeners[q], w = 0; w < s.length; w++)
        if (s[w].eventHandler === x) {
          s[w].splice(w, 1);
          break;
        }
  };
  ...
  T.prototype.dispatchEvent = function (q, x, s) {
    if (q && this._eventListeners[q]) {
      x = x || {};
      for (var w = this._eventListeners[q], y = 0; y < w.length; y++)
        w[y].eventHandler.call(w[y].context, x);
    }
    "function" === typeof this[q] && this[q].call(s || this.chart, x);
  };
  Ba.prototype.registerSpace = function (q, x) {
    "top" === q
      ? (this._topOccupied += x.height)
      : "bottom" === q
      ? (this._bottomOccupied += x.height)
      : "left" === q
      ? (this._leftOccupied += x.width)
      : "right" === q && (this._rightOccupied += x.width);
  };
  Ba.prototype.unRegisterSpace = function (q, x) {
    "top" === q
      ? (this._topOccupied -= x.height)
      : "bottom" === q
      ? (this._bottomOccupied -= x.height)
  ...
  Ba.prototype.getFreeSpace = function () {
    return {
  ...
  ja.prototype._initialize = function () {
    w(this.padding) || "object" !== typeof this.padding
      ? (this.topPadding =
          this.rightPadding =
          this.bottomPadding =
          this.leftPadding =
            Number(this.padding) | 0)
      : ((this.topPadding = w(this.padding.top)
          ? 0
          : Number(this.padding.top) | 0),
        (this.rightPadding = w(this.padding.right)
          ? 0
          : Number(this.padding.right) | 0),
        (this.bottomPadding = w(this.padding.bottom)
          ? 0
          : Number(this.padding.bottom) | 0),
        (this.leftPadding = w(this.padding.left)
          ? 0
          : Number(this.padding.left) | 0));
  };
  ja.prototype.render = function (q) {
    if (0 !== this.fontSize) {
      q && this.ctx.save();
      var x = this.ctx.font;
          ...
          "right" === this.horizontalAlign
            ...
            : "center" === this.horizontalAlign &&
              (w =
                ...
                z.width / 2 +
                this.leftPadding),
          this.ctx.fillText(z.text, w, y),
          (y += z.height);
      this.ctx.font = x;
      q && this.ctx.restore();
    }
  };
  ja.prototype.setText = function (q) {
    this.text = q;
    this._isDirty = !0;
    this._wrappedText = null;
  };
  ja.prototype.measureText = function () {
    this._lineHeight = Sa(this.fontFamily, this.fontSize, this.fontWeight);
  ...
  ja.prototype._getLineWithWidth = function (q, x, s) {
    q = String(q);
    if (!q) return { text: "", width: 0 };
    var w = (s = 0),
      y = q.length - 1,
      z = Infinity;
    for (this.ctx.font = this._getFontString(); w <= y; ) {
      var z = Math.floor((w + y) / 2),
        F = q.substr(0, z + 1);
    ...
    x = !0;
    if (F.length === q.length || " " === q[F.length]) x = !1;
    x &&
      ((q = F.split(" ")),
      1 < q.length && q.pop(),
      (F = q.join(" ")),
    ...
    if (0 === this.frontSize) y = w = 0;
      ...
      for (; 0 < q.length; ) {
        ...
        var R = y,
          ...
          w = w + F.height,
          q = Da(q.slice(F.text.length, q.length));
        z && w > z && ((F = x.pop()), (w -= F.height), (y = R));
      }
    this._wrappedText = { lines: x, width: y, height: w };
  ...
  Ga.prototype.render = function () {
    if (this.text) {
      var q = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        x = q.layoutManager.getFreeSpace(),
        s = x.x1,
        y = x.y1,
        z = 0,
        F = 0,
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              x.width - 4 - P * ("center" === this.horizontalAlign ? 2 : 1)),
          (F = 0.5 * x.height - this.margin - 2),
          (z = 0))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign || "right" === this.horizontalAlign
            ? (null === this.maxWidth && (this.maxWidth = x.height - 4),
              (F = 0.5 * x.width - this.margin - 2))
            : "center" === this.horizontalAlign &&
              (null === this.maxWidth && (this.maxWidth = x.width - 4),
              (F = 0.5 * x.height - 4)));
      var O;
      w(this.padding) || "number" !== typeof this.padding
        ? w(this.padding) ||
        ...
        : (O = 2.5 * this.padding);
      this.wrap ||
        (F = Math.min(F, Math.max(1.5 * this.fontSize, this.fontSize + O)));
      F = new ja(this.ctx, {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((y = x.y2 - 2 - O.height), (B = "bottom")),
          "left" === this.horizontalAlign
            ? (s = x.x1 + 2)
            : "center" === this.horizontalAlign
            ? (s = x.x1 + x.width / 2 - O.width / 2)
            : "right" === this.horizontalAlign && (s = x.x2 - 2 - O.width - P),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((s = x.x1 + 2),
              (y = x.y2 - 2 - (this.maxWidth / 2 - O.width / 2)),
              (z = -90),
              (B = "left"),
              (this.width = O.height),
              (this.height = O.width))
            : "right" === this.horizontalAlign
            ? ((s = x.x2 - 2),
              (y = x.y1 + 2 + (this.maxWidth / 2 - O.width / 2)),
              (z = 90),
              (B = "right"),
              (this.width = O.height),
              (this.height = O.width))
            : "center" === this.horizontalAlign &&
              ((y = q.y1 + (q.height / 2 - O.height / 2)),
              (s = q.x1 + (q.width / 2 - O.width / 2)),
              (B = "center"),
              (this.width = O.width),
              (this.height = O.height)),
          (R = "center"));
      ...
      F.horizontalAlign = R;
      F.render(!0);
      q.layoutManager.registerSpace(B, {
        width:
          this.width + ("left" === B || "right" === B ? this.margin + 2 : 0),
        height:
          this.height + ("top" === B || "bottom" === B ? this.margin + 2 : 0),
      });
      this.bounds = { x1: s, y1: y, x2: s + this.width, y2: y + this.height };
  ...
  ka(Ha, T);
  y = {
    addTheme: function (q, x) {
      va[q] = x;
    },
    addColorSet: function (q, x) {
      xa[q] = x;
    },
    addCultureInfo: function (q, x) {
      Ia[q] = x;
    },
    formatNumber: function (q, x, s) {
      s = s || "en";
      if (Ia[s]) return X(q, x || "#,##0.##", new Ha(s));
      throw "Unknown Culture Name";
    },
    formatDate: function (q, x, s) {
      s = s || "en";
      if (Ia[s]) return ya(q, x || "DD MMM YYYY", new Ha(s));
      throw "Unknown Culture Name";
    },
  };
  window.CanvasJS = y;
  y.Chart = (function () {
    ...
    function v(a, f, b) {
      if (a && f && b) {
        ...
        if ("undefined" !== typeof Blob && new Blob()) {
          for (
            var k = a.replace(/^data:[a-z\/]*;base64,/, ""),
              k = atob(k),
          ...
          try {
            window.navigator.msSaveBlob(f, b), (d = !0);
          } catch (h) {
    ...
    function s(a, f) {
      f = f || {};
      this.theme = w(f.theme) || w(va[f.theme]) ? "light1" : f.theme;
      ...
      if (
        ...
        x || (this._canvasJSContainer.style.height = "0px");
        this.container.appendChild(this._canvasJSContainer);
        this.canvas = ra(c, d);
        this._preRenderCanvas = ra(c, d);
        ...
        this.canvas.getContext &&
          ...
          (this._eventManager = new fa(this)),
          (this.windowResizeHandler = U(window, "resize", function () {
          ...
          U(this.overlaidCanvas, "click", function (a) {
            b._mouseEventHandler(a);
          }),
          U(this.overlaidCanvas, "mousemove", function (a) {
            b._mouseEventHandler(a);
          }),
          U(this.overlaidCanvas, "mouseup", function (a) {
            b._mouseEventHandler(a);
          }),
          U(this.overlaidCanvas, "mousedown", function (a) {
            b._mouseEventHandler(a);
            ta(b._dropdownMenu);
          }),
          U(this.overlaidCanvas, "mouseout", function (a) {
            b._mouseEventHandler(a);
          }),
          U(
            this.overlaidCanvas,
      ...
      for (var b = [], c, d = 0; d < a.length; d++)
        if (0 == d) b.push(a[0]);
          ...
          c =
            (Math.abs(
              (a[k].x - a[g].x) /
                (0 === a[k].x - a[l].x ? 0.01 : a[k].x - a[l].x)
            ) *
              (f - 1)) /
              2 +
            1;
    ...
    function z(a, f, b, c, d, g, k, l, n, h) {
      var r = 0;
      h ? ((k.color = g), (l.color = g)) : (h = 1);
      r = n ? Math.abs(d - b) : Math.abs(c - f);
      r =
        0 < k.trimLength
          ? Math.abs((r * k.trimLength) / 100)
          : Math.abs(r - k.length);
      n ? ((b += r / 2), (d -= r / 2)) : ((f += r / 2), (c -= r / 2));
      var r = 1 === Math.round(k.thickness) % 2 ? 0.5 : 0,
      ...
      a.beginPath();
      n && 0 < l.thickness
        ? (a.moveTo(c - k.thickness / 2, Math.round((b + d) / 2) - p),
          a.lineTo(f + k.thickness / 2, Math.round((b + d) / 2) - p))
        : 0 < l.thickness &&
          (a.moveTo(Math.round((f + c) / 2) - p, b + k.thickness / 2),
          a.lineTo(Math.round((f + c) / 2) - p, d - k.thickness / 2));
      a.stroke();
      a.strokeStyle = k.color || g;
      a.lineWidth = k.thickness || 2;
      a.setLineDash && a.setLineDash(F(k.dashType, k.thickness));
      a.beginPath();
      n && 0 < k.thickness
        ? (a.moveTo(c - r, b),
          a.lineTo(c - r, d),
    ...
    function J(a, f, b, c, d) {
      ...
      "undefined" !== typeof c &&
        ((a = Math.min(c, a)),
        "undefined" !== typeof d && (a = Math.max(d, a)));
    ...
    function V(a, f) {
      V.base.constructor.call(this, "Legend", "legend", f, null, a);
      this.chart = a;
      ...
      "undefined" === typeof this.options.fontSize &&
        (this.fontSize = this.chart.getAutoFontSize(this.fontSize));
      this.lineHeight = Sa(this.fontFamily, this.fontSize, this.fontWeight);
    ...
    function B(a, f, b, c, d, g) {
      B.base.constructor.call(this, "Axis", f, b, c, a);
      this.chart = a;
      this.canvas = a.canvas;
      this.ctx = a.ctx;
      ...
      this.options.crosshair &&
        (this.crosshair = new ga(this.chart, this.options.crosshair, this));
    ...
    function O(a, f, b, c) {
      O.base.constructor.call(this, "ScaleBreaks", "scaleBreaks", f, null, c);
      this.id = b;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = c;
    ...
    function da(a, f, b, c, d, g) {
      da.base.constructor.call(this, "Break", f, b, c, g);
      this.id = d;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.scaleBreaks = g;
      ...
      this.fillOpacity = w(b.fillOpacity) ? g.fillOpacity : this.fillOpacity;
      this.lineThickness = w(b.lineThickness)
        ? g.lineThickness
        : this.lineThickness;
    ...
    function ba(a, f, b, c, d) {
      ba.base.constructor.call(this, "StripLine", "stripLines", f, b, d);
      this.id = c;
      this.chart = a;
      this.ctx = this.chart.ctx;
    ...
    function ga(a, f, b) {
      ga.base.constructor.call(this, "Crosshair", "crosshair", f, null, b);
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = b;
    ...
    s.prototype._updateOptions = function () {
      ...
      this.options.zoomEnabled
        ? (this._zoomButton ||
            ...
            U(this._zoomButton, "click", function () {
              a.zoomEnabled
                ? ((a.zoomEnabled = !1),
                  (a.panEnabled = !0),
            ...
            U(this._zoomButton, "mouseover", function () {
              ma(a, a._zoomButton, {
              ...
              0 >= navigator.userAgent.search("MSIE") &&
                ma(a, a._zoomButton.childNodes[0], {
                  WebkitFilter: "invert(100%)",
                  filter: "invert(100%)",
                });
            }),
            U(this._zoomButton, "mouseout", function () {
              ma(a, a._zoomButton, {
          ...
          this._resetButton ||
            ...
            U(this._resetButton, "click", function () {
              a.toolTip.hide();
            ...
            U(this._resetButton, "mouseover", function () {
              ma(a, a._resetButton, {
                backgroundColor: a.toolbar.backgroundColorOnHover,
              ...
              0 >= navigator.userAgent.search("MSIE") &&
                ma(a, a._resetButton.childNodes[0], {
                  WebkitFilter: "invert(100%)",
                  filter: "invert(100%)",
                });
            }),
            U(this._resetButton, "mouseout", function () {
              ma(a, a._resetButton, {
                backgroundColor: a.toolbar.backgroundColor,
                color: a.toolbar.fontColor,
                transition: "0.4s",
        ...
        : this.exportEnabled &&
          ...
          U(
            ...
            function () {
              ...
              0 >= navigator.userAgent.search("MSIE") &&
                ma(a, a._menuButton.childNodes[0], {
                  WebkitFilter: "invert(100%)",
                  filter: "invert(100%)",
                });
            },
      ...
      if (!this._dropdownMenu && this.exportEnabled && x) {
        this._dropdownMenu = document.createElement("div");
        this._dropdownMenu.setAttribute("tabindex", -1);
        var f = -1 !== this.theme.indexOf("dark") ? "black" : "#888888";
        ...
        U(
          ...
          "click",
          function () {
            v(a.canvas, "jpeg", a.exportFileName);
            ta(a._dropdownMenu);
          },
          !0
        );
        ...
        U(
          ...
          "click",
          function () {
            v(a.canvas, "png", a.exportFileName);
            ta(a._dropdownMenu);
          },
          !0
        );
      ...
      for (var b in this.toolTip.options)
        this.toolTip.options.hasOwnProperty(b) && this.toolTip.updateOption(b);
    };
      ...
      this.options.height
        ...
        : (this.height = f =
            0 < this.container.clientHeight
              ? this.container.clientHeight
              : this.height);
      return this.canvas.width !== a * aa || this.canvas.height !== f * aa
        ? (Fa(this.canvas, a, f),
          Fa(this._preRenderCanvas, a, f),
          Fa(this.overlaidCanvas, a, f),
          Fa(this._eventManager.ghostCanvas, a, f),
          (this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }),
          !0)
        : !1;
    };
    s.prototype._initialize = function () {
      ...
      this._updateOptions();
      this.animatedRender =
        x && this.animationEnabled && 0 === this.renderCount;
      this._updateSize();
      this.clearCanvas();
      this.ctx.beginPath();
      this.axisX = [];
      ...
      this.layoutManager = new Ba(0, 0, this.width, this.height, 2);
      ...
      this.addEventListener("dataAnimationIterationEnd", function () {
        na.fSWm && na.fSWm(k);
        0 !== k.axisX.length && na.fBWm && na.fBWm(k);
      });
      Wa(this);
    ...
    s.prototype.render = function (a) {
      ...
      if (this.animatedRender) {
        var d = ra(this.width, this.height);
      ...
      for (a = 0; a < this.plotInfo.plotTypes.length; a++)
        for (
          var k = this.plotInfo.plotTypes[a], l = 0;
          l < k.plotUnits.length;
          l++
        ) {
          var n = k.plotUnits[l],
            h = null;
          n.targetCanvas = null;
          this.animatedRender &&
            ((n.targetCanvas = ra(this.width, this.height)),
          ...
          "line" === n.type
            ? (h = this.renderLine(n))
            : "stepLine" === n.type
            ? (h = this.renderStepLine(n))
            : "spline" === n.type
            ? (h = this.renderSpline(n))
            : "column" === n.type
            ? (h = this.renderColumn(n))
            : "bar" === n.type
            ? (h = this.renderBar(n))
            : "area" === n.type
            ? (h = this.renderArea(n))
            : "stepArea" === n.type
            ? (h = this.renderStepArea(n))
            : "splineArea" === n.type
            ? (h = this.renderSplineArea(n))
            : "stackedColumn" === n.type
            ? (h = this.renderStackedColumn(n))
            : "stackedColumn100" === n.type
            ? (h = this.renderStackedColumn100(n))
            : "stackedBar" === n.type
            ? (h = this.renderStackedBar(n))
            : "stackedBar100" === n.type
            ? (h = this.renderStackedBar100(n))
            : "stackedArea" === n.type
            ? (h = this.renderStackedArea(n))
            : "stackedArea100" === n.type
            ? (h = this.renderStackedArea100(n))
            : "bubble" === n.type
            ? (h = h = this.renderBubble(n))
            : "scatter" === n.type
            ? (h = this.renderScatter(n))
            : "pie" === n.type
            ? this.renderPie(n)
            : "doughnut" === n.type
            ? this.renderPie(n)
            : "funnel" === n.type
            ? (h = this.renderFunnel(n))
            : "pyramid" === n.type
            ? (h = this.renderFunnel(n))
            : "candlestick" === n.type
            ? (h = this.renderCandlestick(n))
            : "ohlc" === n.type
            ? (h = this.renderCandlestick(n))
            : "rangeColumn" === n.type
            ? (h = this.renderRangeColumn(n))
            : "error" === n.type
            ? (h = this.renderError(n))
            : "rangeBar" === n.type
            ? (h = this.renderRangeBar(n))
            : "rangeArea" === n.type
            ? (h = this.renderRangeArea(n))
            : "rangeSplineArea" === n.type
            ? (h = this.renderRangeSplineArea(n))
            : "waterfall" === n.type
            ? (h = this.renderWaterfall(n))
            : "boxAndWhisker" === n.type && (h = this.renderBoxAndWhisker(n));
          for (b = 0; b < n.dataSeriesIndexes.length; b++)
            this._dataInRenderedOrder.push(this.data[n.dataSeriesIndexes[b]]);
          this.animatedRender &&
            ((n.targetCanvasCtx.miterLimit = g), h && c.push(h));
        }
      ...
      this.animatedRender &&
        ...
        ((g = ra(this.width, this.height).getContext("2d")),
          ...
          r._animator.animate(
            ...
            function (a) {
              ...
              r.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(r.width * aa),
                Math.floor(r.height * aa),
                0,
                0,
                r.width,
                r.height
              ...
              for (var b = 0; b < c.length; b++)
                (h = c[b]),
                  1 > a && "undefined" !== typeof h.startTimePercent
                    ? a >= h.startTimePercent &&
                      h.animationCallback(
                        h.easingFunction(
                          ...
                          0,
                          1,
                          1 - h.startTimePercent
                        ),
                        h
                      )
                    : h.animationCallback(h.easingFunction(a, 0, 1, 1), h);
            ...
            function () {
              ...
              for (var a = 0; a < r.plotInfo.plotTypes.length; a++)
                for (
                  var b = r.plotInfo.plotTypes[a], e = 0;
                  e < b.plotUnits.length;
                  e++
                )
                  b.plotUnits[e].targetCanvas = null;
              d = null;
              r.disableToolTip = !1;
            }
          );
    ...
    s.prototype.categoriseDataSeries = function () {
      for (var a = "", f = 0; f < this.data.length; f++)
        if (
          ...
          for (
            var b = null, c = !1, d = null, g = !1, k = 0;
            k < this.plotInfo.plotTypes.length;
            k++
          )
          ...
          for (k = 0; k < b.plotUnits.length; k++)
            if (
              b.plotUnits[k].axisYType === a.axisYType &&
              b.plotUnits[k].axisXType === a.axisXType &&
          ...
          g ||
            ...
            b.plotUnits.push(d));
          b.totalDataSeries++;
          d.dataSeriesIndexes.push(f);
          a.plotUnit = d;
        }
      for (f = 0; f < this.plotInfo.plotTypes.length; f++)
        for (
          b = this.plotInfo.plotTypes[f], k = a = 0;
          k < b.plotUnits.length;
          k++
        )
    ...
    s.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var f = a.axisY.dataInfo, b = a.axisX.dataInfo, c, d, g = !1, k = 0;
          ...
          for (n = 0; n < l.dataPoints.length; n++) {
            ...
            c < b.min && (b.min = c);
            c > b.max && (b.max = c);
            d < f.min && "number" === typeof d && (f.min = d);
            d > f.max && "number" === typeof d && (f.max = d);
            if (0 < n) {
              if (a.axisX.logarithmic) {
                var t = c / l.dataPoints[n - 1].x;
                1 > t && (t = 1 / t);
                b.minDiff > t && 1 !== t && (b.minDiff = t);
              } else
                (t = c - l.dataPoints[n - 1].x),
                  0 > t && (t *= -1),
                  b.minDiff > t && 0 !== t && (b.minDiff = t);
              null !== d &&
                null !== l.dataPoints[n - 1].y &&
                (a.axisY.logarithmic
                  ? ((t = d / l.dataPoints[n - 1].y),
                    1 > t && (t = 1 / t),
          ...
          this.plotInfo.axisXValueType = l.xValueType = g
            ? "dateTime"
            : "number";
        }
    };
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
            var C = this.sessionVariables.axisX.newViewportMinimum
              ...
              u = this.sessionVariables.axisX.newViewportMaximum
                ...
                : Infinity;
          if (
            (p.dataPoints[m].x && p.dataPoints[m].x.getTime) ||
            "dateTime" === p.xValueType
          )
            g = !0;
          for (m = 0; m < p.dataPoints.length; m++) {
            "undefined" === typeof p.dataPoints[m].x &&
              (p.dataPoints[m].x = m + (a.axisX.logarithmic ? 1 : 0));
            p.dataPoints[m].x.getTime
              ? ((g = !0), (c = p.dataPoints[m].x.getTime()))
              : (c = p.dataPoints[m].x);
            d = w(p.dataPoints[m].y) ? 0 : p.dataPoints[m].y;
            c < b.min && (b.min = c);
            c > b.max && (b.max = c);
            if (0 < m) {
              if (a.axisX.logarithmic) {
                var E = c / p.dataPoints[m - 1].x;
                1 > E && (E = 1 / E);
                b.minDiff > E && 1 !== E && (b.minDiff = E);
              } else
                (E = c - p.dataPoints[m - 1].x),
                  0 > E && (E *= -1),
                  b.minDiff > E && 0 !== E && (b.minDiff = E);
              null !== d &&
                null !== p.dataPoints[m - 1].y &&
                (a.axisY.logarithmic
                  ? 0 < d &&
                    ((E = d / p.dataPoints[m - 1].y),
                    1 > E && (E = 1 / E),
            ...
            if (c < C && !e) null !== p.dataPoints[m].y && (wa = c);
            else {
              if (!e && ((e = !0), 0 < m)) {
                m -= 2;
                continue;
              ...
              if (c > u && !t) t = !0;
              else if (c > u && t) continue;
              p.dataPoints[m].label &&
                (a.axisX.labels[c] = p.dataPoints[m].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
              null === p.dataPoints[m].y
                ? b.viewPortMin === c && wa < c && (b.viewPortMin = wa)
                : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + d),
                  0 <= d
                    ? k[c]
                      ? (k[c] += d)
                      : ((k[c] = d), (n = Math.min(d, n)))
                    : l[c]
                    ? (l[c] += d)
                    : ((l[c] = d), (h = Math.max(d, h))));
            }
          }
          a.axisY.scaleBreaks &&
            ...
            (f.dataPointYPositiveSums
              ...
              : ((f.dataPointYPositiveSums = k),
                (f.dataPointYNegativeSums = l)));
          this.plotInfo.axisXValueType = p.xValueType = g
            ? "dateTime"
            : "number";
        }
        for (m in k)
        ...
        for (m in l)
          l.hasOwnProperty(m) &&
            ...
            ((a = l[m]),
            a < f.min && (f.min = a),
            a > f.max && (f.max = Math.max(a, h)),
            m < b.viewPortMin ||
              m > b.viewPortMax ||
              (a < f.viewPortMin && (f.viewPortMin = a),
              a > f.viewPortMax && (f.viewPortMax = Math.max(a, h))));
      }
    };
          ...
          if ("normal" === r.axisPlacement || "xySwapped" === r.axisPlacement)
            var wa = this.sessionVariables.axisX.newViewportMinimum
              ...
              C = this.sessionVariables.axisX.newViewportMaximum
                ...
                : Infinity;
          if (
            (r.dataPoints[p].x && r.dataPoints[p].x.getTime) ||
            "dateTime" === r.xValueType
          )
            g = !0;
          for (p = 0; p < r.dataPoints.length; p++) {
            "undefined" === typeof r.dataPoints[p].x &&
              (r.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0));
            r.dataPoints[p].x.getTime
              ? ((g = !0), (c = r.dataPoints[p].x.getTime()))
              : (c = r.dataPoints[p].x);
            d = w(r.dataPoints[p].y) ? null : r.dataPoints[p].y;
            c < b.min && (b.min = c);
            c > b.max && (b.max = c);
            if (0 < p) {
              if (a.axisX.logarithmic) {
                ...
                (u = c - r.dataPoints[p - 1].x),
                  0 > u && (u *= -1),
                  b.minDiff > u && 0 !== u && (b.minDiff = u);
              w(d) ||
                null === r.dataPoints[p - 1].y ||
                (a.axisY.logarithmic
                  ? 0 < d &&
                    ((u = d / r.dataPoints[p - 1].y),
                    1 > u && (u = 1 / u),
            ...
            if (c < wa && !m) null !== d && (t = c);
              ...
              if (c > C && !e) e = !0;
              else if (c > C && e) continue;
              r.dataPoints[p].label &&
                (a.axisX.labels[c] = r.dataPoints[p].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
              null === d
                ? b.viewPortMin === c && t < c && (b.viewPortMin = t)
                : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + d),
                  0 <= d ? (k = !0) : 0 > d && (l = !0),
                  (n[c] = n[c] ? n[c] + Math.abs(d) : Math.abs(d)));
            }
          }
          this.plotInfo.axisXValueType = r.xValueType = g
            ? "dateTime"
            : "number";
        }
        a.axisY.logarithmic
          ? ((f.max = w(f.viewPortMax)
              ? 99 * Math.pow(a.axisY.logarithmBase, -0.05)
              : Math.max(
                  f.viewPortMax,
                  99 * Math.pow(a.axisY.logarithmBase, -0.05)
                )),
            (f.min = w(f.viewPortMin) ? 1 : Math.min(f.viewPortMin, 1)))
          : k && !l
          ? ((f.max = w(f.viewPortMax) ? 99 : Math.max(f.viewPortMax, 99)),
            (f.min = w(f.viewPortMin) ? 1 : Math.min(f.viewPortMin, 1)))
          : k && l
          ? ((f.max = w(f.viewPortMax) ? 99 : Math.max(f.viewPortMax, 99)),
            (f.min = w(f.viewPortMin) ? -99 : Math.min(f.viewPortMin, -99)))
          : !k &&
            l &&
            ((f.max = w(f.viewPortMax) ? -1 : Math.max(f.viewPortMax, -1)),
            (f.min = w(f.viewPortMin) ? -99 : Math.min(f.viewPortMin, -99)));
        f.viewPortMin = f.min;
        f.viewPortMax = f.max;
        a.dataPointYSums = n;
    ...
    s.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          ...
          var h = this.data[a.dataSeriesIndexes[n]],
            r = 0,
            p = !1,
            m = !1,
            e,
          ...
          for (r = 0; r < h.dataPoints.length; r++) {
            ...
            h.dataPoints[r].x.getTime
              ? ((l = !0), (c = h.dataPoints[r].x.getTime()))
              : (c = h.dataPoints[r].x);
            if ((d = h.dataPoints[r].y) && d.length) {
              g = Math.min.apply(null, d);
              k = Math.max.apply(null, d);
              t = !0;
              for (var E = 0; E < d.length; E++) null === d.k && (t = !1);
              t && (p || (wa = e), (e = c));
            }
            c < b.min && (b.min = c);
            c > b.max && (b.max = c);
            ...
            if (!(c < C) || p) {
              ...
              h.dataPoints[r].label &&
                (a.axisX.labels[c] = h.dataPoints[r].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
              ...
              null === d
                ? b.viewPortMin === c && e < c && (b.viewPortMin = e)
                : (g < f.viewPortMin && (f.viewPortMin = g),
                  k > f.viewPortMax && (f.viewPortMax = k));
            }
          }
          this.plotInfo.axisXValueType = h.xValueType = l
            ? "dateTime"
            : "number";
        }
    };
        ...
        for (
          ...
          for (n = 0; n < l.dataPoints.length; n++)
            ...
            !0 === l.dataPoints[n].isCumulativeSum
              ...
              ? ((l.dataPointEOs[n].cumulativeSumYStartValue = p),
                (l.dataPointEOs[n].cumulativeSum =
                  0 === n ? 0 : l.dataPointEOs[n - 1].cumulativeSum),
                (l.dataPoints[n].y = 0 === n ? 0 : c),
                (p = 0 === n ? 0 : l.dataPointEOs[n - 1].cumulativeSum),
                (c = 0))
              : ((d =
                ...
                (l.dataPointEOs[n].cumulativeSumYStartValue =
                  0 === n ? 0 : l.dataPointEOs[n - 1].cumulativeSum),
                (l.dataPointEOs[n].cumulativeSum =
                  0 === n ? d : l.dataPointEOs[n - 1].cumulativeSum + d),
                (c += d));
          for (n = 0; n < l.dataPoints.length; n++)
            if (
              ("undefined" === typeof l.dataPoints[n].x &&
              ...
              0 < n &&
                (a.axisX.logarithmic
                  ? ((p = c / l.dataPoints[n - 1].x),
                    1 > p && (p = 1 / p),
                    b.minDiff > p && 1 !== p && (b.minDiff = p))
                  : ((p = c - l.dataPoints[n - 1].x),
                    0 > p && (p *= -1),
                    b.minDiff > p && 0 !== p && (b.minDiff = p)),
                null !== d &&
                  null !== l.dataPoints[n - 1].y &&
                  (a.axisY.logarithmic
                    ? ((d =
    ...
    s.prototype.calculateAutoBreaks = function () {
      function a(a, c) {
        var b = c - a,
          d = Math.pow(10, Math.floor(Math.log(b) / Math.LN10)),
          f = Math.pow(10, Math.floor(Math.log(Math.abs(a || b)) / Math.LN10)),
          g,
          h;
        f < d
          ? ((g = Math.ceil((a * (0 < a ? 1.01 : 0.99)) / f) * f),
            (h = Math.floor((c * (0 < c ? 0.99 : 1.01)) / f) * f))
          : ((g = Math.ceil((a * (0 < a ? 1.01 : 0.99)) / d) * d),
            (h = Math.floor((c * (0 < c ? 0.99 : 1.01)) / d) * d));
        g > h &&
          ((h = Math.pow(
            0.1,
            Number((Math.log(d) / Math.LN10 + 1).toFixed(2)) >> 1
          )),
          0.01 > h
            ? ((g = Math.ceil((a * (1 + (0 < a ? h : -1 * h))) / d) * d),
              (h = Math.floor((c * (1 + (0 < c ? -1 * h : h))) / d) * d))
            : ((d /= 10),
              (g = Math.ceil((a + (0 < a ? d : -1 * d)) / d) * d),
              (h = Math.floor((c + (0 < c ? -1 * d : d)) / d) * d)));
        var k = g - a,
          m = c - h;
        if (m > 0.01 * b) {
          var l = B.getNiceNumber(m);
          h += Math.floor((0.99 * m) / l) * l;
        }
        k > 0.01 * b &&
          (b = Math.min(
            B.getNiceNumber(k),
          ...
          (g -= Math.floor((0.99 * k) / b) * b);
        return { startValue: g, endValue: h };
      }
      function f(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          var c =
          ...
          if (c || b)
            for (
              ...
              var q = d.data[a.dataSeriesIndexes[x]];
              if (!(4 > q.dataPoints.length))
                  ...
                  if (
                    (c &&
                      ((p =
                        ...
                        100),
                      (h = q.dataPoints[r].x.getTime
                        ? q.dataPoints[r].x.getTime()
                        : q.dataPoints[r].x),
                      (p = Math.floor((h - k) / p)),
                      h < g[p].min && (g[p].min = h),
                      h > g[p].max && (g[p].max = h)),
                    ...
                    if (
                      (h =
                        "waterfall" === a.type
                          ? q.dataPointEOs[r].cumulativeSum
                          : q.dataPoints[r].y) &&
                      h.length
                    )
                      for (var v = 0; v < h.length; v++)
                        (p = Math.floor((h[v] - l) / s)),
                          h[v] < f[p].min && (f[p].min = h[v]),
                          h[v] > f[p].max && (f[p].max = h[v]);
                    else
                      w(h) ||
                        ((p = Math.floor((h - l) / s)),
                        h < f[p].min && (f[p].min = h),
      ...
      function b(a) {
        if (
          ...
          for (
            ...
            var l = d.data[a.dataSeriesIndexes[m]];
            if (!(4 > l.dataPoints.length))
              for (k = 0; k < l.dataPoints.length; k++)
                (h =
                  ...
                  100),
                  (c = l.dataPoints[k].x.getTime
                    ? l.dataPoints[k].x.getTime()
                    : l.dataPoints[k].x),
                  (h = Math.floor((c - b) / h)),
                  c < g[h].min && (g[h].min = c),
                  c > g[h].max && (g[h].max = c);
      ...
      for (var c, d = this, g = !1, k = 0; k < this._axes.length; k++)
        if (
          this._axes[k].scaleBreaks &&
          this._axes[k].scaleBreaks.autoCalculate &&
          1 <= this._axes[k].scaleBreaks.maxNumberOfAutoBreaks
        ) {
          g = !0;
          ...
          for (
            ...
            100 /
              Math.max(
                parseFloat(this._axes[k].scaleBreaks.collapsibleThreshold) ||
                  10,
                10
              );
            l++
      ...
      if (g) {
        for (k = 0; k < this.plotInfo.plotTypes.length; k++)
          for (
            g = this.plotInfo.plotTypes[k], l = 0;
        ...
        for (k = 0; k < this._axes.length; k++)
          if (this._axes[k].dataInfo._dataRanges) {
            var n = this._axes[k].dataInfo.min;
            c =
              ((this._axes[k].dataInfo.max + 1 - n) *
                Math.max(
                  parseFloat(this._axes[k].scaleBreaks.collapsibleThreshold) ||
                    10,
                  10
              ...
              100;
            var h = this._axes[k].dataInfo._dataRanges,
              r,
              p,
              g = [];
            if (this._axes[k].dataInfo.dataPointYPositiveSums) {
              var m = this._axes[k].dataInfo.dataPointYPositiveSums;
              r = h;
              for (l in m)
                m.hasOwnProperty(l) &&
                  !isNaN(l) &&
                  ((p = m[l]),
                  w(p) ||
                    ((index = Math.floor((p - n) / c)),
                    p < r[index].min && (r[index].min = p),
                    p > r[index].max && (r[index].max = p)));
              delete this._axes[k].dataInfo.dataPointYPositiveSums;
            }
            if (this._axes[k].dataInfo.dataPointYNegativeSums) {
              m = this._axes[k].dataInfo.dataPointYNegativeSums;
              r = h;
              for (l in m)
                m.hasOwnProperty(l) &&
                  !isNaN(l) &&
            ...
            for (l = 0; l < h.length - 1; l++)
              if (((r = h[l].max), isFinite(r)))
                for (; l < h.length - 1; )
                  if (((n = h[l + 1].min), isFinite(n))) {
                    p = n - r;
                    p > c && g.push({ diff: p, start: r, end: n });
                    break;
                  } else l++;
            if (this._axes[k].scaleBreaks.customBreaks)
              for (
                l = 0;
                l < this._axes[k].scaleBreaks.customBreaks.length;
                l++
              )
                for (c = 0; c < g.length; c++)
                  if (
                    (this._axes[k].scaleBreaks.customBreaks[l].startValue <=
                      g[c].start &&
                      g[c].start <=
            ...
            for (
              ...
              Math.min(
                g.length,
                this._axes[k].scaleBreaks.maxNumberOfAutoBreaks
              );
              l++
            )
              (c = a(g[l].start, g[l].end)),
                this._axes[k].scaleBreaks.autoBreaks.push(
                  new da(
                    this,
                    "autoBreaks",
                    c,
                ...
                this._axes[k].scaleBreaks._appliedBreaks.push(
                  this._axes[k].scaleBreaks.autoBreaks[
                    this._axes[k].scaleBreaks.autoBreaks.length - 1
                  ]
                );
    ...
    s.prototype.getDataPointAtXY = function (a, f, b) {
      ...
      for (var c = [], d = this._dataInRenderedOrder.length - 1; 0 <= d; d--) {
        var g = null;
        (g = this._dataInRenderedOrder[d].getDataPointAtXY(a, f, b)) &&
          c.push(g);
      }
      a = null;
      f = !1;
      for (b = 0; b < c.length; b++)
        if (
          ...
          if (
            ((d = ia("markerSize", c[b].dataPoint, c[b].dataSeries) || 8),
            c[b].distance <= d / 2)
          ) {
            f = !0;
            break;
    ...
    s.prototype.getObjectAtXY = function (a, f, b) {
      ...
      else if (x) c = Ua(a, f, this._eventManager.ghostCtx);
      else
        for (b = 0; b < this.legend.items.length; b++) {
          var d = this.legend.items[b];
          a >= d.x1 && a <= d.x2 && f >= d.y1 && f <= d.y2 && (c = d.id);
        }
      return c;
    };
    ...
    s.prototype._touchEventHandler = function (a) {
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        if (!(b && 1 < b.length)) {
          ...
          d.time = new Date();
          try {
            var g = d.y - this._lastTouchData.y;
    ...
    s.prototype._dispatchRangeEvent = function (a, f) {
      ...
      for (var d = 0; d < c.length; d++)
        if ((w(b[c[d]]) && (b[c[d]] = []), "axisY" === c[d]))
          for (var g = 0; g < this.axisY.length; g++)
            b[c[d]].push({
              viewportMinimum:
                this[c[d]][g].sessionVariables.newViewportMinimum,
              viewportMaximum:
                this[c[d]][g].sessionVariables.newViewportMaximum,
            });
        else if ("axisY2" === c[d])
      ...
      s.capturedEventParam &&
        ...
        c.hasOwnProperty(b) &&
          ("mouseup" !== b || c.chart.overlaidCanvas.releaseCapture
            ? (a.target !== c.chart.overlaidCanvas && x) ||
            ...
            for (var g = 0; g < this._events.length; g++)
              if (this._events[g].hasOwnProperty(b))
                if (
                  ((c = this._events[g]),
                  (d = c.bounds),
                  f.x >= d.x1 && f.x <= d.x2 && f.y >= d.y1 && f.y <= d.y2)
                ) {
                  c[b].call(c.context, f.x, f.y);
    ...
    s.prototype._plotAreaMouseUp = function (a, f) {
      if (
        ...
        if (this.panEnabled || this.zoomEnabled) {
          if (this.panEnabled)
            for (d = g = 0; d < this._axes.length; d++)
              (b = this._axes[d]),
                b.logarithmic
            ...
            2 < Math.abs(b - d) &&
              2 < Math.abs(c - g) &&
              this._zoomPanToSelectedRegion(b, c, d, g) &&
              (k = !0);
          }
          k &&
        ...
        if (this.axisX && 0 < this.axisX.length)
          for (k = 0; k < this.axisX.length; k++)
            this.axisX[k].crosshair &&
              this.axisX[k].crosshair.enabled &&
              this.axisX[k].renderCrosshair(a, f);
        if (this.axisX2 && 0 < this.axisX2.length)
          for (k = 0; k < this.axisX2.length; k++)
            this.axisX2[k].crosshair &&
              this.axisX2[k].crosshair.enabled &&
              this.axisX2[k].renderCrosshair(a, f);
        if (this.axisY && 0 < this.axisY.length)
          for (k = 0; k < this.axisY.length; k++)
            this.axisY[k].crosshair &&
              this.axisY[k].crosshair.enabled &&
              this.axisY[k].renderCrosshair(a, f);
        if (this.axisY2 && 0 < this.axisY2.length)
          for (k = 0; k < this.axisY2.length; k++)
            this.axisY2[k].crosshair &&
              this.axisY2[k].crosshair.enabled &&
              this.axisY2[k].renderCrosshair(a, f);
      }
    };
          ...
          if (this.panEnabled)
            (d = {
              ...
              (k._panTimerId = setTimeout(
                (function (c, b, d, e) {
                  return function () {
                    k._zoomPanToSelectedRegion(c, b, d, e, !0) &&
                      (k._dispatchRangeEvent("rangeChanging", "pan"),
                      k.render(),
                      k._dispatchRangeEvent("rangeChanged", "pan"),
                      (k.dragStartPoint.x = a),
                      (k.dragStartPoint.y = f));
                  };
                })(d.x1, d.y1, d.x2, d.y2),
                0
              ));
            ...
            this.overlaidCanvasCtx.fillRect(c, l, n, h);
    ...
    s.prototype.validateRegion = function (a, f, b, c, d) {
      ...
      for (
        ...
        (("axisX" === this._axes[p].type && g) ||
          ("axisY" === this._axes[p].type && k)) &&
          h.push(this._axes[p]);
      for (k = 0; k < h.length; k++) {
        var p = h[k],
          g = !1,
          m = p.convertPixelToValue({ x: a, y: f }),
          e = p.convertPixelToValue({ x: b, y: c });
        if (m > e)
          var t = e,
            e = m,
            m = t;
        if (p.scaleBreaks)
          for (t = 0; !g && t < p.scaleBreaks._appliedBreaks.length; t++)
            g =
              p.scaleBreaks._appliedBreaks[t].startValue <= m &&
              p.scaleBreaks._appliedBreaks[t].endValue >= e;
        if (isFinite(p.dataInfo.minDiff))
          if (
            ((t = p.getAppearentDifferceReplacingBreaksToSize(m, e, null, !0)),
            !(
              g ||
              (!(
                this.panEnabled &&
            ...
            n.push(p), r.push({ val1: m, val2: e }), (l = !0);
          else if (!d) {
            l = !1;
            break;
          }
    ...
    s.prototype.preparePlotArea = function () {
      ...
      a.layoutManager = new Ba(a.x1, a.y1, a.x2, a.y2, 2);
    };
    s.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var h = this._indexLabels[a],
          ...
          p,
          m,
          l = ia("indexLabelFontColor", h.dataPoint, h.dataSeries),
          n = ia("indexLabelFontSize", h.dataPoint, h.dataSeries);
        p = ia("indexLabelFontFamily", h.dataPoint, h.dataSeries);
        m = ia("indexLabelFontStyle", h.dataPoint, h.dataSeries);
        var k = ia("indexLabelFontWeight", h.dataPoint, h.dataSeries),
          e = ia("indexLabelBackgroundColor", h.dataPoint, h.dataSeries),
          d = ia("indexLabelMaxWidth", h.dataPoint, h.dataSeries),
          g = ia("indexLabelWrap", h.dataPoint, h.dataSeries),
          t = ia("indexLabelLineDashType", h.dataPoint, h.dataSeries),
          q = ia("indexLabelLineColor", h.dataPoint, h.dataSeries),
          C = w(h.dataPoint.indexLabelLineThickness)
            ? w(h.dataSeries.options.indexLabelLineThickness)
              ? 0
        ...
        var G = h.dataPoint.indexLabelFormatter
          ? h.dataPoint.indexLabelFormatter(E)
          ...
          ? h.dataSeries.indexLabelFormatter(E)
          ...
          : null;
        if (null !== G && "" !== G) {
          var u = ia("indexLabelPlacement", h.dataPoint, h.dataSeries),
            E = ia("indexLabelOrientation", h.dataPoint, h.dataSeries),
            s = h.direction,
            D = h.dataSeries.axisX,
          ...
          e.measureText();
          h.dataSeries.indexLabelMaxWidth = e.maxWidth;
          if ("stackedarea100" === r) {
            if (
              h.point.x < b.x1 ||
              h.point.x > b.x2 ||
            ...
            if (
              h.dataPoint.x < D.viewportMinimum ||
              h.dataPoint.x > D.viewportMaximum ||
          ...
          d = k = 2;
          "horizontal" === E
            ? ((l = e.width), (n = e.height))
            : ((n = e.width), (l = e.height));
                ...
                0 < s
                  ...
                  : ((m = h.point.y + k + c),
                    m > g - n - k - c &&
                      ((m =
                        "auto" === u
                          ? Math.min(h.point.y, g) - n - k - c
                          : g - n - k - c),
                      (v = m < h.point.y))))
              : ((d = Math.max(h.bounds.y1, b.y1)),
                (g = Math.min(h.bounds.y2, b.y2)),
                (c =
                  0 <= r.indexOf("range") || "error" === r
                    ? 0 < s
                      ? Math.max(h.bounds.y1, b.y1) + n / 2 + k
                      : Math.min(h.bounds.y2, b.y2) - n / 2 - k
                    : (Math.max(h.bounds.y1, b.y1) +
                        Math.min(h.bounds.y2, b.y2)) /
                      2),
                0 < s
                  ? ((m = Math.max(h.point.y, c) - n / 2),
                    m < d &&
                      ("bubble" === r || "scatter" === r) &&
                      (m = Math.max(h.point.y - n - k, b.y1 + k)))
                  : ((m = Math.min(h.point.y, c) - n / 2),
                    m > g - n - k &&
                      ("bubble" === r || "scatter" === r) &&
                      (m = Math.min(h.point.y + k, b.y2 - n - k))),
                (m = Math.min(m, g - n)));
          } else
            0 <= r.indexOf("line") ||
            0 <= r.indexOf("area") ||
                  ...
                  0 > s
                    ...
                    : ((p = h.point.x + d + c),
                      p > g - l - d - c &&
                        ((p =
                          "auto" === u
                            ? Math.min(h.point.x, g) - l - d - c
                            : g - l - d - c),
                        (v = p < h.point.x))))
                : ((k = Math.max(h.bounds.x1, b.x1)),
                  Math.min(h.bounds.x2, b.x2),
                  (c =
                    0 <= r.indexOf("range") || "error" === r
                      ? 0 > s
                        ? Math.max(h.bounds.x1, b.x1) + l / 2 + d
                        : Math.min(h.bounds.x2, b.x2) - l / 2 - d
          ...
          C &&
            ...
            ((0 > r.indexOf("column") &&
              ...
              !v) &&
            ((f.lineWidth = C),
            (f.strokeStyle = q ? q : "gray"),
            f.setLineDash && f.setLineDash(F(t, C)),
            f.beginPath(),
            f.moveTo(h.point.x, h.point.y),
            0 <= r.indexOf("bar") || ("error" === r && h.axisSwapped)
              ...
              : f.lineTo(
                  p + l / 2,
                  m +
                    ((m < h.point.y ? n : -n) + ("horizontal" === E ? n : -n)) /
                      2
                ),
            f.stroke());
        }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (h = this._indexLabels[a]),
          (e = ia("indexLabelBackgroundColor", h.dataPoint, h.dataSeries)),
          (h.dataSeries.indexLabelBackgroundColor = w(e)
            ? x
              ? "transparent"
              : null
            : e);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], k, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var r = h.dataPoints,
            p = "solid";
          if (b.setLineDash) {
            var m = F(h.nullDataLineDashType, h.lineThickness),
              p = h.lineDashType,
              e = F(p, h.lineThickness);
            b.setLineDash(e);
          }
          var t = h.id;
          ...
          var t = h._colorSet,
            q =
              (t =
              h.lineColor =
                h.options.lineColor ? h.options.lineColor : t[0]);
          b.strokeStyle = t;
          var C = !0,
            u = 0,
            E,
                  ...
                  C || s
                    ? (!C && h.connectNullData
                        ? (b.setLineDash &&
                            ...
                            b.beginPath(),
                            b.moveTo(k.x, k.y),
                            (p = h.nullDataLineDashType),
                            b.setLineDash(m)),
                          b.lineTo(E, G),
                          x && c.lineTo(E, G))
                        : (b.beginPath(),
                          b.moveTo(E, G),
                          x && (c.beginPath(), c.moveTo(E, G))),
                      (s = C = !1))
                    : (b.lineTo(E, G),
                      x && c.lineTo(E, G),
                      0 == u % 500 &&
                        ...
                        b.beginPath(),
                        b.moveTo(E, G),
                        x && (c.stroke(), c.beginPath(), c.moveTo(E, G))));
                  k = { x: E, y: G };
                  u < r.length - 1 &&
                    (q !== (r[u].lineColor || t) ||
                      p !== (r[u].lineDashType || h.lineDashType)) &&
                    (b.stroke(),
                    b.beginPath(),
                    b.moveTo(E, G),
                    (q = r[u].lineColor || t),
                    ...
                    b.setLineDash &&
                      (r[u].lineDashType
                        ? ((p = r[u].lineDashType),
                          b.setLineDash(F(p, h.lineThickness)))
                        : ((p = h.lineDashType), b.setLineDash(e))));
                  if (0 < r[u].markerSize || 0 < h.markerSize) {
                    var A = h.getMarkerProperties(u, E, G, b);
                    g.push(A);
                    w = P(w);
                    x &&
                      g.push({
                  ...
                  u < r.length - 1 &&
                    ...
                    b.setLineDash &&
                      (r[u].lineDashType
                        ...
                        : ((p = h.lineDashType), b.setLineDash(e))));
                  if (0 < r[u].markerSize || 0 < h.markerSize)
                    (w = h.getMarkerProperties(u, E, G, b)),
                      g.push(w),
                      (A = P(A)),
                      x &&
                        g.push({
          ...
          for (var b = 0; b < a.length - 3; b += 3)
            if (
              ...
              c.stroke(),
                ...
                x &&
                  (d.stroke(), d.beginPath(), d.moveTo(a[b + 3].x, a[b + 3].y));
          c.stroke();
          x && d.stroke();
        }
      }
            ...
            for (E = !1, C = 0; C < r.length; C++)
              if (
                ...
                if ("number" !== typeof r[C].y)
                  ...
                  C < r.length - 1 &&
                    (q !== (r[C].lineColor || t) ||
                      p !== (r[C].lineDashType || h.lineDashType)) &&
                    ((q = r[C].lineColor || t),
                    (G[G.length - 1].newStrokeStyle = q),
                    c.setLineDash &&
                      (r[C].lineDashType
                        ? ((p = r[C].lineDashType),
                        ...
                        : ((p = h.lineDashType),
                          (G[G.length - 1].newLineDashArray = e))));
                  if (0 < r[C].markerSize || 0 < h.markerSize) {
                    var w = h.getMarkerProperties(C, u, E, c);
                    k.push(w);
                    s = P(s);
                    x &&
                      k.push({
    ...
    var W = function (a, f, b, c, d, g, k, l, n, h, r, p, m) {
      "undefined" === typeof m && (m = 1);
      k = k || 0;
      l = l || "black";
      var e = 15 < c - f && 15 < d - b ? 8 : 0.35 * Math.min(c - f, d - b);
      a.beginPath();
      a.moveTo(f, b);
      a.save();
      a.fillStyle = g;
      a.globalAlpha = m;
      a.fillRect(f, b, c - f, d - b);
      a.globalAlpha = 1;
      0 < k &&
        ((m = 0 === k % 2 ? 0 : 0.5),
        a.beginPath(),
        ...
        (a.strokeStyle = l),
        a.moveTo(f, b),
        a.rect(f - m, b - m, c - f + 2 * m, d - b + 2 * m),
        a.stroke());
      a.restore();
      !0 === n &&
        (a.save(),
        ...
        a.lineTo(c, b),
        a.closePath(),
        (k = a.createLinearGradient((c + f) / 2, b + e, (c + f) / 2, b)),
        k.addColorStop(0, g),
        k.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (a.fillStyle = k),
        a.fill(),
        a.restore());
      !0 === h &&
        ...
        a.lineTo(c, d),
        a.closePath(),
        (k = a.createLinearGradient((c + f) / 2, d - e, (c + f) / 2, d)),
        k.addColorStop(0, g),
        k.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (a.fillStyle = k),
        a.fill(),
      ...
      !0 === r &&
        ...
        a.lineTo(f, d),
        a.closePath(),
        (k = a.createLinearGradient(f + e, (d + b) / 2, f, (d + b) / 2)),
        k.addColorStop(0, g),
        k.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (a.fillStyle = k),
        a.fill(),
        a.restore());
      !0 === p &&
        ...
        a.lineTo(c - e, d - e),
        a.lineTo(c, d),
        (k = a.createLinearGradient(c - e, (d + b) / 2, c, (d + b) / 2)),
        k.addColorStop(0, g),
        k.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (a.fillStyle = k),
        k.addColorStop(0, g),
    ...
    s.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < t.length)
            for (
              var q = 5 < p && e.bevelEnabled ? !0 : !1, g = 0;
              g < t.length;
              g++
            )
              if (
                (t[g].getTime ? (n = t[g].x.getTime()) : (n = t[g].x),
                !(
                  n < a.axisX.dataInfo.viewPortMin ||
                  n > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof t[g].y)
              ) {
                k = a.axisX.convertValueToPixel(n);
                l = a.axisY.convertValueToPixel(t[g].y);
                k = a.axisX.reversed
                  ? (k +
                      (a.plotType.totalDataSeries * p) / 2 -
                      (a.previousDataSeriesCount + r) * p) <<
                    0
                  : (k -
                      (a.plotType.totalDataSeries * p) / 2 +
                      (a.previousDataSeriesCount + r) * p) <<
                    0;
                var C = a.axisX.reversed ? (k - p) << 0 : (k + p) << 0,
                  u;
                0 <= t[g].y ? (u = h) : ((u = l), (l = h));
                l > u && ((c = l), (l = u), (u = c));
                c = t[g].color
                  ? t[g].color
                  : e._colorSet[g % e._colorSet.length];
                W(
                  b,
                  k,
                  l,
                ...
                (t[g].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    point: {
                      x: k + (C - k) / 2,
                      y: 0 > t[g].y === a.axisY.reversed ? l : u,
                    },
                    direction: 0 > t[g].y === a.axisY.reversed ? 1 : -1,
                    bounds: {
                      x1: k,
                      y1: Math.min(l, u),
                      x2: C,
    ...
    s.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        r = this.dataPointMaxWidth
          ...
          ? this.dataPointWidth
          : (0.15 * this.width) << 0;
        var e = a.axisX.dataInfo.minDiff;
        isFinite(e) || (e = 0.3 * Math.abs(a.axisX.range));
        e = this.dataPointWidth
          ? this.dataPointWidth
          : (0.9 *
              ((d.width *
                (a.axisX.logarithmic
                  ? Math.log(e) / Math.log(a.axisX.range)
                  : Math.abs(e) / Math.abs(a.axisX.range))) /
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          var q = a.dataSeriesIndexes[t],
            C = this.data[q],
            u = C.dataPoints;
          if (0 < u.length) {
            var E = 5 < e && C.bevelEnabled ? !0 : !1;
            b.strokeStyle = "#4572A7 ";
            for (h = 0; h < u.length; h++)
              if (
                ((c = u[h].x.getTime ? u[h].x.getTime() : u[h].x),
                !(
                ...
                var G =
                    (r - (a.plotType.plotUnits.length * e) / 2 + a.index * e) <<
                    0,
                  s = (G + e) << 0,
                  w;
                if (
                  ...
                  (n[c] = u[h].y + (n[c] ? n[c] : 0)),
                    (w = a.axisY.convertValueToPixel(n[c])),
                    (p = "undefined" !== typeof k[c] ? k[c] : m),
                    (k[c] = w);
                else if (
                  ((p = a.axisY.convertValueToPixel(u[h].y)), 0 <= u[h].y)
                ) {
    ...
    s.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < u.length)
            for (
              var E = 5 < e && C.bevelEnabled ? !0 : !1, h = 0;
              h < u.length;
              h++
            )
              if (
                ...
                if (
                  ...
                  (n[c] = p + ("undefined" !== typeof n[c] ? n[c] : 0)),
                    (w = a.axisY.convertValueToPixel(n[c])),
                    (p = k[c] ? k[c] : m),
                    (k[c] = w);
                else if (((p = a.axisY.convertValueToPixel(p)), 0 <= u[h].y)) {
                  var A = "undefined" !== typeof g[c] ? g[c] : 0;
                  p -= A;
                  w = m - A;
                  g[c] = A + (w - p);
          ...
          if (0 < t.length) {
            ...
            for (g = 0; g < t.length; g++)
              if (
                ...
                k = a.axisY.convertValueToPixel(t[g].y);
                l = a.axisX.reversed
                  ? (l +
                      (a.plotType.totalDataSeries * p) / 2 -
                      (a.previousDataSeriesCount + r) * p) <<
                  ...
                  : (l -
                      ...
                      (a.previousDataSeriesCount + r) * p) <<
                    0;
                var C = a.axisX.reversed ? (l - p) << 0 : (l + p) << 0,
                  u;
                0 <= t[g].y ? (u = h) : ((u = k), (k = h));
                c = t[g].color
                  ? t[g].color
                  : e._colorSet[g % e._colorSet.length];
                W(b, u, l, k, C, c, 0, null, q, !1, !1, !1, e.fillOpacity);
                c = e.dataPointIds[g];
                this._eventManager.objectMap[c] = {
                  id: c,
                  objectType: "dataPoint",
          ...
          if (0 < u.length) {
            ...
            for (h = 0; h < u.length; h++)
              if (
                ...
                var w =
                    (p - (a.plotType.plotUnits.length * e) / 2 + a.index * e) <<
                    0,
                  s = (w + e) << 0,
                  v;
                if (
                  ...
                  (n[c] = u[h].y + (n[c] ? n[c] : 0)),
                    (r = k[c] ? k[c] : m),
                    (k[c] = v = a.axisY.convertValueToPixel(n[c]));
                else if (
                ...
                c = u[h].color
                  ? u[h].color
                  : C._colorSet[h % C._colorSet.length];
                W(b, v, w, r, s, c, 0, null, E, !1, !1, !1, C.fillOpacity);
                c = C.dataPointIds[h];
                this._eventManager.objectMap[c] = {
                  id: c,
                  objectType: "dataPoint",
            ...
            for (h = 0; h < u.length; h++)
              if (
                ...
                if (
                  ...
                  (n[c] = w + (n[c] ? n[c] : 0)),
                    (r = k[c] ? k[c] : m),
                    (k[c] = w = a.axisY.convertValueToPixel(n[c]));
                else if (((r = a.axisY.convertValueToPixel(w)), 0 <= u[h].y)) {
                  var A = g[c] ? g[c] : 0;
                  w = m + A;
                  r += A;
                  g[c] = A + (r - w);
                ...
                c = u[h].color
                  ? u[h].color
                  : C._colorSet[h % C._colorSet.length];
                W(b, w, s, r, v, c, 0, null, E, !1, !1, !1, C.fillOpacity);
                c = C.dataPointIds[h];
                this._eventManager.objectMap[c] = {
                  id: c,
                  objectType: "dataPoint",
    ...
    s.prototype.renderArea = function (a) {
      ...
      function c() {
        A &&
          (0 < t.lineThickness && g.stroke(),
          a.axisY.logarithmic ||
          (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum)
            ? (v = s)
            : 0 > a.axisY.viewportMaximum
            ? (v = n.y1)
            : 0 < a.axisY.viewportMinimum && (v = l.y2),
          g.lineTo(u, v),
          g.lineTo(A.x, v),
          g.closePath(),
          (g.globalAlpha = t.fillOpacity),
          g.fill(),
          (g.globalAlpha = 1),
          x && (k.lineTo(u, v), k.lineTo(A.x, v), k.closePath(), k.fill()),
          g.beginPath(),
          g.moveTo(u, E),
          k.beginPath(),
          k.moveTo(u, E),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        g.clip();
        x && (k.beginPath(), k.rect(r.x1, r.y1, r.width, r.height), k.clip());
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          var C = 0,
            ...
            A = null;
          if (0 < q.length) {
            var y = t._colorSet[C % t._colorSet.length],
              z = (t.lineColor = t.options.lineColor || y),
              S = z;
            g.fillStyle = y;
            g.strokeStyle = z;
            g.lineWidth = t.lineThickness;
            b = "solid";
            if (g.setLineDash) {
              var Y = F(t.nullDataLineDashType, t.lineThickness);
              b = t.lineDashType;
              var ca = F(b, t.lineThickness);
              g.setLineDash(ca);
            }
            for (var $ = !0; C < q.length; C++)
              if (
                ((w = q[C].x.getTime ? q[C].x.getTime() : q[C].x),
                !(
                ...
                if ("number" !== typeof q[C].y)
                  t.connectNullData || $ || f || c(), ($ = !0);
                else {
                  u = a.axisX.convertValueToPixel(w);
                  E = a.axisY.convertValueToPixel(q[C].y);
                  f || $
                    ? (!f && t.connectNullData
                        ? (g.setLineDash &&
                            ...
                            (E = b),
                            (A = p),
                            (b = t.nullDataLineDashType),
                            g.setLineDash(Y)),
                          g.lineTo(u, E),
                          x && k.lineTo(u, E))
                        : (g.beginPath(),
                          g.moveTo(u, E),
                          x && (k.beginPath(), k.moveTo(u, E)),
                          (A = { x: u, y: E })),
                      ($ = f = !1))
                    : (g.lineTo(u, E),
                      x && k.lineTo(u, E),
                  ...
                  C < q.length - 1 &&
                    (S !== (q[C].lineColor || z) ||
                      b !== (q[C].lineDashType || t.lineDashType)) &&
                    (c(),
                    (S = q[C].lineColor || z),
                    (g.strokeStyle = S),
                    g.setLineDash &&
                      (q[C].lineDashType
                        ? ((b = q[C].lineDashType),
                          g.setLineDash(F(b, t.lineThickness)))
                        : ((b = t.lineDashType), g.setLineDash(ca))));
                  var N = t.dataPointIds[C];
                  ...
                  0 !== q[C].markerSize &&
                    (0 < q[C].markerSize || 0 < t.markerSize) &&
                    ((w = t.getMarkerProperties(C, u, E, g)),
                    h.push(w),
                    (N = P(N)),
                    x &&
                      h.push({
                  ...
                  (q[C].indexLabel ||
                    ...
                    this._indexLabels.push({
                      ...
                      dataSeries: t,
                      point: { x: u, y: E },
                      direction: 0 > q[C].y === a.axisY.reversed ? 1 : -1,
                      color: y,
                    });
                }
            c();
    ...
    s.prototype.renderSplineArea = function (a) {
          ...
          if (0 < p.lineThickness) {
            ...
            for (var e = 0; e < b.length - 3; e += 3)
              if (
                ...
                b[e + 3].newStrokeStyle || b[e + 3].newLineDashArray)
              )
                c.stroke(),
                  c.beginPath(),
                  c.moveTo(b[e + 3].x, b[e + 3].y),
                  b[e + 3].newStrokeStyle &&
                    (c.strokeStyle = b[e + 3].newStrokeStyle),
                  b[e + 3].newLineDashArray &&
                    c.setLineDash(b[e + 3].newLineDashArray);
            c.stroke();
          }
          c.beginPath();
          c.moveTo(b[0].x, b[0].y);
          x && (d.beginPath(), d.moveTo(b[0].x, b[0].y));
          for (e = 0; e < b.length - 3; e += 3)
            c.bezierCurveTo(
              b[e + 1].x,
              b[e + 1].y,
              b[e + 2].x,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.clip();
        x && (d.beginPath(), d.rect(n.x1, n.y1, n.width, n.height), d.clip());
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          var l = [],
            ...
            w = [];
          if (0 < m.length) {
            var s = p._colorSet[e % p._colorSet.length],
              v = (p.lineColor = p.options.lineColor || s),
              A = v;
            c.fillStyle = s;
            c.strokeStyle = v;
            ...
            var za = "solid";
            if (c.setLineDash) {
              var z = F(p.nullDataLineDashType, p.lineThickness),
                za = p.lineDashType,
                S = F(za, p.lineThickness);
              c.setLineDash(S);
            }
            for (q = !1; e < m.length; e++)
              if (
                ((t = m[e].x.getTime ? m[e].x.getTime() : m[e].x),
                !(
                ...
                if ("number" !== typeof m[e].y)
                    ...
                    (p.connectNullData
                      ? c.setLineDash &&
                        ...
                        (p.options.nullDataLineDashType ||
                          !m[e - 1].lineDashType) &&
                        ((w[w.length - 1].newLineDashArray = z),
                        (za = p.nullDataLineDashType))
                      : (f(), (w = []))),
                    (q = !0);
                else {
                  t = a.axisX.convertValueToPixel(t);
                  q = a.axisY.convertValueToPixel(m[e].y);
                  var Y = p.dataPointIds[e];
                  ...
                  e < m.length - 1 &&
                    (A !== (m[e].lineColor || v) ||
                      za !== (m[e].lineDashType || p.lineDashType)) &&
                    ((A = m[e].lineColor || v),
                    (w[w.length - 1].newStrokeStyle = A),
                    c.setLineDash &&
                      (m[e].lineDashType
                        ? ((za = m[e].lineDashType),
                          (w[w.length - 1].newLineDashArray = F(
                            za,
                            p.lineThickness
                          )))
                        : ((za = p.lineDashType),
                          (w[w.length - 1].newLineDashArray = S))));
                  if (
                    0 !== m[e].markerSize &&
                    (0 < m[e].markerSize || 0 < p.markerSize)
                  ) {
                    var ca = p.getMarkerProperties(e, t, q, c);
                    l.push(ca);
                    Y = P(Y);
                    x &&
                      l.push({
                  ...
                  (m[e].indexLabel ||
                    ...
                    this._indexLabels.push({
                      ...
                      dataSeries: p,
                      point: { x: t, y: q },
                      direction: 0 > m[e].y === a.axisY.reversed ? 1 : -1,
                      color: s,
                    });
                  q = !1;
                }
      ...
      function c() {
        A &&
          ...
          (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum)
            ...
            : 0 > a.axisY.viewportMaximum
            ? (D = n.y1)
            : 0 < a.axisY.viewportMinimum && (D = l.y2),
          g.lineTo(u, D),
          g.lineTo(A.x, D),
          g.closePath(),
          (g.globalAlpha = t.fillOpacity),
          g.fill(),
          (g.globalAlpha = 1),
          x && (k.lineTo(u, D), k.lineTo(A.x, D), k.closePath(), k.fill()),
          g.beginPath(),
          g.moveTo(u, w),
          k.beginPath(),
          k.moveTo(u, w),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < q.length) {
            ...
            var Y = "solid";
            if (g.setLineDash) {
              var ca = F(t.nullDataLineDashType, t.lineThickness),
                Y = t.lineDashType,
                $ = F(Y, t.lineThickness);
              g.setLineDash($);
            }
            for (; C < q.length; C++)
              if (
                ((s = q[C].x.getTime ? q[C].x.getTime() : q[C].x),
                !(
                ...
                var N = w;
                "number" !== typeof q[C].y
                  ? (t.connectNullData || b || f || c(), (b = !0))
                  : ((u = a.axisX.convertValueToPixel(s)),
                    (w = a.axisY.convertValueToPixel(q[C].y)),
                    f || b
                      ? (!f && t.connectNullData
                          ? (g.setLineDash &&
                              (t.options.nullDataLineDashType ||
                              ...
                              (w = b),
                              (A = p),
                              (Y = t.nullDataLineDashType),
                              g.setLineDash(ca)),
                            g.lineTo(u, N),
                            g.lineTo(u, w),
                            x && (k.lineTo(u, N), k.lineTo(u, w)))
                          : (g.beginPath(),
                            g.moveTo(u, w),
                            x && (k.beginPath(), k.moveTo(u, w)),
                            (A = { x: u, y: w })),
                        (b = f = !1))
                      : (g.lineTo(u, N),
                        x && k.lineTo(u, N),
                    ...
                    C < q.length - 1 &&
                      (S !== (q[C].lineColor || z) ||
                        Y !== (q[C].lineDashType || t.lineDashType)) &&
                      (c(),
                      (S = q[C].lineColor || z),
                      (g.strokeStyle = S),
                      g.setLineDash &&
                        (q[C].lineDashType
                          ? ((Y = q[C].lineDashType),
                            g.setLineDash(F(Y, t.lineThickness)))
                          : ((Y = t.lineDashType), g.setLineDash($)))),
                    (s = t.dataPointIds[C]),
                    (this._eventManager.objectMap[s] = {
                      id: s,
                      objectType: "dataPoint",
                    ...
                    0 !== q[C].markerSize &&
                      (0 < q[C].markerSize || 0 < t.markerSize) &&
                      ((N = t.getMarkerProperties(C, u, w, g)),
                      h.push(N),
                      (s = P(s)),
                      x &&
                        h.push({
    ...
    s.prototype.renderStackedArea = function (a) {
      function f() {
        if (!(1 > n.length)) {
          ...
          c.globalAlpha = 1;
          c.beginPath();
          x && (C.closePath(), C.fill(), C.beginPath());
          n = [];
        }
      }
      var b = a.targetCanvasCtx || this.plotArea.ctx,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.clip();
        x && (C.beginPath(), C.rect(k.x1, k.y1, k.width, k.height), C.clip());
        for (var d = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
          var D = a.dataSeriesIndexes[v],
            A = this.data[D],
            y = A.dataPoints;
          A.dataPointIndexes = [];
          for (p = 0; p < y.length; p++)
            (D = y[p].x.getTime ? y[p].x.getTime() : y[p].x),
              (A.dataPointIndexes[D] = p),
              d[D] || (h.push(D), (d[D] = !0));
          h.sort(Na);
        }
        for (v = 0; v < a.dataSeriesIndexes.length; v++) {
          D = a.dataSeriesIndexes[v];
          A = this.data[D];
          y = A.dataPoints;
          w = !0;
          n = [];
          ...
          if (0 < h.length) {
            var d = A._colorSet[0],
              z = (A.lineColor = A.options.lineColor || d),
              S = z;
            c.fillStyle = d;
            c.strokeStyle = z;
            ...
            for (var $ = !0, p = 0; p < h.length; p++) {
              t = h[p];
              var N = null,
                N =
                  0 <= A.dataPointIndexes[t]
                    ? y[A.dataPointIndexes[t]]
                    : { x: t, y: null };
              if (
                !(
                  t < a.axisX.dataInfo.viewPortMin ||
                ...
                if ("number" !== typeof N.y)
                  ...
                  if (
                    ...
                    r[t] = N.y + (r[t] ? r[t] : 0);
                    if (0 >= r[t] && a.axisY.logarithmic) continue;
                    e = a.axisY.convertValueToPixel(r[t]);
                  } else (e = a.axisY.convertValueToPixel(N.y)), (e -= I);
                  n.push({ x: m, y: q - I });
                  l[t] = q - e;
                  w || $
                    ? (!w && A.connectNullData
                  ...
                  p < y.length - 1 &&
                    (S !== (y[p].lineColor || z) ||
                      s !== (y[p].lineDashType || A.lineDashType)) &&
                    (f(),
                    c.beginPath(),
                    c.moveTo(m, e),
                    n.push({ x: m, y: q - I }),
                  ...
                  if (0 <= A.dataPointIndexes[t]) {
                    var la = A.dataPointIds[A.dataPointIndexes[t]];
                    this._eventManager.objectMap[la] = {
                      id: la,
                      objectType: "dataPoint",
                      dataSeriesIndex: D,
                      dataPointIndex: A.dataPointIndexes[t],
                      x1: m,
                      y1: e,
                    };
                  }
                  0 <= A.dataPointIndexes[t] &&
                    0 !== N.markerSize &&
                    (0 < N.markerSize || 0 < A.markerSize) &&
                    ((t = A.getMarkerProperties(
                      A.dataPointIndexes[t],
                      m,
                      e,
                      c
                    )),
    ...
    s.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.rect(g.x1, g.y1, g.width, g.height);
        c.clip();
        x && (v.beginPath(), v.rect(g.x1, g.y1, g.width, g.height), v.clip());
        for (var d = [], y = 0; y < a.dataSeriesIndexes.length; y++) {
          var D = a.dataSeriesIndexes[y],
            A = this.data[D],
            z = A.dataPoints;
          A.dataPointIndexes = [];
          for (p = 0; p < z.length; p++)
            (D = z[p].x.getTime ? z[p].x.getTime() : z[p].x),
              (A.dataPointIndexes[D] = p),
              d[D] || (h.push(D), (d[D] = !0));
          h.sort(Na);
        }
        for (y = 0; y < a.dataSeriesIndexes.length; y++) {
          D = a.dataSeriesIndexes[y];
          A = this.data[D];
          z = A.dataPoints;
          w = !0;
          d = A.id;
          ...
          n = [];
          if (0 < h.length) {
            var d = A._colorSet[p % A._colorSet.length],
              B = (A.lineColor = A.options.lineColor || d),
              S = B;
            c.fillStyle = d;
            c.strokeStyle = B;
            c.lineWidth = A.lineThickness;
            ...
            for (var $ = !0, p = 0; p < h.length; p++) {
              ...
              if (
                ...
                if ("number" !== typeof N.y)
                  ...
                  var I;
                  I =
                    0 !== a.dataPointYSums[t]
                      ? 100 * (N.y / a.dataPointYSums[t])
                      : 0;
                  m = a.axisX.convertValueToPixel(t);
                  var la = l[t] ? l[t] : 0;
                  if (
                    ...
                    if (0 >= r[t] && a.axisY.logarithmic) continue;
                    e = a.axisY.convertValueToPixel(r[t]);
                  } else (e = a.axisY.convertValueToPixel(I)), (e -= la);
                  n.push({ x: m, y: s - la });
                  l[t] = s - e;
                  w || $
                    ? (!w && A.connectNullData
                  ...
                  p < z.length - 1 &&
                    (S !== (z[p].lineColor || B) ||
                      u !== (z[p].lineDashType || A.lineDashType)) &&
                    (f(),
                    c.beginPath(),
                    c.moveTo(m, e),
                    n.push({ x: m, y: s - la }),
                  ...
                  if (0 <= A.dataPointIndexes[t]) {
                    var pa = A.dataPointIds[A.dataPointIndexes[t]];
                  ...
                  0 <= A.dataPointIndexes[t] &&
                    0 !== N.markerSize &&
                    (0 < N.markerSize || 0 < A.markerSize) &&
                    ((t = A.getMarkerProperties(p, m, e, c)),
                    k.push(t),
                    (markerColor = P(pa)),
                    x &&
                      k.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          for (
            ...
            (g = m[d].getTime ? (g = m[d].x.getTime()) : (g = m[d].x)),
              g < a.axisX.dataInfo.viewPortMin ||
                g > a.axisX.dataInfo.viewPortMax ||
                "undefined" === typeof m[d].z ||
                ((e = m[d].z), e > l && (l = e), e < n && (n = e));
        for (
          var t = 25 * Math.PI,
            q = Math.max(
          ...
          if (
            ...
            for (b.strokeStyle = "#4572A7 ", d = 0; d < m.length; d++)
              if (
                ...
                k = a.axisY.convertValueToPixel(m[d].y);
                var e = m[d].z,
                  w =
                    2 *
                    Math.max(
                      Math.sqrt(
                        (l === n ? q / 2 : t + ((q - t) / (l - n)) * (e - n)) /
                          Math.PI
                      ) << 0,
                      1
                    ),
                  e = p.getMarkerProperties(d, b);
                e.size = w;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            ...
            for (var p = 0, m = 0, d = 0; d < r.length; d++)
              if (
                ((g = r[d].getTime ? (g = r[d].x.getTime()) : (g = r[d].x)),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof r[d].y)
                ...
                g = a.axisX.convertValueToPixel(g);
                k = a.axisY.convertValueToPixel(r[d].y);
                var e = h.getMarkerProperties(d, g, k, b);
    ...
    s.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          var C = a.dataSeriesIndexes[q],
            u = this.data[C],
            s = u.dataPoints;
          if (0 < s.length)
            for (
              var v = 5 < t && u.bevelEnabled ? !0 : !1, l = 0;
              l < s.length;
              l++
            )
              if (
                (s[l].getTime ? (e = s[l].x.getTime()) : (e = s[l].x),
                !(
                  e < a.axisX.dataInfo.viewPortMin ||
                  e > a.axisX.dataInfo.viewPortMax
                ) &&
                ...
                n = a.axisX.convertValueToPixel(e);
                h = a.axisY.convertValueToPixel(s[l].y[0]);
                r = a.axisY.convertValueToPixel(s[l].y[1]);
                p = a.axisY.convertValueToPixel(s[l].y[2]);
                m = a.axisY.convertValueToPixel(s[l].y[3]);
                var y = (n - t / 2) << 0,
                  D = (y + t) << 0,
                  g = u.options.fallingColor ? u.fallingColor : u._colorSet[0],
                  d = s[l].color ? s[l].color : u._colorSet[0],
                ...
                "candlestick" === u.type
                  ? (b.moveTo(n - z, r),
                    b.lineTo(n - z, Math.min(h, m)),
                    b.stroke(),
                    b.moveTo(n - z, Math.max(h, m)),
                    b.lineTo(n - z, p),
                    b.stroke(),
                    W(
                      b,
                    ...
                    x &&
                      ...
                      (c.strokeStyle = d),
                      c.moveTo(n - z, r),
                      c.lineTo(n - z, Math.min(h, m)),
                      c.stroke(),
                      c.moveTo(n - z, Math.max(h, m)),
                      c.lineTo(n - z, p),
                      c.stroke(),
                      W(
                        c,
                ...
                (s[l].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: s[l],
                    dataSeries: u,
                    point: { x: y + (D - y) / 2, y: a.axisY.reversed ? p : r },
                    direction: 1,
                    bounds: {
                      x1: y,
                      y1: Math.min(r, p),
    ...
    s.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var q = !1, q = !!a.axisY.reversed, s = 0;
          ...
          if (0 < G.length)
            for (
              var y = 5 < t && v.bevelEnabled ? !0 : !1, k = 0;
              k < G.length;
              k++
            )
              if (
                (G[k].getTime ? (e = G[k].x.getTime()) : (e = G[k].x),
                !(
                  e < a.axisX.dataInfo.viewPortMin ||
                  e > a.axisX.dataInfo.viewPortMax
                ) &&
                  !w(G[k].y) &&
                  G[k].y.length &&
                  "number" === typeof G[k].y[0] &&
                  "number" === typeof G[k].y[1] &&
                  "number" === typeof G[k].y[2] &&
                  "number" === typeof G[k].y[3] &&
                  "number" === typeof G[k].y[4] &&
                  5 === G[k].y.length)
              ) {
                l = a.axisX.convertValueToPixel(e);
                n = a.axisY.convertValueToPixel(G[k].y[0]);
                h = a.axisY.convertValueToPixel(G[k].y[1]);
                r = a.axisY.convertValueToPixel(G[k].y[2]);
                p = a.axisY.convertValueToPixel(G[k].y[3]);
                m = a.axisY.convertValueToPixel(G[k].y[4]);
                var D = (l - t / 2) << 0,
                  A = (l + t / 2) << 0,
                  d = G[k].color ? G[k].color : v._colorSet[0],
                  ...
                  S = G[k].whiskerColor
                    ...
                    : d,
                  Y =
                    "number" === typeof G[k].whiskerThickness
                      ? G[k].whiskerThickness
                      : "number" === typeof v.options.whiskerThickness
                      ? v.whiskerThickness
                      : z,
                  ca = G[k].whiskerDashType
                    ? G[k].whiskerDashType
                    : v.whiskerDashType,
                  $ = w(G[k].whiskerLength)
                    ? w(v.options.whiskerLength)
                      ? t
                      : v.whiskerLength
                    : G[k].whiskerLength,
                  $ =
                  ...
                  I = G[k].stemColor
                    ...
                    : d,
                  la =
                    "number" === typeof G[k].stemThickness
                      ? G[k].stemThickness
                      : "number" === typeof v.options.stemThickness
                      ? v.stemThickness
                      : z,
                  pa = 1 === Math.round(la) % 2 ? 0.5 : 0,
                  cb = G[k].stemDashType ? G[k].stemDashType : v.stemDashType,
                  O = G[k].lineColor
                    ? G[k].lineColor
                    : G[k].color
                    ? v.lineColor
                    ...
                    : d,
                  J =
                    "number" === typeof G[k].lineThickness
                      ? G[k].lineThickness
                      : "number" === typeof v.options.lineThickness
                      ? v.lineThickness
                      : z,
                  R = G[k].lineDashType ? G[k].lineDashType : v.lineDashType,
                  K = 1 === Math.round(J) % 2 ? 0.5 : 0,
                  U = v.upperBoxColor,
                  db = v.lowerBoxColor,
                  M = w(v.options.fillOpacity) ? 1 : v.fillOpacity,
                  ha = v.dataPointIds[k];
                ...
                0 < la &&
                  ...
                  (b.strokeStyle = I),
                  (b.lineWidth = la),
                  b.setLineDash && b.setLineDash(F(cb, la)),
                  b.moveTo(l - pa, h),
                  b.lineTo(l - pa, n),
                  b.stroke(),
                  b.moveTo(l - pa, p),
                ...
                0 < J &&
                  (b.beginPath(),
                  (b.globalAlpha = 1),
                  b.setLineDash && b.setLineDash(F(R, J)),
                  (b.strokeStyle = O),
                  (b.lineWidth = J),
                  b.moveTo(D, m - K),
                  b.lineTo(A, m - K),
                ...
                0 < Y &&
                  (b.beginPath(),
                  b.setLineDash && b.setLineDash(F(ca, Y)),
                  (b.strokeStyle = S),
                  (b.lineWidth = Y),
                  b.moveTo((l - $ / 2) << 0, p - N),
                  b.lineTo((l + $ / 2) << 0, p - N),
                ...
                x &&
                  ...
                  0 < la &&
                    (c.moveTo(l - B - pa, h),
                    c.lineTo(l - B - pa, Math.max(n, p)),
                    c.stroke(),
                    c.moveTo(l - B - pa, Math.min(n, p)),
                    c.lineTo(l - B - pa, r),
                    c.stroke()),
                  W(
                    c,
                ...
                (G[k].indexLabel ||
                  v.indexLabel ||
                  G[k].indexLabelFormatter ||
                  v.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: v.type,
                    dataPoint: G[k],
                    dataSeries: v,
                    point: { x: D + (A - D) / 2, y: a.axisY.reversed ? n : p },
                    direction: 1,
                    bounds: {
                      x1: D,
                      y1: Math.min(n, p),
    ...
    s.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < e.length)
            for (
              var t = 5 < h && m.bevelEnabled ? !0 : !1, g = 0;
              g < e.length;
              g++
            )
              if (
                (e[g].getTime ? (n = e[g].x.getTime()) : (n = e[g].x),
                !(
                  n < a.axisX.dataInfo.viewPortMin ||
                  n > a.axisX.dataInfo.viewPortMax
                ) &&
                  !w(e[g].y) &&
                  e[g].y.length &&
                  "number" === typeof e[g].y[0] &&
                  "number" === typeof e[g].y[1])
              ) {
                c = a.axisX.convertValueToPixel(n);
                k = a.axisY.convertValueToPixel(e[g].y[0]);
                l = a.axisY.convertValueToPixel(e[g].y[1]);
                var q = a.axisX.reversed
                    ? (c +
                    ...
                    : (c -
                        ...
                        (a.previousDataSeriesCount + r) * h) <<
                      0,
                  s = a.axisX.reversed ? (q - h) << 0 : (q + h) << 0,
                  c = e[g].color
                    ? e[g].color
                ...
                W(b, q, k, s, l, c, 0, c, t, t, !1, !1, m.fillOpacity);
                c = P(u);
                x &&
                  W(
                    this._eventManager.ghostCtx,
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    point: {
                      x: q + (s - q) / 2,
                      y: e[g].y[1] >= e[g].y[0] ? l : k,
                    },
                    direction: e[g].y[1] >= e[g].y[0] ? -1 : 1,
                    bounds: {
                      x1: q,
                      y1: Math.min(k, l),
                      x2: s,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
          var G = a.dataSeriesIndexes[v],
            ...
            B = 0;
          if (A)
            for (d = y._linkedSeries.id, u = 0; u < d; u++)
              !this.data[u].type.match(/(bar|column)/gi) ||
                !this.data[u].visible ||
                (this.data[u].type.match(/(stacked)/gi) && B) ||
                (this.data[u].type.match(/(range)/gi) && (g = !0), B++);
          d = this.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.dataPointWidth
            ? this.dataPointWidth
          ...
          u > l && (u = l);
          if (0 < D.length)
            for (var F = y._colorSet, l = 0; l < D.length; l++) {
              var d = (y.lineColor = y.options.color ? y.options.color : F[0]),
                S = {
                  color: D[l].whiskerColor
                    ? D[l].whiskerColor
                    : D[l].color
                    ? y.whiskerColor
                      ? y.whiskerColor
                    ...
                    ? y.whiskerColor
                    : d,
                  thickness: w(D[l].whiskerThickness)
                    ? y.whiskerThickness
                    : D[l].whiskerThickness,
                  dashType: D[l].whiskerDashType
                    ? D[l].whiskerDashType
                    : y.whiskerDashType,
                  length: w(D[l].whiskerLength)
                    ? w(y.options.whiskerLength)
                      ? u
                      : y.options.whiskerLength
                    : D[l].whiskerLength,
                  trimLength: w(D[l].whiskerLength)
                    ? w(y.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              S.length =
                "number" === typeof S.length
                  ? 0 >= S.length
                    ...
                    ? u
                    : S.length
                  : "string" === typeof S.length
                  ? (parseInt(S.length) * u) / 100 > u
                    ? u
                    : (parseInt(S.length) * u) / 100 > u
                  : u;
              S.thickness =
              ...
              var Y = {
                color: D[l].stemColor
                  ...
                  ? y.stemColor
                  : d,
                thickness: D[l].stemThickness
                  ? D[l].stemThickness
                  : y.stemThickness,
                dashType: D[l].stemDashType
                  ? D[l].stemDashType
                  : y.stemDashType,
              };
              Y.thickness =
                "number" === typeof Y.thickness
                  ...
                  : 2;
              D[l].getTime ? (t = D[l].x.getTime()) : (t = D[l].x);
              if (
                !(
                  t < a.axisX.dataInfo.viewPortMin ||
                  t > a.axisX.dataInfo.viewPortMax
                ...
                !w(D[l].y) &&
                D[l].y.length &&
                "number" === typeof D[l].y[0] &&
                "number" === typeof D[l].y[1]
              ) {
                var ca = a.axisX.convertValueToPixel(t);
                c ? (h = ca) : (n = ca);
                ca = a.axisY.convertValueToPixel(D[l].y[0]);
                c ? (r = ca) : (m = ca);
                ca = a.axisY.convertValueToPixel(D[l].y[1]);
                c ? (p = ca) : (e = ca);
                c
                  ? ((m = a.axisX.reversed
                      ? (h + ((A ? s : 1) * u) / 2 - (A ? B - 1 : 0) * u) << 0
                      : (h - ((A ? s : 1) * u) / 2 + (A ? B - 1 : 0) * u) << 0),
                    (e = a.axisX.reversed ? (m - u) << 0 : (m + u) << 0))
                  : ((r = a.axisX.reversed
                      ? (n + ((A ? s : 1) * u) / 2 - (A ? B - 1 : 0) * u) << 0
                      : (n - ((A ? s : 1) * u) / 2 + (A ? B - 1 : 0) * u) << 0),
                    (p = a.axisX.reversed ? (r - u) << 0 : (r + u) << 0));
                !c && m > e && ((ca = m), (m = e), (e = ca));
                c && r > p && ((ca = r), (r = p), (p = ca));
                ca = y.dataPointIds[l];
                ...
                x && z(this._eventManager.ghostCtx, r, m, p, e, d, S, Y, c);
                if (
                  D[l].indexLabel ||
                  y.indexLabel ||
                  D[l].indexLabelFormatter ||
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: c ? (D[l].y[1] >= D[l].y[0] ? r : p) : r + (p - r) / 2,
                      y: c ? m + (e - m) / 2 : D[l].y[1] >= D[l].y[0] ? e : m,
                    },
                    direction: D[l].y[1] >= D[l].y[0] ? -1 : 1,
                    bounds: {
                      x1: c ? Math.min(r, p) : r,
                      y1: c ? m : Math.min(m, e),
                      x2: c ? Math.max(r, p) : p,
                      ...
                      point: {
                        x: c
                          ? D[l].y[1] >= D[l].y[0]
                            ...
                            : r
                          : r + (p - r) / 2,
                        y: c ? m + (e - m) / 2 : D[l].y[1] >= D[l].y[0] ? m : e,
                      },
                      direction: D[l].y[1] >= D[l].y[0] ? 1 : -1,
                      bounds: {
                        x1: c ? Math.min(r, p) : r,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          var m = a.dataSeriesIndexes[p],
            ...
            t = e.dataPoints;
          if (0 < t.length) {
            var q = 5 < r && e.bevelEnabled ? !0 : !1;
            b.strokeStyle = "#4572A7 ";
            for (g = 0; g < t.length; g++)
              if (
                (t[g].getTime ? (h = t[g].x.getTime()) : (h = t[g].x),
                !(
                  ...
                  !w(t[g].y) &&
                  t[g].y.length &&
                  "number" === typeof t[g].y[0] &&
                  "number" === typeof t[g].y[1])
              ) {
                k = a.axisY.convertValueToPixel(t[g].y[0]);
                l = a.axisY.convertValueToPixel(t[g].y[1]);
                n = a.axisX.convertValueToPixel(h);
                n = a.axisX.reversed
                  ? (n +
                      (a.plotType.totalDataSeries * r) / 2 -
                      (a.previousDataSeriesCount + p) * r) <<
                    0
                  : (n -
                      (a.plotType.totalDataSeries * r) / 2 +
                      (a.previousDataSeriesCount + p) * r) <<
                ...
                c = t[g].color
                  ? t[g].color
                  : e._colorSet[g % e._colorSet.length];
                W(b, k, n, l, s, c, 0, null, q, !1, !1, !1, e.fillOpacity);
                c = e.dataPointIds[g];
                this._eventManager.objectMap[c] = {
                  id: c,
                  objectType: "dataPoint",
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: t[g].y[1] >= t[g].y[0] ? k : l,
                      y: n + (s - n) / 2,
                    },
                    direction: t[g].y[1] >= t[g].y[0] ? -1 : 1,
                    bounds: {
                      x1: Math.min(k, l),
                      y1: n,
                      x2: Math.max(k, l),
    ...
    s.prototype.renderRangeArea = function (a) {
      function f() {
        if (w) {
          ...
          for (var b = n.length - 1; 0 <= b; b--)
            (a = n[b]), c.lineTo(a.x, a.y), d.lineTo(a.x, a.y);
          c.closePath();
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.rect(k.x1, k.y1, k.width, k.height);
        c.clip();
        x && (d.beginPath(), d.rect(k.x1, k.y1, k.width, k.height), d.clip());
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          var n = [],
          ...
          var g = [],
            ...
            w = null;
          if (0 < p.length) {
            var v = r._colorSet[e % r._colorSet.length],
              y = (r.lineColor = r.options.lineColor || v),
              D = y;
            c.fillStyle = v;
            c.strokeStyle = y;
            ...
            if (c.setLineDash) {
              var z = F(r.nullDataLineDashType, r.lineThickness),
                A = r.lineDashType,
                B = F(A, r.lineThickness);
              c.setLineDash(B);
            }
            for (var S = !0; e < p.length; e++)
              if (
                ((u = p[e].x.getTime ? p[e].x.getTime() : p[e].x),
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax &&
                    (!r.connectNullData || !S))
                ...
                if (
                  null !== p[e].y &&
                  p[e].y.length &&
                  "number" === typeof p[e].y[0] &&
                  "number" === typeof p[e].y[1]
                ) {
                  t = a.axisX.convertValueToPixel(u);
                  q = a.axisY.convertValueToPixel(p[e].y[0]);
                  s = a.axisY.convertValueToPixel(p[e].y[1]);
                  m || S
                    ? (r.connectNullData && !m
                        ? (c.setLineDash &&
                            ...
                            ((n[n.length - 1].newLineDashArray = B),
                  ...
                  e < p.length - 1 &&
                    (D !== (p[e].lineColor || y) ||
                      A !== (p[e].lineDashType || r.lineDashType)) &&
                    (f(),
                    (D = p[e].lineColor || y),
                    (n[n.length - 1].newStrokeStyle = D),
                    (c.strokeStyle = D),
                    c.setLineDash &&
                      (p[e].lineDashType
                        ? ((A = p[e].lineDashType),
                  ...
                  if (
                    0 !== p[e].markerSize &&
                    (0 < p[e].markerSize || 0 < r.markerSize)
                  ) {
                    var Y = r.getMarkerProperties(e, t, s, c);
                    g.push(Y);
                    var ca = P(u);
                    x &&
                      g.push({
                    ...
                    Y = r.getMarkerProperties(e, t, q, c);
                    g.push(Y);
                    ca = P(u);
                    x &&
                      g.push({
                  ...
                  if (
                    ...
                    this._indexLabels.push({
                      ...
                      point: { x: t, y: q },
                      direction:
                        p[e].y[0] > p[e].y[1] === a.axisY.reversed ? -1 : 1,
                      color: v,
                    }),
                      this._indexLabels.push({
                        chartType: "rangeArea",
          ...
          if (0 < h.lineThickness) {
            ...
            for (var f = 0; f < e.length - 3; f += 3) {
              if (e[f].newStrokeStyle || e[f].newLineDashArray)
                c.stroke(),
                  c.beginPath(),
                  c.moveTo(e[f].x, e[f].y),
                  e[f].newStrokeStyle && (c.strokeStyle = e[f].newStrokeStyle),
                  e[f].newLineDashArray && c.setLineDash(e[f].newLineDashArray);
              c.bezierCurveTo(
                e[f + 1].x,
                e[f + 1].y,
                e[f + 2].x,
            ...
            for (var g = (f = 0); f < e.length - 3; f += 3, g++) {
              if (q[g].newStrokeStyle || q[g].newLineDashArray)
                c.stroke(),
                  c.beginPath(),
                  c.moveTo(e[f].x, e[f].y),
                  q[g].newStrokeStyle && (c.strokeStyle = q[g].newStrokeStyle),
                  q[g].newLineDashArray && c.setLineDash(q[g].newLineDashArray);
              c.bezierCurveTo(
                e[f + 1].x,
                e[f + 1].y,
                e[f + 2].x,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var g = [],
            ...
            s = [];
          if (0 < r.length) {
            var u = h._colorSet[p % h._colorSet.length],
              w = (h.lineColor = h.options.lineColor || u),
              v = w;
            c.fillStyle = u;
            c.lineWidth = h.lineThickness;
            var z = "solid",
              D;
            if (c.setLineDash) {
              var A = F(h.nullDataLineDashType, h.lineThickness),
                z = h.lineDashType;
              D = F(z, h.lineThickness);
            }
            for (e = !1; p < r.length; p++)
              if (
                ((m = r[p].x.getTime ? r[p].x.getTime() : r[p].x),
                !(
                ...
                if (
                  null !== r[p].y &&
                  r[p].y.length &&
                  "number" === typeof r[p].y[0] &&
                  "number" === typeof r[p].y[1]
                ) {
                  m = a.axisX.convertValueToPixel(m);
                  e = a.axisY.convertValueToPixel(r[p].y[0]);
                  t = a.axisY.convertValueToPixel(r[p].y[1]);
                  var B = h.dataPointIds[p];
                  this._eventManager.objectMap[B] = {
                    id: B,
                    objectType: "dataPoint",
                    dataSeriesIndex: n,
                  ...
                  p < r.length - 1 &&
                    (v !== (r[p].lineColor || w) ||
                      z !== (r[p].lineDashType || h.lineDashType)) &&
                    ((v = r[p].lineColor || w),
                    (q[q.length - 1].newStrokeStyle = v),
                    c.setLineDash &&
                      (r[p].lineDashType
                        ? ((z = r[p].lineDashType),
                          (q[q.length - 1].newLineDashArray = F(
                            z,
                            h.lineThickness
                          )))
                        : ((z = h.lineDashType),
                          (q[q.length - 1].newLineDashArray = D))));
                  if (
                    0 !== r[p].markerSize &&
                    (0 < r[p].markerSize || 0 < h.markerSize)
                  ) {
                    var J = h.getMarkerProperties(p, m, e, c);
                    g.push(J);
                    var S = P(B);
                    x &&
                      g.push({
                    ...
                    J = h.getMarkerProperties(p, m, t, c);
                    g.push(J);
                    S = P(B);
                    x &&
                      g.push({
                  ...
                  0 < p &&
                    ...
                    (h.connectNullData
                      ? c.setLineDash &&
                        ...
                        (h.options.nullDataLineDashType ||
                          !r[p - 1].lineDashType) &&
                        ((q[q.length - 1].newLineDashArray = A),
                        (z = h.nullDataLineDashType))
                      : (f(D, w), (q = []), (s = []))),
                    (e = !0);
            f(D, w);
            ea.drawMarkers(g);
    ...
    s.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
          var t = a.dataSeriesIndexes[e],
            q = this.data[t],
            s = q.dataPoints,
            d = q._colorSet[0];
          q.risingColor = q.options.risingColor ? q.options.risingColor : d;
          q.fallingColor = q.options.fallingColor
            ? q.options.fallingColor
            : "#e40a0a";
          var u =
              "number" === typeof q.options.lineThickness
                ? Math.round(q.lineThickness)
                : 1,
            w = 1 === Math.round(u) % 2 ? -0.5 : 0;
          if (0 < s.length)
            for (
              var v = 5 < m && q.bevelEnabled ? !0 : !1,
                y = !1,
                z = null,
                A = null,
                k = 0;
              ...
              if (
                (s[k].getTime ? (r = s[k].x.getTime()) : (r = s[k].x),
                "number" !== typeof s[k].y)
              ) {
                if (0 < k && !y && q.connectNullData)
                  var B =
                    q.options.nullDataLineDashType || !s[k - 1].lineDashType
                ...
                n =
                  0 === q.dataPointEOs[k].cumulativeSum
                    ? p
                    : a.axisY.convertValueToPixel(
                        q.dataPointEOs[k].cumulativeSum
                      );
                h =
                  0 === q.dataPointEOs[k].cumulativeSumYStartValue
                    ? p
                    : a.axisY.convertValueToPixel(
                        q.dataPointEOs[k].cumulativeSumYStartValue
                      );
                l = a.axisX.reversed
                  ? (l +
                      (a.plotType.totalDataSeries * m) / 2 -
                      (a.previousDataSeriesCount + e) * m) <<
                    0
                  : (l -
                      (a.plotType.totalDataSeries * m) / 2 +
                      (a.previousDataSeriesCount + e) * m) <<
                    0;
                var J = a.axisX.reversed ? (l - m) << 0 : (l + m) << 0;
                n > h && ((d = n), (n = h), (h = d));
                a.axisY.reversed && ((d = n), (n = h), (h = d));
                d = q.dataPointIds[k];
                this._eventManager.objectMap[d] = {
                  id: d,
                  objectType: "dataPoint",
                ...
                var S = s[k].color
                  ...
                  ? q.risingColor
                  : q.fallingColor;
                W(b, l, n, J, h, S, 0, S, v, v, !1, !1, q.fillOpacity);
                d = P(d);
                x &&
                  W(
                    this._eventManager.ghostCtx,
                ...
                var Y,
                  S = l;
                Y =
                  ("undefined" !== typeof s[k].isIntermediateSum &&
                    !0 === s[k].isIntermediateSum) ||
                  ("undefined" !== typeof s[k].isCumulativeSum &&
                ...
                0 < k &&
                  z &&
                  (!y || q.connectNullData) &&
                  (y && b.setLineDash && b.setLineDash(F(B, u)),
                  b.beginPath(),
                  b.moveTo(z, A - w),
                  b.lineTo(S, Y - w),
                  0 < u && b.stroke(),
                ...
                S = s[k].lineDashType
                  ? s[k].lineDashType
                  : q.options.lineDashType
                  ? q.options.lineDashType
                  : "shortDash";
                b.strokeStyle = s[k].lineColor
                  ? s[k].lineColor
                  : q.options.lineColor
                  ? q.options.lineColor
                  : "#9e9e9e";
                b.lineWidth = u;
                b.setLineDash && ((S = F(S, u)), b.setLineDash(S));
                (s[k].indexLabel ||
                  q.indexLabel ||
    ...
    var qa = function (a, f, b, c, d, g, k, l, n) {
      if (!(0 > b)) {
        "undefined" === typeof l && (l = 1);
        if (!x) {
          var h = Number((k % (2 * Math.PI)).toFixed(8));
          Number((g % (2 * Math.PI)).toFixed(8)) === h && (k -= 1e-4);
        }
        a.save();
        a.globalAlpha = l;
        "pie" === d
    ...
    s.prototype.renderPie = function (a) {
      function f() {
        if (h && r) {
          for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < r.length; f++) {
            var g = r[f],
              k = h.dataPointIds[f];
            e[f].id = k;
            ...
            p = g.indexLabelFormatter
              ? g.indexLabelFormatter(t)
              : g.indexLabel
              ? n.replaceKeywordsWithValue(g.indexLabel, g, h, f)
              : h.indexLabelFormatter
              ? h.indexLabelFormatter(t)
              : h.indexLabel
              ? n.replaceKeywordsWithValue(h.indexLabel, g, h, f)
              : g.label
              ? g.label
              : "";
            n._eventManager.objectMap[k] = l;
            ...
            l.indexLabelLineColor = g.indexLabelLineColor
              ...
              : g.color
              ? g.color
              : h._colorSet[f % h._colorSet.length];
            l.indexLabelLineThickness = w(g.indexLabelLineThickness)
            ...
            l.indexLabelFontSize = w(g.indexLabelFontSize)
            ...
            l.endAngle = l.startAngle + ((2 * Math.PI) / y) * Math.abs(g.y);
            g = (l.endAngle + l.startAngle) / 2;
            g = (g + 2 * Math.PI) % (2 * Math.PI);
            l.midAngle = g;
            if (l.midAngle > Math.PI / 2 - u && l.midAngle < Math.PI / 2 + u) {
              if (0 === a || e[c].midAngle > l.midAngle) c = f;
              a++;
            } else if (
              l.midAngle > (3 * Math.PI) / 2 - u &&
              l.midAngle < (3 * Math.PI) / 2 + u
            ) {
              if (0 === b || e[d].midAngle > l.midAngle) d = f;
              b++;
            }
            l.hemisphere =
              g > Math.PI / 2 && g <= (3 * Math.PI) / 2 ? "left" : "right";
            l.indexLabelTextBlock = new ja(n.plotArea.ctx, {
      ...
      function b(a) {
        ...
        for (b = 0; b < r.length; b++) {
          var c = e[b].startAngle,
            d = e[b].endAngle;
          if (d > c) {
            var f = 0.07 * A * Math.cos(e[b].midAngle),
              g = 0.07 * A * Math.sin(e[b].midAngle),
              k = !1;
            if (r[b].exploded) {
              if (
                1e-9 < Math.abs(e[b].center.x - (v.x + f)) ||
                1e-9 < Math.abs(e[b].center.y - (v.y + g))
              )
                (e[b].center.x = v.x + f * a),
                  (e[b].center.y = v.y + g * a),
                  (k = !0);
            } else if (
              0 < Math.abs(e[b].center.x - v.x) ||
              0 < Math.abs(e[b].center.y - v.y)
            )
              (e[b].center.x = v.x + f * (1 - a)),
                (e[b].center.y = v.y + g * (1 - a)),
                (k = !0);
            k &&
              ((f = {}),
              (f.dataSeries = h),
              (f.dataPoint = h.dataPoints[b]),
              (f.index = b),
      ...
      function d(a) {
        for (var b = null, d = 1; d < r.length; d++)
          if (
            ((b = (a + d + e.length) % e.length),
            e[b].hemisphere !== e[a].hemisphere)
          ) {
            b = null;
            break;
          } else if (
            ...
            (0 > c(e[b], e[a]) ||
              ("right" === e[a].hemisphere
                ? e[b].indexLabelTextBlock.y >= e[a].indexLabelTextBlock.y
                : e[b].indexLabelTextBlock.y <= e[a].indexLabelTextBlock.y))
          )
            break;
          else b = null;
      ...
      function g(a, b, f) {
        ...
        if (0 <= a && a < r.length) {
          ...
          k =
            "right" === l.hemisphere
              ? v.x + Math.sqrt(Math.pow(q, 2) - Math.pow(b - v.y, 2))
              : v.x - Math.sqrt(Math.pow(q, 2) - Math.pow(b - v.y, 2));
          p = v.x + A * Math.cos(l.midAngle);
          n = v.y + A * Math.sin(l.midAngle);
          n = Math.sqrt(Math.pow(k - p, 2) + Math.pow(b - n, 2));
          p = Math.acos(A / q);
          n = Math.acos((q * q + A * A - n * n) / (2 * A * q));
          b = n < p ? b - l.indexLabelTextBlock.y : 0;
          k = null;
          for (m = 1; m < r.length; m++)
            if (
              ((k = (a - m + e.length) % e.length),
              e[k].hemisphere !== e[a].hemisphere)
            ) {
              k = null;
              break;
            } else if (
              ...
              (0 > c(e[k], e[a]) ||
                ("right" === e[a].hemisphere
                  ? e[k].indexLabelTextBlock.y <= e[a].indexLabelTextBlock.y
                  : e[k].indexLabelTextBlock.y >= e[a].indexLabelTextBlock.y))
            )
              break;
            else k = null;
            ...
            ? ((m = "right" === l.hemisphere ? p : n),
              ...
              null !== m &&
                ...
                (b =
                  l.indexLabelTextBlock.y -
                  l.indexLabelTextBlock.height / 2 -
                  (e[m].indexLabelTextBlock.y +
                    e[m].indexLabelTextBlock.height / 2)),
                b - p < t &&
                  ((k = -p),
                  (m = g(m, k, f + 1)),
                  +m.toFixed(x) > +k.toFixed(x) &&
                    (h = b > t ? -(b - t) : -(p - (m - k))))))
            : 0 < b &&
              ((m = "right" === l.hemisphere ? n : p),
              (h = b),
              null !== m &&
                ((p = b),
                (b =
                ...
                b - p < t &&
                  ...
                  +m.toFixed(x) < +k.toFixed(x) &&
                    (h = b > t ? b - t : p - (k - m)))));
          h &&
            ((f = l.indexLabelTextBlock.y + h),
            (b = 0),
            (b =
              "right" === l.hemisphere
                ? v.x + Math.sqrt(Math.pow(q, 2) - Math.pow(f - v.y, 2))
                : v.x - Math.sqrt(Math.pow(q, 2) - Math.pow(f - v.y, 2))),
            l.midAngle > Math.PI / 2 - u && l.midAngle < Math.PI / 2 + u
              ? ((k = (a - 1 + e.length) % e.length),
                (k = e[k]),
                (a = e[(a + 1 + e.length) % e.length]),
                "left" === l.hemisphere &&
                "right" === k.hemisphere &&
                b > k.indexLabelTextBlock.x
                  ? (b = k.indexLabelTextBlock.x - 15)
                  : "right" === l.hemisphere &&
                    "left" === a.hemisphere &&
        ...
        for (
          ...
          if ("inside" !== h.indexLabelPlacement) {
            ...
            for (a = 0; a < r.length; a++) {
              var l = e[a];
              l.indexLabelTextBlock.x = v.x + q * Math.cos(l.midAngle);
              l.indexLabelTextBlock.y = v.y + q * Math.sin(l.midAngle);
              l.indexLabelAngle = l.midAngle;
              l.radius = A;
              l.percentInnerRadius = L;
            }
            for (var u, w, a = 0; a < r.length; a++) {
              var l = e[a],
                y = d(a);
              if (null !== y) {
                u = e[a];
                ...
                var z = 0,
                  z = c(u, w) - t;
                if (0 > z) {
                  for (var D = (w = 0), F = 0; F < r.length; F++)
                    F !== a &&
                      e[F].hemisphere === l.hemisphere &&
                      (e[F].indexLabelTextBlock.y < l.indexLabelTextBlock.y
                        ? w++
                        : D++);
                  w = (z / (w + D || 1)) * D;
                  var D = -1 * (z - w),
                  ...
                  "right" === l.hemisphere
                    ? ((F = g(a, w)),
                      (D = -1 * (z - F)),
                      (Ca = g(y, D)),
                      +Ca.toFixed(x) < +D.toFixed(x) &&
                        +F.toFixed(x) <= +w.toFixed(x) &&
                        g(a, -(D - Ca)))
                    : ((F = g(y, w)),
                      (D = -1 * (z - F)),
                      (Ca = g(a, D)),
            ...
            for (a = 0; a < r.length; a++)
              (l = e[a]),
                (q = "pie" === h.type ? 0.7 * A : 0.8 * A),
                (y = v.x + q * Math.cos(l.midAngle)),
                (w = v.y + q * Math.sin(l.midAngle)),
                (l.indexLabelTextBlock.x = y),
                (l.indexLabelTextBlock.y = w);
          for (a = 0; a < r.length; a++)
            if (
              ((l = e[a]),
              ...
              (y = y = 0),
                ...
                0 < y &&
                  (!k &&
                    ...
                    0.3 * l.indexLabelTextBlock.maxWidth > w
                      ? (l.indexLabelText = "")
                      : (l.indexLabelTextBlock.maxWidth = 0.85 * w),
                    0.3 * l.indexLabelTextBlock.maxWidth < w &&
                      (l.indexLabelTextBlock.x -=
          ...
          (function () {
            for (var a = -1, b = -1, f = 0, g = !1, k = 0; k < r.length; k++)
              if (((g = !1), (u = e[k]), u.indexLabelText)) {
                var h = d(k);
                if (null !== h) {
                  var l = e[h];
                  z = 0;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 !== y) {
          ...
          h.radius && (A = J(h.radius, A));
          var B =
            "undefined" !== typeof h.innerRadius && null !== h.innerRadius
              ? J(h.innerRadius, A)
              : 0.7 * A;
          h.radius = A;
          "doughnut" === h.type && (h.innerRadius = B);
          var L = Math.min(B / A, (A - 1) / A);
          this.pieDoughnutClickHandler = function (a) {
            n.isAnimating ||
              (!w(a.dataSeries.explodeOnClick) &&
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              b.fillStyle = n.backgroundColor;
              b.fillRect(m.x1, m.y1, m.width, m.height);
              a = e[0].startAngle + 2 * Math.PI * a;
              for (b = 0; b < r.length; b++) {
                var c = 0 === b ? e[b].startAngle : d,
                  d = c + (e[b].endAngle - e[b].startAngle),
                  f = !1;
                d > a && ((d = a), (f = !0));
                var g = r[b].color
                  ? r[b].color
    ...
    s.prototype.renderFunnel = function (a) {
      function f() {
        for (var a = 0, b = [], c = 0; c < v.length; c++) {
          if ("undefined" === typeof v[c].y) return -1;
          v[c].y = "number" === typeof v[c].y ? v[c].y : 0;
          a += Math.abs(v[c].y);
        }
        if (0 === a) return -1;
        for (c = b[0] = 0; c < v.length; c++)
          b.push((Math.abs(v[c].y) * O) / a);
        return b;
      }
      function b() {
        var a = U,
        ...
        f = Math.abs(f);
        f = headArea + f;
        for (var d = [], g = 0, k = 0; k < v.length; k++) {
          if ("undefined" === typeof v[k].y) return -1;
          v[k].y = "number" === typeof v[k].y ? v[k].y : 0;
          g += Math.abs(v[k].y);
        }
        if (0 === g) return -1;
        for (
          var h = (d[0] = 0), l = 0, m, b = b - a, n = !1, k = 0;
          k < v.length;
          k++
        )
          (a = (Math.abs(v[k].y) * f) / g),
            n
              ? (h = 0 == Number(c.toFixed(3)) ? 0 : a / c)
              : ((sqrt = ba * ba * b * b - 4 * Math.abs(ba) * a),
                0 > sqrt
                  ? ((m = c),
                    (h = ((b + m) * (e - l)) / 2),
                    (a -= h),
                    ...
                    (l += a / m),
                    (n = !0))
                  : ((h = (Math.abs(ba) * b - Math.sqrt(sqrt)) / 2),
                    (m = b - (2 * h) / Math.abs(ba)),
                    (l += h),
                    l > e &&
                      ((l -= h),
        ...
        if (u && v) {
          for (
            ...
            (t = M[z]),
              ...
              (q[z] = J - t - R);
          t = 0.5 * R;
          for (var z = 0, D = v.length - 1; z < v.length || 0 <= D; z++, D--) {
            b = u.reversed ? v[D] : v[z];
            a = b.color
              ? b.color
              : u.reversed
              ? u._colorSet[(v.length - 1 - z) % u._colorSet.length]
            ...
            g = b.indexLabelFontSize || u.indexLabelFontSize || 12;
            ...
            s._eventManager.objectMap[r] = {
              ...
              dataPointIndex: z,
              dataSeriesIndex: 0,
              funnelSection: M[u.reversed ? v.length - 1 - z : z],
            };
              ...
              20 > q[z] &&
                ((q[z] =
                  z !== da
                    ...
                    : M[z].x2 - M[z].x1),
                (q[z] /= 2)));
            r = b.indexLabelMaxWidth || u.indexLabelMaxWidth || q[z];
            if (r > q[z] || 0 > r) r = q[z];
            w[z] = "inside" === u.indexLabelPlacement ? M[z].height : !1;
            y = s.getPercentAndTotal(u, b);
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? s.replaceKeywordsWithValue(b.indexLabel, b, u, z)
              : u.indexLabelFormatter
              ? u.indexLabelFormatter(A)
              : u.indexLabel
              ? s.replaceKeywordsWithValue(u.indexLabel, b, u, z)
              : b.label
              ? b.label
              : "";
            0 >= m && (m = 0);
            1e3 > r && 1e3 - r < t && (r += 1e3 - r);
            $.roundRect || Aa($);
            c = new ja($, {
              fontSize: g,
              fontFamily: k,
              ...
              backgroundColor: d,
              maxWidth: r,
              maxHeight: !1 === w[z] ? (p ? 4.28571429 * g : 1.5 * g) : w[z],
              text: b,
              padding: ea,
            });
            c.measureText();
      ...
      function d() {
        ...
        for (
          ...
          c = H[h];
          d = c.textBlock;
          b = (a = m(h) < M.length ? H[m(h)] : null) ? a.textBlock : null;
          c = c.height;
          a && d.y + c + ea > b.y && (e = !0);
        ...
        if (e)
          for (h = H.length - 1; 0 <= h; h--)
            (a = M[h]),
              ...
              u.reversed
                ? (H[h].textBlock.y + H[h].height > Q + z &&
                    (H[h].textBlock.y = Q + z - H[h].height),
                  H[h].textBlock.y < Z - z && (H[h].textBlock.y = Z - z))
                : (H[h].textBlock.y < Q - z && (H[h].textBlock.y = Q - z),
                  H[h].textBlock.y + H[h].height > Z + z &&
                    (H[h].textBlock.y = Z + z - H[h].height));
      }
      function g() {
        var a, b, c, d;
          ...
          for (var f = 0; f < M.length; f++)
            0 == H[f].textBlock.text.length
              ...
              : ((a = M[f]),
                ...
                u.reversed
                  ? (H[f].textBlock.y + H[f].height > Q + z &&
                      (H[f].textBlock.y = Q + z - H[f].height),
                    H[f].textBlock.y < Z - z && (H[f].textBlock.y = Z - z))
                  : (H[f].textBlock.y < Q - z && (H[f].textBlock.y = Q - z),
                    H[f].textBlock.y + H[f].height > Z + z &&
                      (H[f].textBlock.y = Z + z - H[f].height)));
        else
      ...
      function k() {
        function a(b, c) {
          ...
          d = l(b, e);
          if (d >= c) return (f.y += c), c;
          if (b == M.length - 1) return 0 < d && (f.y += d), d;
          d += a(e, c - d);
          0 < d && (f.y += d);
          return d;
        }
        ...
        for (var d, e, f, g, h, k, n = 1, r = 0; r < 2 * n; r++) {
          for (
            var t = H.length - 1;
            0 <= t &&
            !((previousTextBlock = (previousLabel = 0 <= p(t) ? H[p(t)] : null)
              ? previousLabel.textBlock
              : null),
            (f = H[t]),
            (g = f.textBlock),
            (k = (h = m(t) < M.length ? H[m(t)] : null) ? h.textBlock : null),
      ...
      function l(a, b) {
        return (
          (b < M.length ? H[b].textBlock.y : u.reversed ? Q + z : Z + z) -
          (0 > a
            ? u.reversed
              ? Z - z
              : Q - z
      ...
      function n(a, b, c) {
        function d(b, c, f, h) {
          ...
          var l = {};
          l.dataSeries = u;
          l.dataPoint = u.reversed
            ? u.dataPoints[v.length - 1 - b]
            : u.dataPoints[b];
          l.index = u.reversed ? v.length - 1 - b : b;
          a.toolTip.highlightObjects([l]);
          for (l = 0; l < M.length; l++) ua(c, M[l], u.fillOpacity);
          q(c);
          A && ("inside" !== u.indexLabelPlacement ? r(c) : g(), t(c));
          1 == k
            ? ((ga = !1), h.cancelRequestAnimFrame.call(window, n))
            : (n = h.requestAnimFrame.call(window, function () {
                d(b, c, f, h);
              }));
        }
        function e(b) {
          b.clearRect(y.x1, y.y1, y.x2 - y.x1, y.y2 - y.y1);
          b.fillStyle = a.backgroundColor;
          b.fillRect(y.x1, y.y1, y.width, y.height);
        }
        var f = [],
          k,
          l,
        ...
        if (0 === aa.length) f = ia;
          ...
          l =
            (z *
              (1 != aa.length || (0 != aa[0] && aa[0] != M.length - 1)
                ? 2
                : 1)) /
            h();
          for (var w = 0; w < M.length; w++) {
            if (1 == aa.length && 0 == aa[0]) {
              if (0 === w) {
                f.push(ia[w]);
                k = m;
                continue;
            ...
            f.push(ia[w] + k);
            if (0 <= aa.indexOf(w) || (w < M.length && 0 <= aa.indexOf(w + 1)))
              k += l;
          }
        }
        p = (function () {
          for (var a = [], b = 0; b < M.length; b++) a.push(f[b] - M[b].y1);
          return a;
        })();
        c = {
          ...
          changeSection: function (a) {
            for (var b, c, d = 0; d < M.length; d++)
              (b = p[d]),
                (c = M[d]),
                (newY = b * a),
                "undefined" === typeof s[d] && (s[d] = 0),
                0 > s && (s *= -1),
                (c.y1 += newY - s[d]),
                (c.y2 += newY - s[d]),
                (c.y3 += newY - s[d]),
                (c.y4 += newY - s[d]),
                c.y5 && ((c.y5 += newY - s[d]), (c.y6 += newY - s[d])),
                (s[d] = newY);
          },
        };
        d(b, a.ctx, c, a);
      ...
      function h() {
        for (var a = 0, b = 0; b < M.length - 1; b++)
          (0 <= aa.indexOf(b) || 0 <= aa.indexOf(b + 1)) && a++;
        return a;
      }
      function r(a) {
        for (var b, c, d, f, g = 0; g < M.length; g++)
          (f = 1 === H[g].lineThickness % 2 ? 0.5 : 0),
            (c = (((M[g].y2 + M[g].y4) / 2) << 0) + f),
            (b = e(c).x2 - 1),
            (d = H[g].textBlock.x),
      ...
      function m(a) {
        for (a += 1; a <= M.length && a != M.length && H[a].isDirty; a++);
        return a;
      }
      function e(a) {
      ...
      function q(a) {
        ...
        a.roundRect || Aa(a);
        s.title &&
          (s.title.dockInsidePlotArea ||
            ("center" === s.title.horizontalAlign &&
              "center" === s.title.verticalAlign)) &&
          ((s.title.ctx = a), s.title.render());
        if (s.subtitles)
        ...
        s.legend &&
          (s.legend.dockInsidePlotArea ||
            ("center" === s.legend.horizontalAlign &&
              "center" === s.legend.verticalAlign)) &&
          ((s.legend.ctx = a), s.legend.render());
        na.fNg && na.fNg(s);
      }
      var s = this;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          ...
          if (
            (!A &&
              "undefined" !== typeof v[B].indexLabel &&
              null !== v[B].indexLabel &&
              0 < v[B].indexLabel.toString().length &&
              (A = !0),
            !A &&
              "undefined" !== typeof v[B].label &&
              null !== v[B].label &&
              0 < v[B].label.toString().length &&
              (A = !0),
            (!A && "function" === typeof u.indexLabelFormatter) ||
              "function" === typeof v[B].indexLabelFormatter)
          )
            A = !0;
        A =
          A ||
        ...
        ("inside" !== u.indexLabelPlacement && A) ||
          (D = (12.5 * y.width) / 100);
        var B = y.x1 + D,
          J = y.x2 - D,
          S = y.y1 + z,
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== v.length) {
          var N,
            I,
            D = (75 * D) / 100,
            R = (30 * (J - D)) / 100;
          "funnel" === u.type
            ? ((N = u.neckHeight),
              ...
              "string" === typeof N && N.match(/%$/)
                ? ((N = parseInt(N)), (N = (N * O) / 100))
                : (N = parseInt(N)),
              "string" === typeof I && I.match(/%$/)
                ? ((I = parseInt(I)), (I = (I * D) / 100))
                : (I = parseInt(I)),
              N > O ? (N = O) : 0 >= N && (N = !0),
              I > D ? (I = D - 0.5) : 0 >= I && (I = !0))
            : "pyramid" === u.type &&
              ((I = N = !0), (u.reversed = u.reversed ? !1 : !0));
          N = N ? ("number" === typeof N ? N : 0) : 0.35 * O;
          I = I ? ("number" === typeof I ? I : 0) : 0.25 * D;
          var P = B + D / 2,
            U = B,
            V = B + D,
            Q = u.reversed ? Y : S,
          ...
          if (-1 !== B) {
            if (u.reversed)
              for (ha.push(X), I = B.length - 1; 0 < I; I--)
                (X += B[I]), ha.push(X);
            else for (I = 0; I < B.length; I++) (X += B[I]), ha.push(X);
            if (u.reversed)
              for (I = 0; I < B.length; I++)
                ha[I] < T
                  ? (D.push(W), P.push(K), (da = I))
                  : (D.push((ha[I] - Q + ba * U) / ba),
                    P.push((ha[I] - Q + fa * V) / fa));
            else
              for (I = 0; I < B.length; I++)
                ha[I] < T
                  ? (D.push((ha[I] - Q + ba * U) / ba),
            ...
            for (I = 0; I < B.length - 1; I++)
              (X = u.reversed
                ? v[v.length - 1 - I].color
                  ? v[v.length - 1 - I].color
                  : u._colorSet[(v.length - 1 - I) % u._colorSet.length]
                : v[I].color
                ? v[I].color
                : u._colorSet[I % u._colorSet.length]),
                I === da
                  ? M.push({
                      x1: D[I],
                      y1: ha[I],
            ...
            for (I = 0; I < v.length; I++)
              v[I].exploded &&
                ((ka = !0),
                u.reversed ? aa.push(v.length - 1 - I) : aa.push(I));
            $.clearRect(y.x1, y.y1, y.width, y.height);
            $.fillStyle = s.backgroundColor;
            $.fillRect(y.x1, y.y1, y.width, y.height);
            for (I = 0; I < M.length; I++)
              (B = M[I]), ua($, B, u.fillOpacity), ia.push(B.y1);
            q($);
            A &&
              u.visible &&
              (c(),
              ...
              d(),
              "inside" !== u.indexLabelPlacement &&
                (k(), s.animationEnabled || r($)),
              s.animationEnabled || t());
            if (!A)
              for (I = 0; I < v.length; I++)
                (B = u.dataPointIds[I]),
                  (D = {
                    ...
                    dataPointIndex: I,
                    dataSeriesIndex: 0,
                    funnelSection: M[u.reversed ? v.length - 1 - I : I],
                  }),
                  (s._eventManager.objectMap[B] = D);
            s.animationEnabled && s.animatedRender
              ? setTimeout(function () {
                  ka && n(s, -1);
                  A && (t(), "inside" !== u.indexLabelPlacement && r($));
                  a.targetCtx = null;
                }, s.animationDuration)
              : ka
              ? (n(s, -1, 1),
              ...
              : s.animationEnabled &&
                A &&
                (t(), "inside" !== u.indexLabelPlacement && r($));
            this.funnelPyramidClickHandler = function (a) {
              ...
              if (
                ...
                if ("funnel" === u.type || "pyramid" === u.type)
                  u.reversed
                    ? (v[v.length - 1 - a].exploded = v[v.length - 1 - a]
                        .exploded
                        ? !1
                        : !0)
                    : (v[a].exploded = v[a].exploded ? !1 : !0);
                n(s, b);
              }
            };
            return {
    ...
    s.prototype.getPercentAndTotal = function (a, f) {
      ...
      return { percent: d, total: c };
    };
    s.prototype.replaceKeywordsWithValue = function (a, f, b, c, d) {
      var g = this;
      ...
      if (
        ...
        var k = "#percent",
          ...
          k = isNaN(n.percent) ? k : n.percent;
        do {
          n = "";
          if (b.percentFormatString) n = b.percentFormatString;
          else {
            var n = "#,##0.",
              h = Math.max(Math.ceil(Math.log(1 / Math.abs(k)) / Math.LN10), 2);
            if (isNaN(h) || !isFinite(h)) h = 2;
            for (var r = 0; r < h; r++) n += "#";
            b.percentFormatString = n;
          }
          a = a.replace("#percent", X(k, n, g._cultureInfo));
          a = a.replace(
            "#total",
            X(
              l,
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        try {
          var e = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
          e && 0 < e.length && ((h = Da(e[2])), (a = Da(e[1])));
        } catch (k) {}
        e = null;
        if ("color" === a)
        ...
        else if (b.hasOwnProperty(a)) e = b;
        else return "";
        e = e[a];
        null !== h && (e = e[h]);
        if ("x" === a)
          if (
            "dateTime" === g.plotInfo.axisXValueType ||
    ...
    V.prototype.render = function () {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        l = (this.markerMargin =
          ...
          !w(this.chart.options.legend.markerMargin)
      ...
      for (var r = [], p = 0; p < this.dataSeries.length; p++) {
        ...
        if (m.dataPoints && m.dataPoints.length)
          if (
            ...
            var e = (m.legendMarkerType = m.legendMarkerType
                ? m.legendMarkerType
                : ("line" !== m.type &&
                    "stepLine" !== m.type &&
                    "spline" !== m.type &&
                ...
                ? "error" === m.type && m._linkedSeries
                  ? m._linkedSeries.legendMarkerType
                    ? m._linkedSeries.legendMarkerType
                    : R.getDefaultLegendMarker(m._linkedSeries.type)
                  : R.getDefaultLegendMarker(m.type)
                : m.markerType),
              t = m.legendText
                ? m.legendText
                ...
                : m.name,
              q = (m.legendMarkerColor = m.legendMarkerColor
                ? m.legendMarkerColor
                : m.markerColor
                ? m.markerColor
                : "error" === m.type
              ...
              v = m.legendMarkerBorderThickness
                ...
                : 0;
            "error" === m.type && r.push(q);
            t = this.chart.replaceKeywordsWithValue(t, m.dataPoints[0], m, p);
            e = {
              markerType: e,
              markerColor: q,
              text: t,
            ...
            for (var x = 0; x < m.dataPoints.length; x++) {
              var y = m.dataPoints[x],
                e = y.legendMarkerType
                  ? y.legendMarkerType
                  : m.legendMarkerType
                  ? m.legendMarkerType
                  : R.getDefaultLegendMarker(m.type),
                ...
                v = y.legendMarkerBorderThickness
                  ...
                  : m.legendMarkerBorderThickness
                  ? m.legendMarkerBorderThickness
                  : y.markerBorderThickness || m.markerBorderThickness
                  ? Math.max(1, Math.round(0.2 * s))
                  : 0,
                t = this.chart.replaceKeywordsWithValue(t, y, m, x),
                e = {
                  markerType: e,
                  markerColor: q,
                  text: t,
              ...
              (y.showInLegend || (m.showInLegend && !1 !== y.showInLegend)) &&
                n.push(e);
            }
      }
      ...
      if (0 < n.length) {
        ...
        for (p = 0; p < n.length; p++) {
          ...
          if (
            "line" === e.chartType ||
            "spline" === e.chartType ||
            "stepLine" === e.chartType
          )
            y -= 2 * 0.1 * this.lineHeight;
          if (
            !(
              0 >= k ||
              "undefined" === typeof k ||
            ...
            if ("horizontal" === this.orientation) {
              ...
              if (
                ...
                (m = { items: [], width: 0 }),
                  ...
                  (this.height += x),
                  (x = 0);
              x = Math.max(x, e.textBlock.height);
            } else
              (e.textBlock = new ja(this.ctx, {
                x: 0,
                y: 0,
                  ...
                  (e.textBlock.width =
                    ...
                    (s +
                      ...
                      "stepLine" === e.chartType
                        ? 2 * 0.1 * this.lineHeight
                        : 0))),
                this.height < k - this.lineHeight
                  ? ((m = { items: [], width: 0 }), h.push(m))
                  : ((m = h[v]), (v = (v + 1) % h.length)),
                (this.height += e.textBlock.height);
            e.textBlock.x = m.width;
            e.textBlock.y = 0;
            m.width += Math.round(
              e.textBlock.width +
                s +
        ...
        this.itemWidth = t;
        this.height =
          !1 === this.itemWrap ? h.length * this.lineHeight : this.height + x;
      ...
      for (p = 0; p < this.items.length; p++)
        (e = n[p]),
          (e.id = ++this.chart._eventManager.lastObjectId),
          (this.chart._eventManager.objectMap[e.id] = {
            id: e.id,
      ...
      for (p = f = 0; p < h.length; p++) {
        m = h[p];
        for (y = x = 0; y < m.items.length; y++) {
          e = m.items[y];
          q = e.textBlock.x + d + (0 === y ? 0.2 * s : this.horizontalSpacing);
          u = c + f;
          t = q;
          ...
          this.ctx.save();
          this.ctx.beginPath();
          this.ctx.rect(d, c, g, Math.max(k - (k % this.lineHeight), 0));
          this.ctx.clip();
          if (
            "line" === e.chartType ||
            "stepLine" === e.chartType ||
            ...
            (this.ctx.strokeStyle = e.lineColor),
              (this.ctx.lineWidth = Math.ceil(this.lineHeight / 8)),
              this.ctx.beginPath(),
              this.ctx.moveTo(
                q - 0.1 * this.lineHeight,
                u + this.lineHeight / 2
              ),
              this.ctx.lineTo(
                q + 0.85 * this.lineHeight,
                u + this.lineHeight / 2
              ),
              this.ctx.stroke(),
              (t -= 0.1 * this.lineHeight);
          if ("error" === e.chartType) {
            this.ctx.strokeStyle = r[0];
            v = s / 8;
            this.ctx.lineWidth = v;
            this.ctx.beginPath();
            var v = q - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
              z = u + 0.15 * this.lineHeight,
              A = 0.7 * this.lineHeight,
              B = A + 0.02 * this.lineHeight;
            this.ctx.moveTo(v, z);
            this.ctx.lineTo(v + A, z);
            this.ctx.stroke();
            this.ctx.beginPath();
            this.ctx.moveTo(v + A / 2, z);
            this.ctx.lineTo(v + A / 2, z + B);
            this.ctx.stroke();
            this.ctx.beginPath();
            this.ctx.moveTo(v, z + B);
            this.ctx.lineTo(v + A, z + B);
            this.ctx.stroke();
            r.shift();
          }
          ea.drawMarker(
          ...
          if (
            ...
            e.textBlock.x += 0.1 * this.lineHeight;
          e.textBlock.y = Math.round(u + this.lineHeight / 2);
          e.textBlock.render(!0);
          this.ctx.restore();
          x = 0 < y ? Math.max(x, e.textBlock.height) : e.textBlock.height;
          this.chart.data[e.dataSeriesIndex].visible ||
          ...
          this.ghostCtx.fillRect(
            ...
            e.textBlock.x + e.textBlock.width - t,
            e.textBlock.height
          );
          e.x1 = this.chart._eventManager.objectMap[e.id].x1 = t;
          e.y1 = this.chart._eventManager.objectMap[e.id].y1 =
            e.textBlock.y - this.lineHeight / 2;
          e.x2 = this.chart._eventManager.objectMap[e.id].x2 =
            e.textBlock.x + e.textBlock.width;
          e.y2 = this.chart._eventManager.objectMap[e.id].y2 =
            e.textBlock.y + e.textBlock.height - this.lineHeight / 2;
        }
        f += x;
      }
      0 < n.length &&
        ...
        if (0 <= g && g < this.dataPoints.length) {
          var c = this.dataPoints[g],
            p = this.axisX.logarithmic
              ...
              : Math.abs(c.x - a);
          p < b.distance &&
            ((b.dataPoint = c), (b.distance = p), (b.index = g));
          c = p;
          c <= l ? (l = c) : 0 < k ? n++ : h++;
          if (1e3 < n && 1e3 < h) break;
        } else if (0 > r - d && r + d >= this.dataPoints.length) break;
        -1 === k ? (d++, (k = 1)) : (k = -1);
      }
        ...
        if (0 <= g && g < this.dataPoints.length) {
          ...
          if (m) {
            switch (this.type) {
              ...
              case "splineArea":
              case "scatter":
                var q = ia("markerSize", e, this) || 4,
                  s = b ? 20 : q,
                  t = Math.sqrt(Math.pow(m.x1 - a, 2) + Math.pow(m.y1 - f, 2));
                t <= s &&
                  c.push({
                    dataPoint: e,
                    dataPointIndex: g,
              ...
              case "doughnut":
                ...
                s =
                  "doughnut" === this.type
                    ...
                    : 0;
                t = Math.sqrt(Math.pow(q.x - a, 2) + Math.pow(q.y - f, 2));
                t < m.radius &&
                  t > s &&
                  ((t = Math.atan2(f - q.y, a - q.x)),
                  0 > t && (t += 2 * Math.PI),
                  (t = Number(
                  ...
                  0 === s && 1 < m.endAngle && (s = 360),
                  q >= s && 0 !== e.y && ((s += 360), t < q && (t += 360)),
                  t > q &&
                    t < s &&
                    (c.push({
                      dataPoint: e,
              ...
              case "pyramid":
                ...
                f > t.y1 &&
                  ...
                  (t.y6
                    ? f > t.y6
                      ? ((g =
                          t.x6 + ((t.x5 - t.x6) / (t.y5 - t.y6)) * (f - t.y6)),
                        (t =
                          t.x3 + ((t.x4 - t.x3) / (t.y4 - t.y3)) * (f - t.y3)))
                      : ((g =
                          t.x1 + ((t.x6 - t.x1) / (t.y6 - t.y1)) * (f - t.y1)),
                        (t =
                          t.x2 + ((t.x3 - t.x2) / (t.y3 - t.y2)) * (f - t.y2)))
                    : ((g =
                        t.x1 + ((t.x4 - t.x1) / (t.y4 - t.y1)) * (f - t.y1)),
                      (t =
                        t.x2 + ((t.x3 - t.x2) / (t.y3 - t.y2)) * (f - t.y2))),
                  a > g &&
                    a < t &&
    ...
    R.prototype.getMarkerProperties = function (a, f, b, c) {
      ...
      return {
        ...
        y: b,
        ctx: c,
        type: d[a].markerType ? d[a].markerType : this.markerType,
        size: d[a].markerSize ? d[a].markerSize : this.markerSize,
        color: d[a].markerColor
          ? d[a].markerColor
          : this.markerColor
          ? this.markerColor
          : d[a].color
        ...
        borderColor: d[a].markerBorderColor
          ? d[a].markerBorderColor
          : this.markerBorderColor
          ? this.markerBorderColor
          : null,
        borderThickness: d[a].markerBorderThickness
    ...
    B.prototype.createLabels = function () {
      var a,
        ...
        n = 0,
        h,
        r = 0.6 * this.chart.height,
        b = !1,
        p;
      a = !1;
      var m = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
        e = m.length
          ? w(this.scaleBreaks.firstBreakIndex)
            ? 0
      ...
      if ("axisX" === this.type && b && !this.logarithmic) {
        ...
        for (
          var t = e, b = this.intervalStartPosition;
          b < d;
          Ra(b, l, this.intervalType)
        ) {
          for (a = b.getTime(); t < m.length && a > m[t].endValue; t++);
          p = a;
          a = t < m.length && a >= m[t].startValue && a <= m[t].endValue;
          a ||
            ((a = this.labelFormatter
              ...
              ? this.labels[p]
              : ya(p, this.valueFormatString, this.chart._cultureInfo)),
            (a = new ja(this.ctx, {
              x: 0,
              y: 0,
              maxWidth: g,
        ...
        if (this.logarithmic && !this.equidistantInterval)
          for (
            ...
            if (((b = this.logLabelValues[c]), b < this.viewportMinimum)) c++;
              ...
              for (; t < m.length && b > m[t].endValue; t++);
              a = t < m.length && b >= m[t].startValue && b <= m[t].endValue;
              p = b;
              a ||
                ((a = this.labelFormatter
                  ? this.labelFormatter({
                  ...
                  : "axisX" === this.type && this.labels[p]
                  ? this.labels[p]
                  : X(p, this.valueFormatString, this.chart._cultureInfo)),
                (a = new ja(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: g,
      ...
      if (this.labelAutoFit || this.options.labelAutoFit)
        if (
          ...
          if (
            ...
            for (b = 0; b < this._labels.length; b++)
              if (!this._labels[b].breaksLabelType) {
                ...
                for (var q, t = a.text.split(" "), c = 0; c < t.length; c++)
                  (l = t[c]),
                    (this.ctx.font =
                      a.fontStyle +
                      " " +
            ...
            for (
              ...
              if (!this._labels[b].breaksLabelType) {
                ...
                m.push(a.height);
                this.sessionVariables.labelMaxHeight = Math.max.apply(Math, m);
                ...
                if (
                  ...
                  if (
                    ...
                    if (w(this.options.labelWrap))
                      if (!w(this.options.labelMaxWidth))
                        ...
                        if (
                          ...
                          c - 2 * g > d &&
                            ...
                            c >= 2 * g && c < 2.2 * g
                              ? ((this.sessionVariables.labelMaxWidth = g),
                                w(this.options.labelFontSize) &&
                                  12 < t &&
                                  ((t = Math.floor((12 / 13) * t)),
                                  a.measureText()),
                                (this.sessionVariables.labelFontSize = w(
                              ...
                              ? ((this.sessionVariables.labelAngle = -25),
                                (this.sessionVariables.labelMaxWidth = l),
                                (this.sessionVariables.labelFontSize = t))
                              : c >= 2.8 * g && c < 3.2 * g
                              ? ((this.sessionVariables.labelMaxWidth =
                                  Math.max(g, e)),
                          ...
                          ((0 === q &&
                            e +
                              this._labels[q + 1].textBlock.measureText()
                                .width -
                              2 * g >
                              d) ||
                            (q === this._labels.length - 1 &&
                              e +
                                this._labels[q - 1].textBlock.measureText()
                                  .width -
                                2 * g >
                  ...
                  w(this.options.labelWrap))
                    ? w(this.options.labelWrap) &&
                      (this.labelWrap && !w(this.options.labelMaxWidth)
                        ? ((this.sessionVariables.labelWrap = this.labelWrap),
          ...
          if (
            ...
            this.sessionVariables.labelMaxWidth = g;
            this.sessionVariables.labelMaxHeight = k;
            this.sessionVariables.labelAngle = w(
              this.sessionVariables.labelAngle
            )
              ? 0
              : this.sessionVariables.labelAngle;
        ...
        if ("outside" === g.labelPlacement) {
          ...
          if ("left" === this._position || "right" === this._position)
            s = w(g.options.labelWrap)
              ...
              : 1.5 * this.labelFontSize;
          w(g.labelBackgroundColor) && (g.labelBackgroundColor = "#EEEEEE");
        } else
          (k =
            "bottom" === this._position || "top" === this._position
            ...
            (s =
              w(g.options.labelWrap) || g.labelWrap
                ? "bottom" === this._position || "top" === this._position
                  ? (0.8 * this.chart.width) >> 0
                  : (0.8 * this.chart.height) >> 0
                : 1.5 * this.labelFontSize),
            w(g.labelBackgroundColor) &&
              (w(g.startValue) && 0 !== g.startValue
                ? (g.labelBackgroundColor = x ? "transparent" : null)
              ...
              0 === this.labelAngle
                ...
                : c.width *
                  ...
                  (c.height - b.fontSize / 2) *
                    Math.sin((Math.PI / 180) * Math.abs(this.labelAngle));
          a < d && (a = d);
          this._labels[f].effectiveWidth = d;
        }
              ...
              0 === this.labelAngle
                ...
                : c.width *
                  ...
                  (c.height - b.fontSize / 2) *
                    Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))),
            a < d && (a = d),
            (this._stripLineLabels[f].effectiveWidth = d));
      }
              ...
              0 === this.labelAngle
                ...
                : c.width *
                  ...
                  (c.height - f.fontSize / 2) *
                    Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))),
            a < d && (a = d),
            (this._stripLineLabels[b].effectiveHeight = d));
      }
      f = this.title ? this._titleTextBlock.measureText().height + 2 : 0;
      return (b =
        "inside" === this.labelPlacement
    ...
    B.setLayoutAndRender = function (a, f, b, c, d, g) {
      var k,
        l,
        n,
        h,
      ...
      for (e = 0; e < m.length; e++)
        if (m[e] && m[e].scaleBreaks && m[e].scaleBreaks._appliedBreaks.length)
          for (
            var t = m[e].scaleBreaks._appliedBreaks, q = 0;
            q < t.length && !(t[q].startValue > m[e].viewportMaximum);
            q++
          )
            t[q].endValue < m[e].viewportMinimum ||
              (w(m[e].scaleBreaks.firstBreakIndex) &&
                (m[e].scaleBreaks.firstBreakIndex = q),
              t[q].startValue >= m[e].viewPortMinimum &&
                (m[e].scaleBreaks.lastBreakIndex = q));
      for (
        var s = (q = 0),
          u = 0,
          v = 0,
        ...
        m[e] &&
          m[e].title &&
          (m[e]._titleTextBlock = new ja(m[e].ctx, {
            text: m[e].title,
            horizontalAlign: "center",
            fontSize: m[e].titleFontSize,
            fontFamily: m[e].titleFontFamily,
            fontWeight: m[e].titleFontWeight,
            fontColor: m[e].titleFontColor,
            fontStyle: m[e].titleFontStyle,
            borderColor: m[e].titleBorderColor,
            borderThickness: m[e].titleBorderThickness,
            backgroundColor: m[e].titleBackgroundColor,
            cornerRadius: m[e].titleCornerRadius,
            textBaseline: "top",
          }));
      for (e = 0; e < m.length; e++)
        if (m[e].title)
          switch (m[e]._position) {
            case "left":
              m[e]._titleTextBlock.maxWidth = m[e].titleMaxWidth || g.height;
              m[e]._titleTextBlock.maxHeight = m[e].titleWrap
                ? 0.8 * g.width
                : 1.5 * m[e].titleFontSize;
              m[e]._titleTextBlock.angle = -90;
              break;
            case "right":
              m[e]._titleTextBlock.maxWidth = m[e].titleMaxWidth || g.height;
              m[e]._titleTextBlock.maxHeight = m[e].titleWrap
              ...
              break;
            default:
              (m[e]._titleTextBlock.maxWidth = m[e].titleMaxWidth || g.width),
                (m[e]._titleTextBlock.maxHeight = m[e].titleWrap
                  ? 0.8 * g.height
                  : 1.5 * m[e].titleFontSize),
                (m[e]._titleTextBlock.angle = 0);
          }
      if ("normal" === d) {
        for (
          var v = [], y = [], z = [], D = [], P = [], N = [], I = [], R = [];
          ...
          if (b && 0 < b.length)
            ...
            z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
          I.push(z);
          if (c && 0 < c.length)
            for (D = [], e = ba = 0; e < c.length; e++)
              D.push(
          ...
          R.push(D);
          k = Math.round(g.x1 + aa + K);
          n = Math.round(
            g.x2 - ba - Z > r.width - 10 ? r.width - 10 : g.x2 - ba - Z
          );
          if (a && 0 < a.length)
            for (v = [], e = X = 0; e < a.length; e++)
              a[e] && (a[e].lineCoordinates = {}),
                (a[e].lineCoordinates.width = Math.abs(n - k)),
                a[e].title &&
          ...
          P.push(v);
          if (f && 0 < f.length)
            for (y = [], e = M = 0; e < f.length; e++)
              f[e] && (f[e].lineCoordinates = {}),
                (f[e].lineCoordinates.width = Math.abs(n - k)),
                f[e].title &&
            ...
            y.push(Math.ceil(f[0] ? f[0].createLabelsAndCalculateHeight() : 0));
          N.push(y);
          if (a && 0 < a.length)
            for (e = 0; e < a.length; e++)
              a[e] &&
                ((a[e].lineCoordinates.x1 = k),
                (n = Math.round(
                  g.x2 - ba - Z > r.width - 10 ? r.width - 10 : g.x2 - ba - Z
                )),
                a[e]._labels &&
                  ...
                  (h = a[e]._labels[1]),
                  (l =
                    "dateTime" === a[e].chart.plotInfo.axisXValueType
                ...
                a[e] &&
                  ...
                  0 < a[e].labelAngle
                    ? B + u > n &&
                      (l += 0 < a[e].labelAngle ? B + u - n - ba : 0)
                    : 0 > a[e].labelAngle
                    ? A - s < k &&
                      A - s < a[e].viewportMinimum &&
                      (F =
                        k -
                        (K +
                          a[e].tickLength +
                  ...
                  0 < l
                    ...
                    : a[e].viewportMaximum === a[e].maximum &&
                      ...
                      (0 < F && (k += F), 0 < l && (n -= l))),
                r.panEnabled
                  ? (X = r.sessionVariables.axisX.height)
                  : (r.sessionVariables.axisX.height = X),
                (l = Math.round(g.y2 - X - d + Q)),
                (h = Math.round(g.y2)),
                (a[e].lineCoordinates.x2 = n),
                (a[e].lineCoordinates.width = n - k),
          ...
          if (f && 0 < f.length)
            for (e = 0; e < f.length; e++)
              (f[e].lineCoordinates.x1 = Math.round(g.x1 + aa + K)),
                ...
                f[e]._labels &&
                  ...
                  ((h = f[e]._labels[1]),
                  (l =
                    "dateTime" === f[e].chart.plotInfo.axisXValueType
                  ...
                  (u =
                    ...
                    (l.textBlock.height - l.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(l.textBlock.angle)))),
                r.panEnabled
                  ? (M = r.sessionVariables.axisX2.height)
                  : (r.sessionVariables.axisX2.height = M),
                (l = Math.round(g.y1)),
                (h = Math.round(g.y2 + f[e].margin)),
                (f[e].lineCoordinates.y1 = l + M + T - U),
                ...
                b[e] &&
                  ...
                  (K =
                    b[e]._labels && 0 < b[e]._labels.length
                      ? b[e]._labels[b[e]._labels.length - 1].textBlock.height /
                        2
                      : 10),
                  (l = Math.round(
                    g.y1 + M + T < Math.max(K, 10)
                      ? Math.max(K, 10)
                      : g.y1 + M + T
                  )),
                  (n = Math.round(
              ...
              c[e] &&
                ...
                (K =
                  c[e]._labels && 0 < c[e]._labels.length
                    ? c[e]._labels[c[e]._labels.length - 1].textBlock.height / 2
                    : 0),
                (l = Math.round(
                  g.y1 + M + T < Math.max(K, 10)
                    ? Math.max(K, 10)
            ...
            for (e = 0; e < a.length; e++)
              a[e] &&
                ...
                a[e]._labels &&
                  ...
                  (k = a[e].getAppearentDifferceReplacingBreaksToSize(
                    a[e].viewportMinimum,
                    k
                  )),
                  (B = a[e].logarithmic
                    ...
                    : (0 < k
                        ? k * Math.abs(a[e].conversionParameters.pixelPerUnit)
                        : 0) + a[e].lineCoordinates.x1)));
          if (f && 0 < f.length)
            for (e = 0; e < f.length; e++)
              f[e].calculateValueToPixelConversionParameters(),
                ...
                f[e]._labels &&
                  ...
                  (k =
                    f[e]._labels[
                      f[e]._labels.length -
                        ("dateTime" === f[e].chart.plotInfo.axisX2ValueType
                          ? 2
                          : 1)
                    ].position),
                  (k = f[e].getAppearentDifferceReplacingBreaksToSize(
                    f[e].viewportMinimum,
                    k
                  )),
                  (B = f[e].logarithmic
                    ...
                    : (0 < k
                        ? k * Math.abs(f[e].conversionParameters.pixelPerUnit)
                        : 0) + f[e].lineCoordinates.x1));
          for (e = 0; e < m.length; e++)
            "axisY" === m[e].type &&
              (m[e].calculateValueToPixelConversionParameters(),
              m[e].calculateBreaksSizeInValues());
          if (0 < q) {
            if (a && 0 < a.length)
              for (e = 0; e < a.length; e++)
                t = P[q - 1][e] === P[q][e] ? !0 : !1;
        ...
        p.beginPath();
        a[0] &&
          p.rect(5, a[0].bounds.y1, a[0].chart.width - 10, a[0].bounds.height);
        f[0] &&
          p.rect(
            5,
        ...
        N = [];
        for (I = []; 4 > q; ) {
          M = X = aa = W = Z = K = T = d = V = R = U = Q = 0;
          if (a && 0 < a.length)
            for (s = [], e = X = 0; e < a.length; e++)
              s.push(
            ...
            s.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
          N.push(s);
          if (f && 0 < f.length)
            for (B = [], e = M = 0; e < f.length; e++)
              B.push(
            ...
            B.push(Math.ceil(f[0] ? f[0].createLabelsAndCalculateWidth() : 0));
          I.push(B);
          if (b && 0 < b.length)
            for (e = 0; e < b.length; e++)
              (b[e].lineCoordinates = {}),
                (k = Math.round(g.x1 + X + d)),
                (n = Math.round(
                  g.x2 - M - T > r.width - 10 ? r.width - 10 : g.x2 - M - T
                )),
                b[e].labelAutoFit &&
                  !w(v) &&
                  (0 < !a.length &&
                  ...
                  0 < !f.length &&
                    (n =
                      0 < b[e].labelAngle
                        ...
                        ? n - y / 2
                        : n)),
                (b[e].lineCoordinates.x1 = k),
                (b[e].lineCoordinates.x2 = n),
                (b[e].lineCoordinates.width = Math.abs(n - k)),
                b[e].title &&
                  (b[e]._titleTextBlock.maxWidth =
                    0 < b[e].titleMaxWidth &&
                  ...
                  (0 < !a.length &&
                    (k =
                      0 < c[e].labelAngle
                        ...
                        : k),
                  0 < !f.length && (n -= D / 2)),
                (c[e].lineCoordinates.x1 = k),
                (c[e].lineCoordinates.x2 = n),
                (c[e].lineCoordinates.width = Math.abs(n - k)),
                c[e].title &&
                  (c[e]._titleTextBlock.maxWidth =
                    0 < c[e].titleMaxWidth &&
          ...
          if (c && 0 < c.length)
            ...
            F.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          P.push(F);
          if (b && 0 < b.length)
            for (e = 0; e < b.length; e++)
          ...
          if (r.panEnabled)
            for (e = 0; e < b.length; e++)
              A[e] = r.sessionVariables.axisY.height;
          else
            for (e = 0; e < b.length; e++)
              r.sessionVariables.axisY.height = A[e];
          if (b && 0 < b.length)
            for (e = b.length - 1; 0 <= e; e--)
              (l = Math.round(g.y2)),
                (h = Math.round(
                  g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2
                )),
                (b[e].lineCoordinates.y1 = l - (A[e] + b[e].margin + Q)),
                (b[e].lineCoordinates.y2 = l - (A[e] + b[e].margin + Q)),
                (b[e].bounds = {
                  x1: k,
                  y1: l - (A[e] + Q + b[e].margin),
                  x2: n,
                  y2: h - (Q + b[e].margin),
                  width: n - k,
                  height: A[e],
          ...
          if (c && 0 < c.length)
            for (e = c.length - 1; 0 <= e; e--)
              c[e] &&
                ((l = Math.round(g.y1)),
                (h = Math.round(g.y1 + (F[e] + c[e].margin + U))),
                (c[e].lineCoordinates.y1 = h),
                (c[e].lineCoordinates.y2 = h),
                (c[e].bounds = {
                  x1: k,
                  y1: l + (c[e].margin + U),
                  x2: n,
            ...
            for (e = 0; e < a.length; e++) {
              ...
              l =
                c && 0 < c.length
                  ...
                  ? Math.max(K, 10)
                  : g.y1;
              n = Math.round(g.x1 + X + d);
              h =
                b && 0 < b.length
                  ? Math.round(
                      b[0]
                        ? b[0].lineCoordinates.y1
                        : g.y2 - W > r.height - Math.max(K, 10)
                        ? r.height - Math.max(K, 10)
                        : g.y2 - W
                    )
                  : g.y2 > r.height - Math.max(K, 10)
                  ? r.height - Math.max(K, 10)
                  : g.y2;
              if (b && 0 < b.length)
              ...
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
                    ((n = c[K].lineCoordinates.x1), (k = n - X));
              a[e].lineCoordinates = {
                x1: n - R,
                y1: l,
                x2: n - R,
            ...
            for (e = 0; e < f.length; e++) {
              ...
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
                    ((n = c[K].lineCoordinates.x2), (k = n - M));
              f[e].lineCoordinates = {
                x1: n + V,
                y1: l,
                x2: n + V,
        ...
        if (b && 0 < b.length)
          for (e = 0; e < b.length; e++)
            b[e].calculateBreaksInPixels(), b[e].renderLabelsTicksAndTitle();
        if (c && 0 < c.length)
          for (e = 0; e < c.length; e++)
            c[e].calculateBreaksInPixels(), c[e].renderLabelsTicksAndTitle();
        if (a && 0 < a.length)
          for (e = 0; e < a.length; e++)
            a[e].calculateBreaksInPixels(), a[e].renderLabelsTicksAndTitle();
        if (f && 0 < f.length)
          for (e = 0; e < f.length; e++)
            f[e].calculateBreaksInPixels(), f[e].renderLabelsTicksAndTitle();
      }
      r.preparePlotArea();
      g = r.plotArea;
      p.save();
      ...
      if (a && 0 < a.length)
        for (e = 0; e < m.length; e++)
          m[e].renderStripLinesOfThicknessType("value");
      if (f && 0 < f.length)
        for (e = 0; e < f.length; e++)
          f[e].renderStripLinesOfThicknessType("value");
      if (b && 0 < b.length)
        for (e = 0; e < b.length; e++)
      ...
      if (f && 0 < f.length)
        for (e = 0; e < f.length; e++) f[e].renderInterlacedColors();
      if (b && 0 < b.length)
      ...
      if (a && 0 < a.length)
        for (e = 0; e < a.length; e++)
          a[e].renderGrid(),
            x && (a[e].createMask(), a[e].renderBreaksBackground());
      if (f && 0 < f.length)
        for (e = 0; e < f.length; e++)
          f[e].renderGrid(),
            x && (f[e].createMask(), f[e].renderBreaksBackground());
      if (b && 0 < b.length)
        for (e = 0; e < b.length; e++)
          b[e].renderGrid(),
            x && (b[e].createMask(), b[e].renderBreaksBackground());
      if (c && 0 < c.length)
        for (e = 0; e < c.length; e++)
          c[e].renderGrid(),
            x && (c[e].createMask(), c[e].renderBreaksBackground());
      if (a && 0 < a.length)
        for (e = 0; e < a.length; e++) a[e].renderAxisLine();
      if (f && 0 < f.length)
        for (e = 0; e < f.length; e++) f[e].renderAxisLine();
      if (b && 0 < b.length)
      ...
      if (f && 0 < f.length)
        for (e = 0; e < f.length; e++)
          f[e].renderStripLinesOfThicknessType("pixel");
      if (b && 0 < b.length)
        for (e = 0; e < b.length; e++)
          ...
          b =
            ...
            a /
              (this.logarithmic
                ...
                : this.conversionParameters.maximum -
                  this.conversionParameters.minimum),
          c = this.scaleBreaks && !w(this.scaleBreaks.options.spacing),
          d,
          g = 0;
        g < f.length;
        g++
      )
        (d = c || !w(f[g].options.spacing)),
          (f[g].spacing =
            J(f[g].spacing, a, 8, d ? 0.1 * a : 8, d ? 0 : 3) << 0),
                ...
                p.position < this.viewportMinimum ||
                  ((k =
                    ...
                    p.textBlock.height *
                      Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))),
                  (b += k));
            b > this.lineCoordinates.width * d && this.labelAutoFit && (f = !0);
          }
        if ("left" === this._position || "right" === this._position)
          if (
            this.logarithmic &&
                ...
                p.position < this.viewportMinimum ||
                  ((r =
                    ...
                    p.textBlock.width *
                      Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))),
                  (c += r));
            c > this.lineCoordinates.height * d &&
              this.labelAutoFit &&
              (f = !0);
          }
      }
        ...
        for (h = 0; h < this._labels.length; h++)
          (p = this._labels[h]),
            p.position < this.viewportMinimum ||
              ...
              ((m = this.getPixelCoordinatesOnAxis(p.position)),
              this.tickThickness &&
                "inside" != this.labelPlacement &&
                ...
                this.ctx.stroke()),
              0 === p.textBlock.angle
                ? ((m.x -= p.textBlock.width / 2),
                  (m.y =
                    "inside" === this.labelPlacement
                      ? m.y - (this.tickLength + p.textBlock.fontSize / 2)
                      : m.y + this.tickLength + p.textBlock.fontSize / 2))
                : ((m.x =
                    "inside" === this.labelPlacement
                      ? 0 > this.labelAngle
              ...
              for (h = 0; h < a._labels.length; h++)
                if (
                  ...
                  !(
                    ...
                    ((m = a.getPixelCoordinatesOnAxis(p.position)),
                    a.tickThickness))
                ) {
            ...
            p.position < this.viewportMinimum ||
              ...
              0 === this.labelAngle
                ? ((p.textBlock.y = m.y),
                  (p.textBlock.x =
                    "inside" === this.labelPlacement
                      ? m.x - p.textBlock.width - this.tickLength - 5
                      : m.x + this.tickLength + 5))
                : ((p.textBlock.y =
                    "inside" === this.labelPlacement
                      ? m.y -
      ...
      if ("inside" === this.labelPlacement)
          ...
          function () {
            for (h = 0; h < a._labels.length; h++)
              (p = a._labels[h]),
                p.position < a.viewportMinimum ||
                  p.position > a.viewportMaximum ||
                  (f && 0 !== g++ % 2 && a.labelAutoFit && p.skipFlag) ||
                  (a.ctx.save(),
                  a.ctx.beginPath(),
        ...
        for (h = 0; h < this._labels.length; h++)
          (p = this._labels[h]),
            p.position < this.viewportMinimum ||
              p.position > this.viewportMaximum ||
              (f && 0 !== g++ % 2 && this.labelAutoFit && p.skipFlag) ||
              p.textBlock.render(!0);
    };
    B.prototype.renderInterlacedColors = function () {
      ...
      if (
        ...
        for (
          ...
          f
            ? ((f = this.getPixelCoordinatesOnAxis(this._labels[d].position)),
              (b =
        ...
        for (
          ...
          f
            ? ((b = this.getPixelCoordinatesOnAxis(this._labels[d].position)),
              (f =
                d + 1 > this._labels.length - 1
                  ? this.getPixelCoordinatesOnAxis(this.viewportMaximum)
                  : this.getPixelCoordinatesOnAxis(
    ...
    B.prototype.renderAxisLine = function () {
      var a = this.chart.ctx,
        f = x ? this.chart._preRenderCtx : a,
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          this.reversed
            ? ((d = this.lineCoordinates.x2), (g = this.lineCoordinates.x1))
            : ((d = this.lineCoordinates.x1), (g = this.lineCoordinates.x2));
          ...
          f.beginPath();
          if (this.scaleBreaks && !w(this.scaleBreaks.firstBreakIndex))
            if (w(this.scaleBreaks.lastBreakIndex))
              d =
              ...
              for (
                ...
                f.moveTo(d, k),
                  ...
                  (d = this.scaleBreaks._appliedBreaks[l].endPixel + c);
          d && (f.moveTo(d, k), f.lineTo(g, k));
          f.stroke();
        }
      } else if (
        ("left" === this._position || "right" === this._position) &&
        ...
        this.reversed
          ? ((d = this.lineCoordinates.y1), (g = this.lineCoordinates.y2))
          : ((d = this.lineCoordinates.y2), (g = this.lineCoordinates.y1));
        f.lineWidth = this.lineThickness;
        ...
        if (this.scaleBreaks && !w(this.scaleBreaks.firstBreakIndex))
          if (w(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              f.moveTo(k, d),
                f.lineTo(k, this.scaleBreaks._appliedBreaks[l].startPixel + c),
                (d = this.scaleBreaks._appliedBreaks[l].endPixel + b);
        d && (f.moveTo(k, d), f.lineTo(k, g));
        f.stroke();
      }
      x &&
        (a.drawImage(
              ...
              if (f)
                if (d[b].startValue < this.conversionParameters.minimum) {
                  if (
                    ...
                    this.conversionParameters.minimum *
                      Math.pow(
                        d[b].endValue / d[b].startValue,
                        Math.log(c) / Math.log(d[b].size)
                      ) <
                      d[b].endValue
                  ) {
                    a = Math.pow(
                    ...
                    (a *=
                      ...
                      Math.pow(
                        d[b].size,
                        Math.log(
                          d[b].endValue / this.conversionParameters.minimum
                        ) / Math.log(d[b].endValue / d[b].startValue)
                      )),
                      (c /= Math.pow(
                        d[b].size,
                        Math.log(
                  ...
                  c >
                  d[b].startValue / this.conversionParameters.minimum
                ) {
                  ...
                  if (c < d[b].size) {
                    a *=
                      Math.pow(
                        d[b].endValue / d[b].startValue,
                        1 === d[b].size ? 1 : Math.log(c) / Math.log(d[b].size)
                      ) / c;
                    break;
                  } else a *= d[b].endValue / d[b].startValue / d[b].size;
                  c /= d[b].size;
                  f = !1;
                } else break;
                  ...
                  if (
                    ...
                    (a *=
                      ...
                      (c *= Math.pow(
                        d[b].size,
                        Math.log(
                          this.conversionParameters.minimum / d[b].startValue
                        ) / Math.log(d[b].endValue / d[b].startValue)
                      ));
                  f = !1;
                } else if (
              ...
              if (f)
                if (d[b].startValue < this.conversionParameters.minimum) {
                  if (
                    d[b].size &&
                    this.conversionParameters.minimum +
                      (c * (d[b].endValue - d[b].startValue)) / d[b].size <
                      d[b].endValue
                  ) {
                    a =
                      0 >= d[b].size
    ...
    B.prototype.convertValueToPixel = function (a) {
      a = this.getAppearentDifferceReplacingBreaksToSize(
        this.conversionParameters.minimum,
        a,
        a
      );
    ...
    B.prototype.getAppearentDifferceReplacingBreaksToSize = function (
      a,
      f,
      b,
      c
      ...
      if (this.logarithmic) {
        b = w(b) ? f / a : b;
        for (var g = 0; g < d.length && !(f < d[g].startValue); g++)
          a > d[g].endValue ||
            (a <= d[g].startValue && f >= d[g].endValue
              ? (b = (b / d[g].endValue) * d[g].startValue * d[g].size)
              : a >= d[g].startValue && f >= d[g].endValue
              ? (b =
                  (b / d[g].endValue) *
                  a *
                  Math.pow(
                    d[g].size,
                    Math.log(d[g].endValue / a) /
                      Math.log(d[g].endValue / d[g].startValue)
                  ))
              : a <= d[g].startValue && f <= d[g].endValue
              ? (b =
                  (b / f) *
              ...
              : !c &&
                ...
                (b =
                  ...
                  Math.pow(
                    d[g].size,
                    Math.log(f / a) / Math.log(d[g].endValue / d[g].startValue)
                  )));
      } else
        for (
          b = w(b) ? Math.abs(f - a) : b, g = 0;
          g < d.length && !(f < d[g].startValue);
          g++
        )
          a > d[g].endValue ||
            (a <= d[g].startValue && f >= d[g].endValue
              ...
              ? (b =
                  ...
                  d[g].endValue +
                  a +
                  (d[g].size * (d[g].endValue - a)) /
                    (d[g].endValue - d[g].startValue))
              : a <= d[g].startValue && f < d[g].endValue
              ? (b =
                  b -
                  f +
                  d[g].startValue +
                  (d[g].size * (f - d[g].startValue)) /
                    (d[g].endValue - d[g].startValue))
              : !c &&
                a > d[g].startValue &&
                f < d[g].endValue &&
                (b =
                  a +
                  (d[g].size * (f - a)) / (d[g].endValue - d[g].startValue)));
      return b;
    };
        ...
        for (
          ...
          this.viewportMinimum > a[d].endValue ||
            ...
            this.viewportMaximum <= a[d].endValue
              ...
              : this.viewportMinimum <= a[d].startValue &&
                this.viewportMaximum >= a[d].endValue
              ? ((c = (c / a[d].endValue) * a[d].startValue),
                (b =
                  0 < a[d].spacing.toString().indexOf("%")
                    ? b * (1 - parseFloat(a[d].spacing) / 100)
                    : b - Math.min(a[d].spacing, 0.1 * b)))
              : this.viewportMinimum > a[d].startValue &&
                this.viewportMaximum >= a[d].endValue
              ? ((c = (c / a[d].endValue) * this.viewportMinimum),
                (b =
                  0 < a[d].spacing.toString().indexOf("%")
                    ? b *
                      (1 -
                    ...
                    : b -
                      (Math.min(a[d].spacing, 0.1 * b) *
                        Math.log(a[d].endValue / this.viewportMinimum)) /
                        Math.log(a[d].endValue / a[d].startValue)))
              : this.viewportMinimum <= a[d].startValue &&
                this.viewportMaximum < a[d].endValue &&
                ((c = (c / this.viewportMaximum) * a[d].startValue),
                (b =
                  0 < a[d].spacing.toString().indexOf("%")
                    ? b *
                      (1 -
    ...
    B.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        if (
          w(this.options.viewportMaximum) &&
          !w(this.sessionVariables.newViewportMaximum) &&
          !isNaN(this.sessionVariables.newViewportMaximum)
        )
          this.viewportMaximum = this.sessionVariables.newViewportMaximum;
          ...
          "axisY" === this.type &&
            ...
            0 === d && 0 === g
              ...
              ? ((c = Math.min(
                  0.01 *
                    Math.abs(
                      this.getAppearentDifferceReplacingBreaksToSize(
                        g,
                        d,
                        null,
                        !0
            ...
            this.includeZero &&
              ...
              0 > g &&
              (g = 0));
        c = this.getAppearentDifferceReplacingBreaksToSize(
            ...
            ("axisX" === this.type
              ...
              : "axisY" === this.type &&
                ...
                this.includeZero &&
                  ...
                  (g = 0)),
            Math.abs(
              this.getAppearentDifferceReplacingBreaksToSize(d, g, null, !0)
            ),
            "axisX" === this.type && b)
          ) {
    ...
    B.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      "axisX" === this.type
        ? ((c =
          ...
          (g =
            Infinity !== this.dataInfo.minDiff
              ? this.dataInfo.minDiff
              : d / c > this.logarithmBase
              ? (d / c) * Math.pow(this.logarithmBase, 0.5)
              : this.logarithmBase))
        : "axisY" === this.type &&
          ((c =
            null !== this.viewportMinimum
          ...
          0 >= c && !isFinite(d)
            ...
            : isFinite(d) || (d = c),
          1 === c && 1 === d
            ? ((d *= this.logarithmBase - 1 / this.logarithmBase), (c = 1))
            : 1 === d / c
            ? ((k = Math.min(
            ...
            : c > d
            ? ((k = Math.min(
                (c / d) * Math.pow(this.logarithmBase, 0.01),
                Math.pow(this.logarithmBase, 5)
              )),
              1 <= d ? (c = d / k) : (d = c * k))
            : ((k = Math.min(
                (d / c) * Math.pow(this.logarithmBase, 0.01),
      ...
      k = Math.pow(
        this.logarithmBase,
        B.getNiceNumber(Math.abs(Math.log(k) / f), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = B.getNiceExponent(Math.log(k) / f / (a - 1), !0)),
          (b = B.getNiceNumber(linearRange / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          "axisX" === this.type
            ? c / Math.sqrt(g)
        ...
        "axisX" === this.type
          ...
          : "axisY" === this.type &&
            ...
            isFinite(c) || isFinite(d)
              ? 1 === c && 1 === d
                ? ((d *= this.logarithmBase), (c /= this.logarithmBase))
                : 1 === d / c
                ? ((k = Math.pow(this.logarithmBase, this.interval)),
                  (d *= k),
                  (c /= k))
                : c > d
                ? ((k = Math.min(0.01 * (c / d), 5)),
                  1 <= d ? (c = d / k) : (d = c * k))
                : ((k = Math.min(
                    (d / c) * Math.pow(this.logarithmBase, 0.01),
                    Math.pow(this.logarithmBase, 0.04)
      ...
      if (
        ...
        if (2 < f) for (k = 0; k < f - 2; k++) this.valueFormatString += "#";
      }
    };
    ...
    da.prototype.render = function (a) {
      if (
        ...
        if (
          ...
          if (
            ((c = 1 === p % 2 ? (c.x << 0) + 0.5 : c.x << 0),
            (k = 1 === p % 2 ? (d.x << 0) + 0.5 : d.x << 0),
            "top" === this.scaleBreaks.parent._position
              ...
              : ((d = this.chart.plotArea.y2),
                ...
                (a *= -1)),
            (this.bounds = { x1: c - p / 2, y1: d, x2: k + p / 2, y2: l }),
            this.ctx.moveTo(c, d),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(c, l), this.ctx.lineTo(k, l), this.ctx.lineTo(k, d);
          ...
          if (
            ...
            (l = 1 === p % 2 ? (c.y << 0) + 0.5 : c.y << 0),
            "left" === this.scaleBreaks.parent._position
              ? ((c = this.chart.plotArea.x1),
                (k = (this.chart.plotArea.x2 + p / 2 + 0.5) << 0))
              : ((c = this.chart.plotArea.x2),
                (k = (this.chart.plotArea.x1 - p / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: c, y1: d - p / 2, x2: k, y2: l + p / 2 }),
            this.ctx.moveTo(c, d),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(k, d), this.ctx.lineTo(k, l), this.ctx.lineTo(c, l);
          else if ("wavy" === this.type) {
            n = c;
            h = d;
            g = 0.5;
            ...
            r = (k - n) / a / 2;
            for (m = 0; m < r; m++)
              this.ctx.lineTo(n, h), (h += 2 * g * a), (n += 2 * a), (g *= -1);
            this.ctx.lineTo(n, h);
            h += l - d;
            for (m = 0; m < r + 1; m++)
              this.ctx.lineTo(n, h), (h += 2 * g * a), (n -= 2 * a), (g *= -1);
            this.ctx.lineTo(n + a, h + g * a);
          }
        0 < p && this.ctx.stroke();
        this.ctx.closePath();
    ...
    ba.prototype.render = function () {
      ...
      if (0 < f) {
        ...
        if (
          ...
          (d = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            (k = this.chart.plotArea.y1),
            (l = this.chart.plotArea.y2),
            (this.bounds = { x1: d - f / 2, y1: k, x2: g + f / 2, y2: l });
        else if (
          ...
          (k = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            ...
            (this.bounds = { x1: d, y1: k - f / 2, x2: g, y2: l + f / 2 });
        this.ctx.moveTo(d, k);
        this.ctx.lineTo(g, l);
        this.ctx.stroke();
    ...
    ka(ga, T);
    ga.prototype.render = function (a, f) {
      var b,
        c,
        d,
        g,
      ...
      if (!this.valueFormatString)
        if (
          !w(this.parent.dataSeries) &&
          0 < this.parent.dataSeries.length &&
          "dateTime" === this.parent.dataSeries[0].xValueType
        )
      ...
      r.lineWidth = h;
      r.save();
      this.labelFontSize = w(this.options.labelFontSize)
        ? this.parent.labelFontSize
        : this.labelFontSize;
      if ("left" === this.parent._position || "right" === this.parent._position)
        (this.labelMaxWidth = w(this.options.labelMaxWidth)
          ? this.parent.bounds.x2 - this.parent.bounds.x1
          : this.labelMaxWidth),
          (this.labelMaxHeight =
            w(this.options.labelWrap) || this.labelWrap
              ? 3 * this.chart.height
        ...
        (this.labelMaxWidth = w(this.options.labelMaxWidth)
          ...
          (this.labelMaxHeight =
            w(this.options.labelWrap) || this.labelWrap
              ...
              : 2 * this.labelFontSize);
      0 < h && r.setLineDash && r.setLineDash(F(this.lineDashType, h));
      l = new ja(r, {
        x: 0,
        y: 0,
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var q = 0; q < this.parent.dataSeries.length; q++)
            (e = this.parent.dataSeries[q].getDataPointAtX(m, !0)) &&
              0 <= e.index &&
              ((e.dataSeries = this.parent.dataSeries[q]),
              null !== e.dataPoint.y && k.push(e));
          e = null;
          if (0 === k.length) return;
          k.sort(function (a, b) {
            return a.distance - b.distance;
          });
          e = Math.abs(a - this.parent.convertValueToPixel(k[0].dataPoint.y));
          q = 0;
          if (
            "rangeBar" === k[0].dataSeries.type ||
            "error" === k[0].dataSeries.type
          )
            for (
              var e = Math.abs(
                  a - this.parent.convertValueToPixel(k[q].dataPoint.y[0])
                ),
                s = 0,
                m = 0;
              m < k.length;
              ...
              if (k[m].dataPoint.y && k[m].dataPoint.y.length)
                for (n = 0; n < k[m].dataPoint.y.length; n++)
                  (s = Math.abs(
                    a - this.parent.convertValueToPixel(k[m].dataPoint.y[n])
                  )),
                    s < e && ((e = s), (q = m));
              else
                (s = Math.abs(
                  a - this.parent.convertValueToPixel(k[m].dataPoint.y)
                )),
                  s < e && ((e = s), (q = m));
          else if ("stackedBar" === k[0].dataSeries.type)
            for (
              var e = Math.abs(
                  a - this.parent.convertValueToPixel(k[0].dataPoint.y)
                ),
                v = (s = 0),
                m = (q = 0);
              m < k.length;
              ...
              if (k[m].dataPoint.y && k[m].dataPoint.y.length)
                ...
                (v += k[m].dataPoint.y),
                  (s = Math.abs(a - this.parent.convertValueToPixel(v))),
                  s < e && ((e = s), (q = m));
            ...
            for (
              ...
              if (k[m].dataPoint.y && k[m].dataPoint.y.length)
                ...
                (v += k[m].dataPoint.y),
                  (u = k[m].dataPoint.x.getTime
                    ? k[m].dataPoint.x.getTime()
                    : k[m].dataPoint.x),
                  (u = 100 * (v / k[m].dataSeries.plotUnit.dataPointYSums[u])),
          ...
          if (
            ...
            b = 0;
            if (
              "rangeBar" === this.parent.dataSeries[q].type ||
              "error" === this.parent.dataSeries[q].type
            ) {
              e = Math.abs(
              ...
              k =
                1 === r.lineWidth % 2
                  ? (this.parent.convertValueToPixel(v) << 0) + 0.5
            ...
            this.bounds = { x1: b - h / 2, y1: d, x2: c + h / 2, y2: g };
            ...
            c = this.chart.plotArea.x2;
            this.bounds = { x1: b, y1: d - h / 2, x2: c, y2: g + h / 2 };
            u = !1;
            if (this.parent.labels)
              for (
                k = Math.ceil(this.parent.interval), m = 0;
            ...
            if (u) {
              if ("axisX" === this.parent.type)
                for (
                  m = this.parent.convertPixelToValue({ y: f }),
                    e = null,
                    q = 0;
                  q < this.parent.dataSeries.length;
                  q++
                )
                  (e = this.parent.dataSeries[q].getDataPointAtX(m, !0)) &&
                    0 <= e.index &&
              ...
              "dateTime" === this.parent.dataSeries[0].xValueType
                ...
                : !w(this.parent.dataSeries) &&
                  0 < this.parent.dataSeries.length &&
                  "number" === this.parent.dataSeries[0].xValueType &&
                  (l.text = this.labelFormatter
                    ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
          ...
          if (u) {
            if ("axisX" === this.parent.type)
              for (
                m = this.parent.convertPixelToValue({ x: a }), e = null, q = 0;
                q < this.parent.dataSeries.length;
                q++
              )
                (e = this.parent.dataSeries[q].getDataPointAtX(m, !0)) &&
          ...
          if (
            ...
            for (
              e = Math.abs(
                f - this.parent.convertValueToPixel(k[0].dataPoint.y[0])
              ),
                m = s = 0;
              m < k.length;
              m++
              ...
              if (k[m].dataPoint.y && k[m].dataPoint.y.length)
                for (n = 0; n < k[m].dataPoint.y.length; n++)
                  (s = Math.abs(
                    f - this.parent.convertValueToPixel(k[m].dataPoint.y[n])
                  )),
                    s < e && ((e = s), (q = m));
              else
                (s = Math.abs(
                  f - this.parent.convertValueToPixel(k[m].dataPoint.y)
                )),
                  s < e && ((e = s), (q = m));
          else if (
            "stackedColumn" === k[0].dataSeries.type ||
            "stackedArea" === k[0].dataSeries.type
          )
            for (
              e = Math.abs(
                f - this.parent.convertValueToPixel(k[0].dataPoint.y)
              ),
                m = v = s = 0;
              m < k.length;
              m++
              ...
              if (k[m].dataPoint.y && k[m].dataPoint.y.length)
                ...
                (v += k[m].dataPoint.y),
                  (s = Math.abs(f - this.parent.convertValueToPixel(v))),
                  s < e && ((e = s), (q = m));
          else if (
            "stackedColumn100" === k[0].dataSeries.type ||
            "stackedArea100" === k[0].dataSeries.type
          )
            for (
              e = Math.abs(
                f - this.parent.convertValueToPixel(k[0].dataPoint.y)
          ...
          b = 0;
          if (
            "rangeColumn" === this.parent.dataSeries[q].type ||
            "rangeArea" === this.parent.dataSeries[q].type ||
            "error" === this.parent.dataSeries[q].type ||
            "rangeSplineArea" === this.parent.dataSeries[q].type ||
            "candlestick" === this.parent.dataSeries[q].type ||
            "ohlc" === this.parent.dataSeries[q].type ||
            "boxAndWhisker" === this.parent.dataSeries[q].type
          ) {
            e = Math.abs(f - this.parent.convertValueToPixel(n.dataPoint.y[0]));
            for (m = s = 0; m < n.dataPoint.y.length; m++)
              (s = Math.abs(
            ...
            "stackedColumn" === this.parent.dataSeries[q].type ||
            "stackedArea" === this.parent.dataSeries[q].type
          ) {
            e = Math.abs(f - this.parent.convertValueToPixel(k[0].dataPoint.y));
            v = s = 0;
            for (m = q; 0 <= m; m--)
              (v += k[m].dataPoint.y),
                (s = Math.abs(f - this.parent.convertValueToPixel(v))),
            ...
            "stackedColumn100" === this.parent.dataSeries[q].type ||
            "stackedArea100" === this.parent.dataSeries[q].type
          ) {
            e = Math.abs(f - this.parent.convertValueToPixel(k[0].dataPoint.y));
            v = s = 0;
            for (m = q; 0 <= m; m--)
            ...
            "waterfall" === this.parent.dataSeries[q].type
              ? ((k =
                  1 === r.lineWidth % 2
        ...
        ("bottom" === this.parent._position ||
          ...
          (0 < h && (r.moveTo(b, d), r.lineTo(c, g), r.stroke()),
          r.restore(),
          !w(l.text) &&
        ...
        ("left" === this.parent._position ||
          ...
          d <= this.parent.convertValueToPixel(this.parent.viewportMinimum) &&
          (0 < h && (r.moveTo(b, d), r.lineTo(c, g), r.stroke()),
          r.restore(),
          !w(l.text) &&
            ("number" === typeof l.text.valueOf() || 0 < l.text.length) &&
        ...
        if (
          ...
          (b = c = k = 1 === r.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (d = this.chart.plotArea.y1),
            (g = this.chart.plotArea.y2),
            (this.bounds = { x1: b - h / 2, y1: d, x2: c + h / 2, y2: g });
        else if (
          ...
          (d = g = k = 1 === r.lineWidth % 2 ? (f << 0) + 0.5 : f << 0),
            (b = this.chart.plotArea.x1),
            (c = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: d - h / 2, x2: c, y2: g + h / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var n = 0; n < this.chart.axisX.length; n++) {
                for (
                  var k = this.chart.axisX[n].convertPixelToValue({ y: f }),
                    h = null,
                    c = 0;
                  c < this.chart.axisX[n].dataSeries.length;
                  c++
                )
                  (h = this.chart.axisX[n].dataSeries[c].getDataPointAtX(
                    k,
                    b
                  )) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX[n].dataSeries[c]),
                    null !== h.dataPoint.y && l.push(h));
                h = null;
              }
            if (this.chart.axisX2)
              for (n = 0; n < this.chart.axisX2.length; n++) {
                k = this.chart.axisX2[n].convertPixelToValue({ y: f });
                h = null;
                for (c = 0; c < this.chart.axisX2[n].dataSeries.length; c++)
                  (h = this.chart.axisX2[n].dataSeries[c].getDataPointAtX(
                    k,
                    b
                  )) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX2[n].dataSeries[c]),
                    null !== h.dataPoint.y && l.push(h));
                h = null;
              }
          } else {
            ...
            if (this.chart.axisX)
              for (n = 0; n < this.chart.axisX.length; n++)
                for (
                  k = this.chart.axisX[n].convertPixelToValue({ x: a }),
                    h = null,
                    c = 0;
                  c < this.chart.axisX[n].dataSeries.length;
                  c++
            ...
            if (this.chart.axisX2)
              for (n = 0; n < this.chart.axisX2.length; n++)
                for (
                  k = this.chart.axisX2[n].convertPixelToValue({ x: a }),
                    h = null,
                    c = 0;
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (0 <= this.currentDataPointIndex)
              ...
              if (
                ...
                return;
              k = d.axisX.convertPixelToValue({ x: a });
              h = d.getDataPointAtX(k, b);
              h.dataSeries = d;
                        ...
                        this.contentDiv.style.borderColor =
                          this.options.borderColor
                            ...
                            : g[0].dataSeries._colorSet[
                                d.index % g[0].dataSeries._colorSet.length
                              ])
                    : (this.contentDiv.style.borderRightColor =
                        this.contentDiv.style.borderLeftColor =
                        this.contentDiv.style.borderColor =
      ...
      for (b = 0; b < a.length; b++) {
        ...
        if (
          ...
          var c = this.chart.data[d.dataSeriesIndex],
            g = c.dataPoints[d.dataPointIndex],
            k = d.dataPointIndex;
          !1 === g.highlightEnabled ||
            ...
            "rangeSplineArea" === c.type
              ...
              ? ua(f, d.funnelSection, 0.3, "white")
              : "candlestick" === c.type
              ? ((f.globalAlpha = 1),
                ...
                f.beginPath(),
                f.moveTo(d.x3 - c, Math.min(d.y2, d.y3)),
                f.lineTo(d.x3 - c, Math.min(d.y1, d.y4)),
                f.stroke(),
                f.beginPath(),
                f.moveTo(d.x3 - c, Math.max(d.y1, d.y4)),
                f.lineTo(d.x3 - c, Math.max(d.y2, d.y3)),
                f.stroke(),
                W(
                  f,
                  d.x1,
              ...
              ? ((f.globalAlpha = 1),
                ...
                (c = 0 === f.lineWidth % 2 ? 0 : 0.5),
                f.beginPath(),
                f.moveTo(d.x3 - c, d.y2),
                f.lineTo(d.x3 - c, d.y3),
                f.stroke(),
                f.beginPath(),
                f.moveTo(d.x3, d.y1),
                f.lineTo(d.x1, d.y1),
              ...
              ? (f.save(),
                ...
                W(
                  f,
                  d.x1 - d.borderThickness / 2,
                  Math.max(
                    d.y2 + d.borderThickness / 2,
                    d.y3 + d.borderThickness / 2
                  ),
                  d.x2 + d.borderThickness / 2,
                  Math.min(
                    d.y2 - d.borderThickness / 2,
                    d.y3 - d.borderThickness / 2
                  ),
    ...
    Z.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (
        var f = null, b = null, c = null, d = 0, g = "", k = !0, l = 0;
        l < a.length;
        l++
      )
      ...
      if (
        ...
        for (var n = null, h = "", l = 0; l < a.length; l++)
          (b = a[l].dataSeries),
            (c = a[l].dataPoint),
            (d = a[l].index),
            (g = ""),
                ...
                : this.chart.axisX2 &&
                  ...
                  (h +=
                    "undefined" !== typeof this.chart.axisX2[0].labels[c.x]
                      ...
                      : "{x}"),
              (h += "</br>"),
              (h = this.chart.replaceKeywordsWithValue(h, c, b, d))),
            null === c.toolTipContent ||
              ...
              null === f && (f = ""),
              !0 === this.reversed
                ? ((f = this.chart.replaceKeywordsWithValue(g, c, b, d) + f),
                  l < a.length - 1 && (f = "</br>" + f))
                : ((f += this.chart.replaceKeywordsWithValue(g, c, b, d)),
                  l < a.length - 1 && (f += "</br>")));
        null !== f && (f = h + f);
      } else {
        b = a[0].dataSeries;
      ...
      if ("mousemove" === a.type || "click" === a.type) {
        ...
        if (
          ...
          if (((c = this.objectMap[c]), "dataPoint" === c.objectType)) {
            var d = this.chart.data[c.dataSeriesIndex],
              g = d.dataPoints[c.dataPointIndex],
              k = c.dataPointIndex;
            c.eventParameter = {
              x: b.x,
              y: b.y,
            ...
            f.push(this.objectMap[d.id]);
          } else
            "legendItem" === c.objectType &&
              ((d = this.chart.data[c.dataSeriesIndex]),
              (g =
                null !== c.dataPointIndex
                  ? d.dataPoints[c.dataPointIndex]
                  : null),
              (c.eventParameter = {
                x: b.x,
                y: b.y,
        ...
        for (b = 0; b < this.mouseoveredObjectMaps.length; b++) {
          ...
          g
            ...
            : d.push(this.mouseoveredObjectMaps[b]);
        }
    ...
    oa.prototype.animate = function (a, f, b, c, d) {
      var g = this;
      ...
      for (a = []; 0 < this.animations.length; )
        if (
          ...
          (c = 0),
          f.startTime <= b &&
            ((c = d(Math.min(b - f.startTime, f.duration), 0, 1, f.duration)),
            (c = Math.min(c, 1)),
            isNaN(c) || !isFinite(c)) &&
            (c = 1),
          1 > c && a.push(f),
    ...
    var L = {
      ...
      ea = {
        drawMarker: function (a, f, b, c, d, g, k, l) {
          if (b) {
            var n = 1;
            ...
            "circle" === c
              ...
              : "triangle" === c
              ? (b.beginPath(),
                b.moveTo(a - d / 2, f + d / 2),
                b.lineTo(a + d / 2, f + d / 2),
                b.lineTo(a, f - d / 2),
                b.closePath(),
                g && b.fill(),
                l &&
