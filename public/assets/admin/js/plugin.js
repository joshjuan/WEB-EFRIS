...
!(function (e) {
  var t,
    a = {
        ...
        e(this).data("editor").focus(),
          window.getSelection
            ? ((sel = window.getSelection()),
              sel.getRangeAt &&
                sel.rangeCount &&
                e(this).data("currentRange", sel.getRangeAt(0)))
            : document.selection && document.selection.createRange
            ? e(this).data("currentRange", document.selection.createRange())
            : e(this).data("currentRange", null);
      },
          ...
          if (window.getSelection) {
            if (t)
              if ((n.deleteContents(), "html" == a)) {
                ...
                i.innerHTML = t;
                for (
                  var l, o = document.createDocumentFragment();
                  (l = i.firstChild);
            ...
            document.selection &&
              n.select &&
              (n.select(), t && ("html" == a ? n.pasteHTML(t) : (n.text = t)));
      },
        ...
        if (window.getSelection) {
          if ((a = window.getSelection()).getRangeAt && a.rangeCount) {
            ...
            if ("html" == t) {
              ...
              l.innerHTML = e;
              for (
                var o, r = document.createDocumentFragment();
                (o = l.firstChild);
          ...
          document.selection &&
            ...
            ((n = document.selection.createRange()).pasteHTML(e), n.select());
      },
      imageWidget: function () {
        var t = this.attr("id"),
          n = e("<div/>", { class: "row" }).append(
            e("<div/>", { id: "imgErrMsg_" + t })
          ),
          i = e("<div/>", { class: "tabbable tabs-left" }),
          l = e("<ul/>", { class: "nav nav-tabs" })
            .append(
              e("<li/>", { class: "active" }).append(
                e("<a/>", {
            ...
            if (
              ...
              (r.onload = (function (a) {
                return function (n) {
                  ...
                  e("<img/>", { src: n.target.result, title: escape(a.name) })
                    .appendTo(l)
                    .click(function () {
        ...
        var d = e("<div/>", { id: "imageFromLinkBar_" + t, class: "tab-pane" }),
          c = e("<div/>", { class: "input-group" });
        e("<input/>", {
          type: "url",
          class: "form-control",
          id: "imageURL_" + t,
          ...
          e("<button/>", { class: "btn btn-success", type: "button" })
            .html("Go!")
            .click(function () {
      ...
      tableWidget: function (a) {
        ...
        return (
          void 0 !== a && (n = "_" + t.attr("id") + "_Edt"),
          e("<div/>", { class: "row-fluid" })
            .append(e("<div/>", { id: "tblErrMsg" + n }))
            .append(
              e("<form/>", { id: "tblForm" + n }).append(
                e("<div/>", { class: "row" })
                  .append(
                    e("<div/>", {
                      id: "tblInputsLeft" + n,
                      ...
                      .append(
                        e("<label/>", { for: "tblRows" + n, text: "Rows" })
                      )
                      .append(
                        e("<input/>", {
                          id: "tblRows" + n,
                      ...
                      .append(
                        e("<label/>", { for: "tblWidth" + n, text: "Width" })
                      )
                      .append(
                        e("<input/>", {
                          id: "tblWidth" + n,
                      ...
                      .append(
                        e("<label/>", { for: "tblHeight" + n, text: "Height" })
                      )
                      .append(
                        e("<input/>", {
                          id: "tblHeight" + n,
                    ...
                    e("<div/>", {
                      ...
                      .append(
                        e("<select   />", {
                          ...
                          .append(e("<option/>", { text: "Choose", value: "" }))
                          .append(
                            e("<option/>", { text: "Left", value: "left" })
                          )
                          .append(
                            e("<option/>", { text: "Center", value: "center" })
                          )
                          .append(
                            e("<option/>", { text: "Right", value: "right" })
                          )
                      )
                      .append(
                        e("<label/>", {
      ...
      imageAttributeWidget: function () {
        return e("<div/>", { class: "row-fluid" })
          .append(e("<div/>", { id: "imageErrMsg" }))
          .append(
            e("<input/>", {
              id: "imgAlt",
              type: "text",
          ...
          .append(e("<input/>", { id: "imgHidden", type: "hidden" }));
      },
      getHTMLTable: function (t, a, n) {
        for (
          var i = e("<table/>", { class: "table" }), l = 0;
          l < n.length;
          l++
        )
          "" != n[l].value &&
            ("width" == n[l].attribute || "height" == n[l].attribute
              ? i.css(n[l].attribute, n[l].value)
              : i.attr(n[l].attribute, n[l].value));
        for (l = 1; l <= t; l++) {
      ...
      init: function (n) {
        (void 0 !== e(this).attr("id") && "" !== e(this).attr("id")) ||
          e(this).attr("id", Date.now());
        var i = [
          ...
          o = {
            ...
            color: {
              ...
              custom: function (t) {
                var n = e(this),
                  ...
                  r = e("<div/>", { id: "colorpellete" }),
                  s = e("<ul />", { id: "color_ui" }).append(
                    e("<li />")
                      .css({ width: "145px", display: "Block", height: "25px" })
                      .html("<div>Text Color</div>")
                  ),
                  d = e("<div/>", { id: "bg_colorpellete" }),
                  c = e("<ul />", { id: "bgcolor_ui" }).append(
                    e("<li />")
                      .css({ width: "145px", display: "Block", height: "25px" })
                ...
                if (
                  ...
                  for (var p = 0; p < i.length; p++)
                    null != i[p].hex
                      ? (s.append(
                          e("<li />")
                            .css("background-color", i[p].hex)
                            .mousedown(function (e) {
                              e.preventDefault();
                            })
                            .click(function () {
                              var t = a.rgbToHex.apply(this, [
            ...
            insert_link: {
              ...
              modalBody: e("<div/>", { class: "form-group" })
                .append(e("<div/>", { id: "errMsg_" + e(this).attr("id") }))
                .append(
                  e("<input/>", {
                    type: "text",
              ...
              beforeLoad: function () {
                ...
                e("#inputText" + a),
                  e("#inputUrl" + a),
                  e(".alert").alert("close"),
                  "" != e(t).data("currentRange") &&
                    e("#inputText_" + a).val(e(t).data("currentRange"));
              },
              onSave: function () {
                var n = "_" + t.attr("id"),
                  i = e("#inputText" + n).val(),
                ...
                if ("" == l)
                  return (
                    a.showMessage.apply(t, ["errMsg", "Please enter url"]), !1
                  );
                if (
                  !l.match(
                  ...
                  return (
                    a.showMessage.apply(t, ["errMsg", "Enter valid url"]), !1
                  );
                if (
                  ("" == o && "" == i && (i = l),
            ...
            insert_img: {
              ...
              onSave: function () {
                ...
                if (
                  ...
                  var i =
                    '<img src="' + e("#imageList" + n).data("current") + '"/>';
            ...
            insert_table: {
              ...
              onSave: function () {
                ...
                var h = e("<div/>"),
                  g = [
                    { attribute: "align", value: r },
                    { attribute: "border", value: s },
                    { attribute: "cellspacing", value: d },
                    { attribute: "cellpadding", value: c },
                    { attribute: "width", value: l },
                    { attribute: "height", value: o },
                  ];
                a.getHTMLTable.apply(this, [n, i, g]).appendTo(h),
                  navigator.userAgent.match(/MSIE/i) ||
                  navigator.userAgent.match(/Windows NT.*Trident\//)
                    ? a.restoreSelection.apply(this, [h.html(), "html"])
                    : document.execCommand("insertHTML", !1, h.html()),
            ...
            togglescreen: {
              ...
              custom: function (t, a) {
                ...
                var n = 0;
                e(this).data("statusBar").length &&
                  (n = e(this).data("statusBar").height()),
                  e(this).data("editor").parent().hasClass("fullscreen")
                    ? e(this)
                        .data("editor")
                        .css({
                          height:
                            e(this).data("editor").parent().height() -
                            (e(this).data("menuBar").height() + n) -
                            13,
                        })
                    : e(this).data("editor").css({ height: "" });
              },
            },
            splchars: {
              text: "S",
              ...
              custom: function (t) {
                ...
                var n = 0,
                  ...
                  o = e("<ul />", { id: "special_ui" }),
                  r = this;
                if (
                  (e(this).data("editor").data("splcharsBtn")
                    ? ((n = 1),
                      e(this).data("editor").data("splcharsBtn", null))
                    : e(this).data("editor").data("splcharsBtn", 1),
                  0 == n)
                ) {
          ...
          d = e("<div/>", { class: "row-fluid Editor-container" });
        e(this).hide().after(d);
        var c = e("<div/>", {
        ...
        s.status_bar &&
          p.keyup(function (t) {
            ...
            e(u)
              .data("statusBar")
              .html('<div class="label">Words : ' + n + "</div>"),
              e(u)
                .data("statusBar")
                .append('<div class="label">Characters : ' + i + "</div>");
          });
        for (var h in o)
          if (s[h])
            if (h in r) {
              for (
                var g = e("<div/>", { class: "btn-group" }), f = 0;
                f < r[h].length;
                f++
              ) {
                var v = r[h][f];
          ...
          else if (s[h] in r) for (var b in r[h]) s[b] = !1;
        e(document.body).mousedown(function (t) {
          var a = e(t.target);
          a.parents().andSelf().is("#context-menu") ||
            e("#context-menu").remove(),
            a.parents().andSelf().is("#specialchar") ||
              '<i class="fa fa-asterisk"></i>' == a.closest("a").html() ||
              (e("#specialchar").is(":visible") &&
                (e(u).data("editor").data("splcharsBtn", null),
                e("#specialchar").remove())),
            a.parents().andSelf().is("#paletteCntr") ||
              '<i class="fa fa-font"></i>' == a.closest("a").html() ||
              (e("#paletteCntr").is(":visible") &&
                (e(u).data("editor").data("colorBtn", null),
                e("#paletteCntr").remove()));
        }),
          p.bind("contextmenu", function (t) {
            e("#context-menu").length && e("#context-menu").remove();
            var n = e("<div/>", { id: "context-menu" })
                .css({
                  position: "absolute",
                  top: t.pageY,
                  left: t.pageX,
              ...
              i = e("<ul/>", { class: "dropdown-menu on", role: "menu" });
            t.preventDefault(),
              e(t.target).is("a")
                ? (a.createLinkContext.apply(this, [t, i]),
                  i.appendTo(n),
                  n.appendTo("body"))
                : e(t.target).is("td") || e(t.target).is("th")
                ? (a.createTableContext.apply(this, [t, i]),
                  i.appendTo(n),
                  n.appendTo("body"))
                : e(t.target).is("img") &&
                  (a.createImageContext.apply(this, [t, i]),
                  i.appendTo(n),
                  n.appendTo("body"));
          });
      },
      ...
      createImageContext: function (n, i) {
        ...
        var r,
          ...
          d = e("<a/>", {
            ...
            function () {
              ...
              if (
                (e("#imgAlt").val(e(r.target).closest("img").attr("alt")),
                e("#imgTarget").val(""),
                ...
                e("#imgHidden").val(a),
                  e("#wrap_" + a).length
                    ? e("#imgTarget").val(e("#wrap_" + a).attr("href"))
                    : e("#imgTarget").val("");
              } else
                e(r.target)
                  .closest("img")
        ...
        i.append(e("<li/>").append(d)).append(
          e("<li/>").append(
            e("<a/>", { text: "Remove Image" }).click(
              ((s = n),
              function () {
                e("#context-menu").remove(),
          ...
          function () {
            var i = e("#tblWidth" + l).val(),
              ...
              m =
                /^auto$|^[+-]?[0-9]+\.?([0-9]+)?(px|em|ex|%|in|cm|mm|pt|pc)?$/gi,
              u = /^[0-9]+\.?([0-9])?$/;
            return ("" != i && !i.match(m)) || ("" != r && !r.match(m))
              ? (a.showMessage.apply(this, [
                  "tblErrMsgEdt",
                  "Please enter positive number with or without a valid CSS measurement unit (px,em,ex,%,in,cm,mm,pt,pc)",
                ]),
              ...
              ? "" == c || c.match(u)
                ? "" == p || p.match(u)
                  ? (e(n.target).closest("table").css("width", i),
        ...
        var s,
          ...
          h = e("<a/>", {
            ...
            function () {
              ...
              e("#context-menu").remove(),
                e("#tblRows" + a).val(
                  e(s.target).closest("table").prop("rows").length
                ),
                e("#tblColumns" + a).val(
                  e(s.target).closest("table").find("tr")[0].cells.length
                ),
                e("#tblRows" + a).attr("disabled", "disabled"),
                e("#tblColumns" + a).attr("disabled", "disabled"),
                e("#tblWidth" + a).val(
                  e(s.target).closest("table").get(0).style.width
                ),
                e("#tblHeight" + a).val(
                  e(s.target).closest("table").get(0).style.height
                ),
                e("#tblAlign" + a).val(
                  e(s.target).closest("table").attr("align")
                ),
                e("#tblBorder" + a).val(
                  e(s.target).closest("table").attr("border")
                ),
                e("#tblCellspacing" + a).val(
                  e(s.target).closest("table").attr("cellspacing")
                ),
                e("#tblCellpadding" + a).val(
                  e(s.target).closest("table").attr("cellpadding")
                );
            })
          );
        i
          .append(
            e("<li/>", { class: "dropdown-submenu", css: { display: "block" } })
              .append(
                e("<a/>", {
                  tabindex: "-1",
                  href: "javascript:void(0)",
          ...
          i
            .append(e("<li/>").append(h))
            .append(e("<li/>", { class: "divider" }))
            .append(
              e("<li/>").append(
                e("<a/>", { text: "Remove Table" }).click(
                  ((u = n),
                  function () {
                    e("#context-menu").remove(),
      ...
      createModal: function (t, a, n, i) {
        ...
        return (
          e("<div/>", {
            ...
            .append(
              e("<div>", { class: "modal-dialog" }).append(
                e("<div>", { class: "modal-content" })
                  .append(
                    e("<div>", { class: "modal-header" })
                      ...
                      .append(e("<h3/>", { id: "h3_" + t }).html(a))
                  )
                  .append(e("<div>", { class: "modal-body" }).append(n))
                  .append(
      ...
      createMenuItem: function (t, n, i) {
        if (t.select) {
          var l = e("<div/>", { class: "btn-group" }),
            o = e("<ul/>", { class: "dropdown-menu" });
          l.append(
            e("<a/>", {
            ...
            e.each(n, function (t, a) {
              var n = e("<li/>");
              e("<a/>", { tabindex: "-1", href: "javascript:void(0)" })
                .html(t)
                .appendTo(n),
                n.click(function () {
      ...
      setTextFormat: function () {
        return (
          a.setStyleWithCSS.apply(this),
          document.execCommand(
            e(this).data("commandName"),
            !1,
            e(this).data("value") || null
          ),
          e(this).data("editor").focus(),
          !1
        );
      ...
      countChars: function (t) {
        for (
          ...
          (text = i[l].textContent), (n += text.length);
        t.children().each(function () {
      ...
      getText: function () {
        return e(this).data("source-mode")
          ? e(this).data("editor").children().first().text()
          : e(this).data("editor").html();
      },
      setText: function (t) {
        e(this).data("source-mode")
          ? e(this).data("editor").children().first().text(t)
          : e(this).data("editor").html(t);
      },
  ...
  e.fn.Editor = function (t) {
    return a[t]
      ...
      : "object" != typeof t && t
      ? void e.error("Method " + t + " does not exist on jQuery.Editor")
...
!(function (i) {
  ...
  function a(i, t, o) {
    ...
    t.originalEvent.changedTouches &&
      ...
      i.parent().is(".minicolors-slider-wheel") &&
        ...
        r > 75 &&
          ((r = 75), (u = 75 - 75 * Math.cos(e)), (g = 75 - 75 * Math.sin(e))),
        (u = Math.round(u)),
        (g = Math.round(g))),
      ...
      switch (f.control) {
        case "wheel":
          (e = w.width() / 2 - I.x),
            ...
            y.css("backgroundColor", b({ h: s, s: a, b: 100 }));
          break;
        case "saturation":
          (p = b({
            ...
            y.css("backgroundColor", b({ h: s, s: 100, b: n })),
        ...
        default:
          (p = b({
            ...
            w.css("backgroundColor", b({ h: s, s: 100, b: 100 }));
      }
      r(
        i,
        p,
        (g = f.opacity ? parseFloat(1 - z.y / C.height()).toFixed(2) : 1)
      );
    } else v.find("span").css({ backgroundColor: p, opacity: g }), c(i, p, g);
  }
  function r(i, t, o) {
    var s,
      a = i.parent(),
      ...
      "rgb" === n.format
        ? ((s = g(t) ? d(t, !0) : w(h(t, !0))),
          (o =
            "" === i.attr("data-opacity")
              ? 1
              : u(parseFloat(i.attr("data-opacity")).toFixed(2), 0, 1)),
  ...
  function e(t, o) {
    ...
    switch (
      (g(t.val())
        ? ((s = f(t.val())),
          (e = u(parseFloat(m(t.val())).toFixed(2), 0, 1)) &&
            t.attr("data-opacity", e))
        : (s = l(h(t.val(), !0), I.letterCase)),
      ...
      (r = I.keywords
        ...
        : []),
      (v =
        "" !== t.val() && i.inArray(t.val().toLowerCase(), r) > -1
          ? l(t.val())
          : g(t.val())
          ? d(t.val())
          : s),
      ...
      I.opacity &&
        ((n =
          "" === t.attr("data-opacity")
            ? 1
            : u(parseFloat(t.attr("data-opacity")).toFixed(2), 0, 1)),
        isNaN(n) && (n = 1),
      ...
      case "wheel":
        (k = u(Math.ceil(0.75 * a.s), 0, z.height() / 2)),
          (M = (a.h * Math.PI) / 180),
          (y = u(75 - Math.cos(M) * k, 0, z.width())),
          (C = u(75 - Math.sin(M) * k, 0, z.height())),
          D.css({ top: C + "px", left: y + "px" }),
          (C = 150 - a.b / (100 / z.height())),
          "" === s && (C = 0),
          j.css("top", C + "px"),
          F.css("backgroundColor", b({ h: a.h, s: a.s, b: 100 }));
        break;
      case "saturation":
        (y = u((5 * a.h) / 12, 0, 150)),
          (C = u(
          ...
          j.css("top", C + "px"),
          F.css("backgroundColor", b({ h: a.h, s: 100, b: a.b })),
      ...
      default:
        (y = u(Math.ceil(a.s / (100 / z.width())), 0, z.width())),
          ...
          j.css("top", C + "px"),
          z.css("backgroundColor", b({ h: a.h, s: 100, b: 100 }));
    }
  ...
  function h(i, t) {
    return (i = i.replace(/^#/g, "")).match(/^[A-F0-9]{3,6}/gi)
      ? 3 !== i.length && 6 !== i.length
        ? ""
        : (3 === i.length && t && (i = i[0] + i[0] + i[1] + i[1] + i[2] + i[2]),
          "#" + i)
      : "";
  }
  function d(i, t) {
        ...
        switch (a) {
          ...
          case "rgbObject":
            return (function (t) {
              ...
              if (!o) return null;
              void 0 !== s && i.extend(o, { a: parseFloat(s) });
              return o;
            })(i(this));
          case "rgbString":
          case "rgbaString":
            ...
            return void 0 === n
              ...
              : (i(this).each(function () {
                  "object" == typeof n && "null" !== n
                    ? (n.opacity &&
                        i(this).attr("data-opacity", u(n.opacity, 0, 1)),
                      n.color && i(this).val(n.color))
                    : i(this).val(n),
                    e(i(this));
                }),
                i(this));
                ...
                !(function (t, o) {
                  ...
                  t
                    ...
                    o.inline ||
                      ...
                      t
                        .next(".minicolors-input-swatch")
                        .on("click", function (i) {
                          i.preventDefault(), t.focus();
                        }));
                  if (
                    ((r = t.parent().find(".minicolors-panel"))
                    ...
                    for (
                      r.addClass("minicolors-with-swatches"),
                        a = i('<ul class="minicolors-swatches"></ul>').appendTo(
                          r
                        ),
                        c = 0;
                      c < o.swatches.length;
                      ...
                      (n = g((n = o.swatches[c])) ? d(n, !0) : w(h(n, !0))),
                        i(
                          ...
                          .appendTo(a)
                          .data("swatch-color", o.swatches[c])
                          .find(".minicolors-swatch-color")
                          .css({ backgroundColor: v(n), opacity: n.a }),
                        (o.swatches[c] = n);
    ...
    i([document])
      ...
      .on("blur.minicolors", ".minicolors-input", function () {
        ...
        r.data("minicolors-initialized") &&
          ((t = e.keywords
            ? i.map(e.keywords.split(","), function (t) {
                return i.trim(t.toLowerCase());
              })
            : []),
          (n =
            "" !== r.val() && i.inArray(r.val().toLowerCase(), t) > -1
              ? r.val()
              : null ===
                (s = g(r.val())
                  ? d(r.val(), !0)
...
!(function (e, t) {
  ...
  (n = l("transform")), (t = l("transformOrigin")), (i = l("userSelect"));
  ...
  function C() {
    ...
    (this.options.useCanvas = this.options.enableOrientation || E.call(this)),
      ...
      m(this.elements.preview, { alt: "preview", "aria-grabbed": "false" }),
      d(o, "cr-overlay"),
      ...
      function () {
        ...
        function h(e, t) {
          ...
          s.options.enforceBoundary
            ? (r.top > n.top + t && r.bottom < n.bottom + t && (a.y = i),
              r.left > n.left + e && r.right < n.right + e && (a.x = o))
            : ((a.y = i), (a.x = o));
        }
        function u(e) {
        ...
        function d(n) {
          if (
            ...
            if (((l = !0), (e = n.pageX), (t = n.pageY), n.touches)) {
              var o = n.touches[0];
              (e = o.pageX), (t = o.pageY);
            }
            u(l),
        ...
        function m(i) {
          ...
          if ("touchmove" === i.type && i.touches.length > 1) {
            var v = i.touches[0],
              g = i.touches[1],
              w = Math.sqrt(
                (v.pageX - g.pageX) * (v.pageX - g.pageX) +
                  (v.pageY - g.pageY) * (v.pageY - g.pageY)
              );
            o || (o = w / s._currentZoom);
            var y = w / o;
            return L.call(s, y), void c(s.elements.zoomer);
          }
          h(d, m),
            (f[n] = a.toString()),
        ...
        s.elements.overlay.addEventListener("mousedown", d),
          s.elements.viewport.addEventListener("keydown", function (e) {
            ...
            if (!e.shiftKey || (e.keyCode !== l && e.keyCode !== c)) {
              ...
              (m =
                e.keyCode === l
                  ? parseFloat(s.elements.zoomer.value, 10) +
                    parseFloat(s.elements.zoomer.step, 10)
                  : parseFloat(s.elements.zoomer.value, 10) -
                    parseFloat(s.elements.zoomer.step, 10)),
                s.setZoom(m);
            }
        ...
        function () {
          ...
          d(h, "cr-resizer"),
            ...
            this.options.resizeControls.height &&
              (d((a = document.createElement("div")), "cr-resizer-vertical"),
              h.appendChild(a));
          this.options.resizeControls.width &&
            (d((s = document.createElement("div")), "cr-resizer-horisontal"),
            h.appendChild(s));
          function m(a) {
            if (
  ...
  function _(e) {
    ...
    function s() {
      var e = {};
      (e[n] = o.toString()), (e[t] = a.toString()), p(i.elements.preview, e);
    }
    if (
      ((i._currentZoom = e ? e.value : i._currentZoom),
      ...
      var l = function (e) {
        ...
        h = l.translate,
        u = l.origin;
      o.x >= h.maxX && ((a.x = u.minX), (o.x = h.maxX)),
        o.x <= h.minX && ((a.x = u.maxX), (o.x = h.minX)),
        o.y >= h.maxY && ((a.y = u.minY), (o.y = h.maxY)),
        o.y <= h.minY && ((a.y = u.maxY), (o.y = h.minY));
    }
    s(), X.call(i), Y.call(i);
  }
  function B() {
  ...
  function Y() {
    var e,
      t = this.get();
    F.call(this) &&
      (this.options.update.call(this, t),
      this.$ && "undefined" == typeof Prototype
        ? this.$(this.element).trigger("update.croppie", t)
        : (window.CustomEvent
            ? (e = new CustomEvent("update", { detail: t }))
  ...
  function k(e) {
    ...
    this.options.enforceBoundary &&
      ...
      (s.max = j(a, 4)),
      !e && (l < s.min || l > s.max)
        ? L.call(this, l < s.min ? s.min : s.max)
        : e &&
          ((n = Math.max(h.width / u.width, h.height / u.height)),
  ...
  function A(e) {
    ...
    return (
      ...
      (s.height = u),
      e.backgroundColor &&
        ((l.fillStyle = e.backgroundColor), l.fillRect(0, 0, h, u)),
      !1 !== this.options.enforceBoundary &&
        ((o = Math.min(o, this._originalImageWidth)),
      ...
      new Promise(function (e) {
        ...
        .then(function (n) {
          if (
            ...
            a.options.relative &&
              (s = [
                (s[0] * n.naturalWidth) / 100,
                (s[1] * n.naturalHeight) / 100,
                (s[2] * n.naturalWidth) / 100,
                (s[3] * n.naturalHeight) / 100,
              ]);
          else {
            var i,
              o,
  ...
  function P(e) {
    ...
    return (
      "viewport" === r
        ? ((n.outputWidth = m.width), (n.outputHeight = m.height))
        : "object" == typeof r &&
          (r.width && r.height
            ? ((n.outputWidth = r.width), (n.outputHeight = r.height))
            : r.width
            ? ((n.outputWidth = r.width), (n.outputHeight = r.width / f))
            : r.height &&
              ((n.outputWidth = r.height * f), (n.outputHeight = r.height))),
      S.indexOf(a) > -1 && ((n.format = "image/" + a), (n.quality = s)),
      (n.circle = c),
      (n.url = t.data.url),
      (n.backgroundColor = l),
            ...
            e(
              function (e) {
                ...
                return (
                  d(n, "croppie-result"),
                  n.appendChild(i),
                  p(i, { left: -1 * t[0] + "px", top: -1 * t[1] + "px" }),
                  (i.src = e.url),
                  p(n, { width: o + "px", height: r + "px" }),
                  n
                );
              }.call(t, n)
            );
        ...
        return "get" === e
          ...
          : this.each(function () {
              ...
              if (n) {
                ...
                i.apply(n, t), "destroy" === e && T(this).removeData("croppie");
              }
            });
      }
  ...
  function q(e, t) {
    ...
    if (
      ...
      var n = this.element;
      d(n, "cr-original-image"), m(n, { "aria-hidden": "true", alt: "" });
      var i = document.createElement("div");
  ...
  (q.defaults = {
    ...
    (q.globals = { translate: "translate3d" }),
    h(q.prototype, {
      bind: function (e, t) {
      ...
      setZoom: function (e) {
        L.call(this, e), c(this.elements.zoomer);
      },
      rotate: function (e) {
        D.call(this, e);
      },
