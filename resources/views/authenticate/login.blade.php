        ...
        <div class="col-lg-5">
            <div class="login-area">
                ...
                <div class="login-form">
                    ...
                    <form id="loginform"
                        action="https://product.geniusocean.com/kingcommerce/kingcommerce/admin/login"
                        method="POST">
                        <input type="hidden" name="_token" value="GqIDuqqjbhCj7Ekfrda3h6LsUHkWK3EdpbX7z6sE">
